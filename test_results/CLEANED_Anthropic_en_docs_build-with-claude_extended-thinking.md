...
On this page
  * [Supported models](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#supported-models)
  * [How extended thinking works](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#how-extended-thinking-works)
  * [How to use extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#how-to-use-extended-thinking)
  * [Summarized thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#summarized-thinking)
  * [Streaming thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#streaming-thinking)
  * [Extended thinking with tool use](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#extended-thinking-with-tool-use)
  * [Toggling thinking modes in conversations](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#toggling-thinking-modes-in-conversations)
  * [Common error scenarios](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#common-error-scenarios)
  * [Practical guidance](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#practical-guidance)
  * [Preserving thinking blocks](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#preserving-thinking-blocks)
  * [Interleaved thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#interleaved-thinking)
  * [Extended thinking with prompt caching](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#extended-thinking-with-prompt-caching)
  * [Understanding thinking block caching behavior](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#understanding-thinking-block-caching-behavior)
  * [Max tokens and context window size with extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#max-tokens-and-context-window-size-with-extended-thinking)
  * [The context window with extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#the-context-window-with-extended-thinking)
  * [The context window with extended thinking and tool use](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#the-context-window-with-extended-thinking-and-tool-use)
  * [Managing tokens with extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#managing-tokens-with-extended-thinking)
  * [Thinking encryption](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#thinking-encryption)
  * [Thinking redaction](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#thinking-redaction)
  * [Differences in thinking across model versions](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#differences-in-thinking-across-model-versions)
  * [Pricing](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#pricing)
  * [Best practices and considerations for extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#best-practices-and-considerations-for-extended-thinking)
  * [Working with thinking budgets](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#working-with-thinking-budgets)
  * [Performance considerations](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#performance-considerations)
  * [Feature compatibility](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#feature-compatibility)
  * [Usage guidelines](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#usage-guidelines)
  * [Next steps](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#next-steps)
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#supported-models)
Supported models
Extended thinking is supported in the following models:
  * Claude Sonnet 4.5 (`claude-sonnet-4-5-20250929`)
  * Claude Sonnet 4 (`claude-sonnet-4-20250514`)
  * Claude Sonnet 3.7 (`claude-3-7-sonnet-20250219`) ([deprecated](https://docs.claude.com/en/docs/about-claude/model-deprecations))
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#how-extended-thinking-works)
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#how-to-use-extended-thinking)
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#summarized-thinking)
Summarized thinking
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#streaming-thinking)
Streaming thinking
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#toggling-thinking-modes-in-conversations)
...
From the model’s perspective, **tool use loops are part of the assistant turn**. An assistant turn doesn’t complete until Claude finishes its full response, which may include multiple tool calls and results. For example, this sequence is all part of a **single assistant turn** :
Copy
```
...
####
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#common-error-scenarios)
...
####
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#practical-guidance)
Practical guidance
...
Toggling thinking modes also invalidates prompt caching for message history. For more details, see the [Extended thinking with prompt caching](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#extended-thinking-with-prompt-caching) section.
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#extended-thinking-with-prompt-caching)
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#understanding-thinking-block-caching-behavior)
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#max-tokens-and-context-window-size-with-extended-thinking)
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#the-context-window-with-extended-thinking)
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#the-context-window-with-extended-thinking-and-tool-use)
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#managing-tokens-with-extended-thinking)
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#thinking-encryption)
Thinking encryption
...
###
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#thinking-redaction)
Thinking redaction
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#differences-in-thinking-across-model-versions)
...
##
[​](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#pricing)
Pricing
