...
scraped_at: 2025-05-25T08:37:40.562607
...
[grid-row](https://tailwindcss.com/docs/grid-row)[grid-auto-columns](https://tailwindcss.com/docs/grid-auto-columns)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/grid-auto-flow#quick-reference)
  * [Examples](https://tailwindcss.com/docs/grid-auto-flow#examples)
    * [Basic example](https://tailwindcss.com/docs/grid-auto-flow#basic-example)
    * [Responsive design](https://tailwindcss.com/docs/grid-auto-flow#responsive-design)
