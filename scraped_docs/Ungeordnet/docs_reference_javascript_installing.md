...
scraped_at: 2025-05-25T08:55:23.432642
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/installing#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/installing#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/installing#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/installing#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/installing#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/installing#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/installing#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/installing#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/installing#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/installing#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/installing#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/installing#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/installing#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/installing#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/installing#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/installing#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/installing#all-changes)
  * `supabase-js`
