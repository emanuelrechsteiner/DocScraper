---
url: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives
scraped_at: 2025-05-25T09:02:59.399544
title: Tailwind CSS Incentives - Official Tailwind UI Components
---
...
[Components](https://tailwindcss.com/plus/ui-blocks/ecommerce#product-ecommerce-components)
# Incentives
Use these Tailwind CSS incentive components to highlight special offers, discounts, loyalty rewards, and promotional deals that encourage customers to make purchases in your store. These components are designed and built by the Tailwind CSS team, and include a variety of different styles and layouts.
## [3-column with illustrations and split header](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-8872b12a99b750e189f99b92c726ab75)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [4-column with illustrations](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-38742d005e7e8f48feb79dea72a0a8a5)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [3-column with illustrations and header](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-2d5d20e54ee541d2b42b7c02457850df)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [3-column with illustrations and centered text](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-52ce80a2e5549b97abb3d5d3f76f739e)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [3-column with illustrations and heading](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-24b27a127824cbc843ef2542d46fb3dc)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [2x2 grid with illustrations](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-3899975a74f43a3fe103baffc0f1de86)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [3-column with icons and supporting text](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-724313acc0fc44912588500e01b3c900)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [3-column with icons](https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-aeb0ee53368825ebb0be85ae6524cd6c)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
### Marketing
