---
url: https://supabase.com/docs/reference/python/functions-invoke
scraped_at: 2025-05-25T09:20:03.145407
...
## Installing
### Install with PyPi[#](https://supabase.com/docs/reference/python/functions-invoke#install-with-pypi)
