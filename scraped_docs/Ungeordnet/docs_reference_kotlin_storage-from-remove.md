---
url: https://supabase.com/docs/reference/kotlin/storage-from-remove
scraped_at: 2025-05-25T09:18:44.499803
...
## Installing
### Add one or more modules to your project[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required)[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#serialization)
...
## Initializing
### Create Supabase Client[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#create-supabase-client)
...
### OAuth and OTP link verification[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow[#](https://supabase.com/docs/reference/kotlin/storage-from-remove#pkce-authentication-flow)
