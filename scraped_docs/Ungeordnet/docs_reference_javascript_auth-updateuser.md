...
scraped_at: 2025-05-25T08:45:17.298516
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/auth-updateuser#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/auth-updateuser#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/auth-updateuser#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/auth-updateuser#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/auth-updateuser#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/auth-updateuser#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/auth-updateuser#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/auth-updateuser#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/auth-updateuser#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/auth-updateuser#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/auth-updateuser#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/auth-updateuser#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/auth-updateuser#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/auth-updateuser#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/auth-updateuser#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/auth-updateuser#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/auth-updateuser#all-changes)
  * `supabase-js`
