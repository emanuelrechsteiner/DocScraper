...
scraped_at: 2025-05-25T08:57:23.573100
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/using-filters#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/using-filters#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/using-filters#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/using-filters#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/using-filters#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/using-filters#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/using-filters#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/using-filters#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/using-filters#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/using-filters#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/using-filters#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/using-filters#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/using-filters#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/using-filters#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/using-filters#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/using-filters#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/using-filters#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/using-filters#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/using-filters#presence)
