...
scraped_at: 2025-05-25T09:02:02.177944
title: Select first row for each group in PostgreSQL | Supabase Docs
---
...
Database
  ...
  2. Examples
  3. [Select First Row per Group](https://supabase.com/docs/guides/database/postgres/first-row-in-group)
...
9
10
select distincton (team) id, team, pointsfrom seasonsorder BY id, points desc, team;
