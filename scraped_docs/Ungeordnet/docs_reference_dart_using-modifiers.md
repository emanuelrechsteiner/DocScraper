...
scraped_at: 2025-05-25T09:48:15.331475
...
v2.0
  ...
  * Database
    ...
    * Using filters
    * Using modifiers
[Using modifiers](https://supabase.com/docs/reference/dart/using-modifiers)
      * [Return data after inserting](https://supabase.com/docs/reference/dart/db-modifiers-select)
      * [Order the results](https://supabase.com/docs/reference/dart/order)
      * [Limit the number of rows returned](https://supabase.com/docs/reference/dart/limit)
      * [Limit the query to a range](https://supabase.com/docs/reference/dart/range)
      * [Retrieve one row of data](https://supabase.com/docs/reference/dart/single)
      * [Retrieve zero or one row of data](https://supabase.com/docs/reference/dart/maybesingle)
      * [Retrieve as a CSV](https://supabase.com/docs/reference/dart/db-csv)
      * [Using explain](https://supabase.com/docs/reference/dart/explain)
  * Auth
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/using-modifiers#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/using-modifiers#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/using-modifiers#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/using-modifiers#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/using-modifiers#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/using-modifiers#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/using-modifiers#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/using-modifiers#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/using-modifiers#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/using-modifiers#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/using-modifiers#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/using-modifiers#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/using-modifiers#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/using-modifiers#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/using-modifiers#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/using-modifiers#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/using-modifiers#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/using-modifiers#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/using-modifiers#presence)
