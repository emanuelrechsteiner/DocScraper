---
url: https://supabase.com/docs/reference/cli/supabase-inspect-db-replication-slots
scraped_at: 2025-05-25T09:44:47.209471
...
Supabase CLI
  ...
  * Migrations
    ...
    * [Apply pending migration files](https://supabase.com/docs/reference/cli/supabase-migration-up)
  * Seed
...
### Additional links[#](https://supabase.com/docs/reference/cli/supabase-inspect-db-replication-slots#additional-links)
