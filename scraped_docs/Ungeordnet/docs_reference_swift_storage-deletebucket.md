---
url: https://supabase.com/docs/reference/swift/storage-deletebucket
scraped_at: 2025-05-25T09:50:27.137643
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/storage-deletebucket#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/storage-deletebucket#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/storage-deletebucket#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/storage-deletebucket#swiftui-app-lifecycle)
