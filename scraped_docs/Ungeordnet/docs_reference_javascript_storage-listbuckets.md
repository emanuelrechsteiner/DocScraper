...
scraped_at: 2025-05-25T08:42:42.781140
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/storage-listbuckets#all-changes)
  * `supabase-js`
