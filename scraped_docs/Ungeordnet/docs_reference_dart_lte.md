...
scraped_at: 2025-05-25T09:49:27.350537
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/lte#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/lte#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/lte#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/lte#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/lte#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/lte#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/lte#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/lte#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/lte#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/lte#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/lte#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/lte#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/lte#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/lte#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/lte#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/lte#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/lte#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/lte#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/lte#presence)
