...
scraped_at: 2025-05-25T08:42:29.601610
...
[place-content](https://tailwindcss.com/docs/place-content)[place-self](https://tailwindcss.com/docs/place-self)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/place-items#quick-reference)
  * [Examples](https://tailwindcss.com/docs/place-items#examples)
    * [Start](https://tailwindcss.com/docs/place-items#start)
    * [End](https://tailwindcss.com/docs/place-items#end)
    * [Center](https://tailwindcss.com/docs/place-items#center)
