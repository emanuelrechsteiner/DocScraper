...
scraped_at: 2025-05-25T08:36:32.338487
...
## [Examples](https://tailwindcss.com/docs/transition-property#examples)
...
[caption-side](https://tailwindcss.com/docs/caption-side)[transition-behavior](https://tailwindcss.com/docs/transition-behavior)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/transition-property#quick-reference)
  * [Examples](https://tailwindcss.com/docs/transition-property#examples)
    * [Basic example](https://tailwindcss.com/docs/transition-property#basic-example)
    * [Supporting reduced motion](https://tailwindcss.com/docs/transition-property#supporting-reduced-motion)
    * [Using a custom value](https://tailwindcss.com/docs/transition-property#using-a-custom-value)
