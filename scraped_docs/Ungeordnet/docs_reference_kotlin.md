---
url: https://supabase.com/docs/reference/kotlin
scraped_at: 2025-05-25T09:06:15.207582
...
## Installing
### Add one or more modules to your project[#](https://supabase.com/docs/reference/kotlin/start#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required)[#](https://supabase.com/docs/reference/kotlin/start#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization[#](https://supabase.com/docs/reference/kotlin/start#serialization)
...
## Initializing
### Create Supabase Client[#](https://supabase.com/docs/reference/kotlin/start#create-supabase-client)
...
### OAuth and OTP link verification[#](https://supabase.com/docs/reference/kotlin/start#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication[#](https://supabase.com/docs/reference/kotlin/start#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow[#](https://supabase.com/docs/reference/kotlin/start#pkce-authentication-flow)
