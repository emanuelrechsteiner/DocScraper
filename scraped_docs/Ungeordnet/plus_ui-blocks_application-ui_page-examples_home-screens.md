---
url: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/home-screens
scraped_at: 2025-05-25T08:39:20.481754
title: Tailwind CSS Home Screens - Official Tailwind UI Components
---
...
[Application UI](https://tailwindcss.com/plus/ui-blocks/application-ui)
[Page Examples](https://tailwindcss.com/plus/ui-blocks/application-ui#product-application-ui-page-examples)
[UI Blocks](https://tailwindcss.com/plus/ui-blocks)
/
[Application UI](https://tailwindcss.com/plus/ui-blocks/application-ui)
/
[Page Examples](https://tailwindcss.com/plus/ui-blocks/application-ui#product-application-ui-page-examples)
# Home Screens
Use these Tailwind CSS home screen examples to create the main entry point for your application, giving users immediate access to the most important features, latest updates, and primary navigation options. These page examples are designed and built by the Tailwind CSS team, and include a variety of different styles and layouts.
## [Sidebar on dark](https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/home-screens#component-1cb122f657954361d2f5fce7ec641480)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [Stacked](https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/home-screens#component-03fc6b9c0ebbb5609e996305274d9b95)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
### Marketing
