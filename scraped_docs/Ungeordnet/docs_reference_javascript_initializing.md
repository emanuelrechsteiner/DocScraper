...
scraped_at: 2025-05-25T09:15:49.580114
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/initializing?example=react-native-options-async-storage#all-changes)
  * `supabase-js`
