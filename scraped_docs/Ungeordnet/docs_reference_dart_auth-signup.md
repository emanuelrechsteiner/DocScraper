...
scraped_at: 2025-05-25T09:22:36.188924
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-signup#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-signup#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-signup#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-signup#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-signup#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-signup#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-signup#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-signup#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-signup#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-signup#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-signup#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-signup#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-signup#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-signup#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-signup#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-signup#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-signup#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-signup#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-signup#presence)
