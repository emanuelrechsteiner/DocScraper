---
url: https://supabase.com/docs/reference/swift/removeallchannels
scraped_at: 2025-05-25T09:38:02.056237
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/removeallchannels#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/removeallchannels#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/removeallchannels#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/removeallchannels#swiftui-app-lifecycle)
