---
url: https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail
scraped_at: 2025-05-25T09:45:54.286843
...
v2.0
  ...
  * Auth
    ...
    * Auth MFA
    * Auth Admin
[Auth Admin](https://supabase.com/docs/reference/dart/admin-api)
      * [Retrieve a user](https://supabase.com/docs/reference/dart/auth-admin-getuserbyid)
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-admin-inviteuserbyemail#presence)
