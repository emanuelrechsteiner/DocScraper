...
scraped_at: 2025-05-25T08:38:56.457263
...
[justify-content](https://tailwindcss.com/docs/justify-content)[justify-self](https://tailwindcss.com/docs/justify-self)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/justify-items#quick-reference)
  * [Examples](https://tailwindcss.com/docs/justify-items#examples)
    * [Start](https://tailwindcss.com/docs/justify-items#start)
    * [End](https://tailwindcss.com/docs/justify-items#end)
    * [Center](https://tailwindcss.com/docs/justify-items#center)
