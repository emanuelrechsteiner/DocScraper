---
url: https://supabase.com/docs/reference/dart/auth-getuseridentities
scraped_at: 2025-05-25T09:14:49.312112
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-getuseridentities#presence)
