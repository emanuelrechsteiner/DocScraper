...
scraped_at: 2025-05-25T09:17:33.328931
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/storage-getbucket#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/storage-getbucket#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/storage-getbucket#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/storage-getbucket#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/storage-getbucket#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/storage-getbucket#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/storage-getbucket#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/storage-getbucket#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/storage-getbucket#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/storage-getbucket#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/storage-getbucket#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/storage-getbucket#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/storage-getbucket#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/storage-getbucket#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/storage-getbucket#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/storage-getbucket#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/storage-getbucket#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/storage-getbucket#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/storage-getbucket#presence)
