---
url: https://supabase.com/docs/reference/swift/auth-signup
scraped_at: 2025-05-25T09:08:33.641781
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/auth-signup#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/auth-signup#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/auth-signup#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/auth-signup#swiftui-app-lifecycle)
