...
scraped_at: 2025-05-25T08:40:22.610586
...
## [Examples](https://tailwindcss.com/docs/background-attachment#examples)
### [Fixing the background image](https://tailwindcss.com/docs/background-attachment#fixing-the-background-image)
...
### [Scrolling with the container](https://tailwindcss.com/docs/background-attachment#scrolling-with-the-container)
...
### [Scrolling with the viewport](https://tailwindcss.com/docs/background-attachment#scrolling-with-the-viewport)
...
### [Responsive design](https://tailwindcss.com/docs/background-attachment#responsive-design)
...
[content](https://tailwindcss.com/docs/content)[background-clip](https://tailwindcss.com/docs/background-clip)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/background-attachment#quick-reference)
  * [Examples](https://tailwindcss.com/docs/background-attachment#examples)
    * [Fixing the background image](https://tailwindcss.com/docs/background-attachment#fixing-the-background-image)
    * [Scrolling with the container](https://tailwindcss.com/docs/background-attachment#scrolling-with-the-container)
    * [Scrolling with the viewport](https://tailwindcss.com/docs/background-attachment#scrolling-with-the-viewport)
