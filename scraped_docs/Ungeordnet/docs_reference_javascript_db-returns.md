---
url: https://supabase.com/docs/reference/javascript/db-returns
scraped_at: 2025-05-25T09:48:10.912464
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/db-returns#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/db-returns#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/db-returns#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/db-returns#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/db-returns#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/db-returns#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/db-returns#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/db-returns#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/db-returns#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/db-returns#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/db-returns#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/db-returns#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/db-returns#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/db-returns#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/db-returns#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/db-returns#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/db-returns#all-changes)
  * `supabase-js`
