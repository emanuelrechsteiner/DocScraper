---
url: https://supabase.com/docs/reference/swift/storage-from-getpublicurl
scraped_at: 2025-05-25T09:04:58.370952
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/storage-from-getpublicurl#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/storage-from-getpublicurl#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/storage-from-getpublicurl#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/storage-from-getpublicurl#swiftui-app-lifecycle)
