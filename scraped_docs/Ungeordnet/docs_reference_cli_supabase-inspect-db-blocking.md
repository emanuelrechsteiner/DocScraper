---
url: https://supabase.com/docs/reference/cli/supabase-inspect-db-blocking
scraped_at: 2025-05-25T09:26:03.870087
...
### Additional links[#](https://supabase.com/docs/reference/cli/supabase-inspect-db-blocking#additional-links)
