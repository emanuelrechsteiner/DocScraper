...
scraped_at: 2025-05-25T09:18:40.351789
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-signout#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-signout#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-signout#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-signout#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-signout#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-signout#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-signout#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-signout#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-signout#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-signout#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-signout#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-signout#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-signout#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-signout#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-signout#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-signout#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-signout#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-signout#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-signout#presence)
