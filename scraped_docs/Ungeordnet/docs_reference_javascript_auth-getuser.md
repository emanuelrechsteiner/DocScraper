...
scraped_at: 2025-05-25T09:30:15.877089
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/auth-getuser#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/auth-getuser#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/auth-getuser#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/auth-getuser#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/auth-getuser#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/auth-getuser#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/auth-getuser#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/auth-getuser#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/auth-getuser#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/auth-getuser#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/auth-getuser#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/auth-getuser#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/auth-getuser#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/auth-getuser#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/auth-getuser#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/auth-getuser#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/auth-getuser#all-changes)
  * `supabase-js`
