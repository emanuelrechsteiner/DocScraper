...
scraped_at: 2025-05-25T09:12:12.129729
title: Working With Arrays | Supabase Docs
---
...
Database
  ...
  3. [Working with arrays](https://supabase.com/docs/guides/database/arrays)
...
3
4
createtablearraytest ( id integernot null, textarray textarray);
...
1
SELECTtextarray[1],array_length(textarray,1) FROMarraytest;
