---
url: https://supabase.com/docs/reference/dart/auth-refreshsession
scraped_at: 2025-05-25T08:56:14.915594
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-refreshsession#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-refreshsession#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-refreshsession#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-refreshsession#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-refreshsession#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-refreshsession#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-refreshsession#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-refreshsession#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-refreshsession#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-refreshsession#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-refreshsession#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-refreshsession#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-refreshsession#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-refreshsession#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-refreshsession#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-refreshsession#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-refreshsession#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-refreshsession#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-refreshsession#presence)
