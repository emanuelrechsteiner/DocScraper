...
scraped_at: 2025-05-25T09:27:40.081040
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/storage-from-list#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/storage-from-list#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/storage-from-list#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/storage-from-list#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/storage-from-list#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/storage-from-list#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/storage-from-list#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/storage-from-list#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/storage-from-list#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/storage-from-list#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/storage-from-list#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/storage-from-list#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/storage-from-list#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/storage-from-list#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/storage-from-list#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/storage-from-list#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/storage-from-list#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/storage-from-list#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/storage-from-list#presence)
