---
url: https://supabase.com/docs/reference/swift/auth-signinwithpassword
scraped_at: 2025-05-25T09:16:17.215421
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/auth-signinwithpassword#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/auth-signinwithpassword#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/auth-signinwithpassword#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/auth-signinwithpassword#swiftui-app-lifecycle)
