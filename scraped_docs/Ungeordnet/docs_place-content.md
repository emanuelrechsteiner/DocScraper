...
scraped_at: 2025-05-25T08:28:37.843156
...
[align-self](https://tailwindcss.com/docs/align-self)[place-items](https://tailwindcss.com/docs/place-items)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/place-content#quick-reference)
  * [Examples](https://tailwindcss.com/docs/place-content#examples)
    * [Center](https://tailwindcss.com/docs/place-content#center)
    * [Start](https://tailwindcss.com/docs/place-content#start)
    * [End](https://tailwindcss.com/docs/place-content#end)
