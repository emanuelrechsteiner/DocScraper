---
url: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages
scraped_at: 2025-05-25T08:58:34.579416
title: Tailwind CSS Order History Pages - Official Tailwind UI Components
---
...
[Page Examples](https://tailwindcss.com/plus/ui-blocks/ecommerce#product-ecommerce-page-examples)
# Order History Pages
Use these Tailwind CSS order history page examples to enable customers to view a record of their past purchases, access details of each order, and track the status of active deliveries. These page examples are designed and built by the Tailwind CSS team, and include a variety of different styles and layouts.
## [Simple](https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-7f9da4e72b3d63e5b35c43829f786ba0)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [With invoice list and quick actions](https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-71d7d7d72af96eb205739097efcb1c87)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [With invoice panels](https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-036712a88c6db4f5399b6387356e119a)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [With invoice tables](https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-a04b3cc22764976dff2cca9f8f420e43)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
## [With invoice list](https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-90bf96c1fb7c25a8887c40ff21cd52da)
Preview
[Get the code →](https://tailwindcss.com/plus/ui-blocks#pricing)
### Marketing
