---
url: https://supabase.com/docs/reference/swift/insert
scraped_at: 2025-05-25T09:27:16.450662
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/insert#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/insert#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/insert#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/insert#swiftui-app-lifecycle)
