---
url: https://supabase.com/docs/reference/self-hosting-auth/verifies-a-sign-up
scraped_at: 2025-05-25T09:04:40.742071
...
### Client libraries[#](https://supabase.com/docs/reference/self-hosting-auth/verifies-a-sign-up#client-libraries)
  * [JavaScript](https://github.com/supabase/gotrue-js)
  * [Dart](https://github.com/supabase/gotrue-dart)


### Additional links[#](https://supabase.com/docs/reference/self-hosting-auth/verifies-a-sign-up#additional-links)
