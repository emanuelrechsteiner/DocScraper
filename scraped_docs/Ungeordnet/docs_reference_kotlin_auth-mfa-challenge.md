---
url: https://supabase.com/docs/reference/kotlin/auth-mfa-challenge
scraped_at: 2025-05-25T09:37:28.680445
...
v3.0
  ...
  * Auth
    ...
    * Auth MFA
[Auth MFA](https://supabase.com/docs/reference/kotlin/auth-mfa-api)
      * [Enroll a factor](https://supabase.com/docs/reference/kotlin/auth-mfa-enroll)
      * [Create a challenge](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge)
      * [Verify a challenge](https://supabase.com/docs/reference/kotlin/auth-mfa-verify)
      * [Create and verify a challenge](https://supabase.com/docs/reference/kotlin/auth-mfa-challengeandverify)
      * [Unenroll a factor](https://supabase.com/docs/reference/kotlin/auth-mfa-unenroll)
      * [Get Authenticator Assurance Level](https://supabase.com/docs/reference/kotlin/auth-mfa-getauthenticatorassurancelevel)
    * Auth Admin
  * Edge Functions
...
## Installing
### Add one or more modules to your project[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required)[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#serialization)
...
## Initializing
### Create Supabase Client[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#create-supabase-client)
...
### OAuth and OTP link verification[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow[#](https://supabase.com/docs/reference/kotlin/auth-mfa-challenge#pkce-authentication-flow)
