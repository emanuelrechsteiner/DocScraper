---
url: https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables
scraped_at: 2025-05-25T09:23:24.711391
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/select?example=query-referenced-tables#all-changes)
  * `supabase-js`
