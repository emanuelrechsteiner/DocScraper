---
url: https://supabase.com/docs/reference/javascript/javascript
scraped_at: 2025-05-25T09:02:07.158991
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/javascript#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/javascript#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/javascript#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/javascript#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/javascript#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/javascript#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/javascript#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/javascript#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/javascript#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/javascript#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/javascript#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/javascript#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/javascript#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/javascript#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/javascript#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/javascript#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/javascript#all-changes)
  * `supabase-js`
