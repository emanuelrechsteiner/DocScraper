---
url: https://supabase.com/docs/reference/javascript/auth-mfa-enroll
scraped_at: 2025-05-25T09:29:43.381777
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/auth-mfa-enroll#all-changes)
  * `supabase-js`
