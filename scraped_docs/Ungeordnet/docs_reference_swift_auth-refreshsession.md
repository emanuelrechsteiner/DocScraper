---
url: https://supabase.com/docs/reference/swift/auth-refreshsession
scraped_at: 2025-05-25T09:03:30.390261
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/auth-refreshsession#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/auth-refreshsession#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/auth-refreshsession#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/auth-refreshsession#swiftui-app-lifecycle)
