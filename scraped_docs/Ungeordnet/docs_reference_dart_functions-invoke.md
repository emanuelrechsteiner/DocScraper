...
scraped_at: 2025-05-25T09:05:43.397495
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/functions-invoke#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/functions-invoke#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/functions-invoke#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/functions-invoke#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/functions-invoke#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/functions-invoke#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/functions-invoke#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/functions-invoke#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/functions-invoke#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/functions-invoke#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/functions-invoke#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/functions-invoke#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/functions-invoke#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/functions-invoke#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/functions-invoke#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/functions-invoke#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/functions-invoke#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/functions-invoke#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/functions-invoke#presence)
