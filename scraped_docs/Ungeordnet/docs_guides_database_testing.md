...
scraped_at: 2025-05-25T08:53:54.068438
title: Testing Your Database | Supabase Docs
---
...
Database
  ...
  3. [Testing your database](https://supabase.com/docs/guides/database/testing)
...
4
5
$supabasetestdbsupabase/tests/database/hello_world.test.sql..okAlltestssuccessful.Files=1,Tests=1,1wallclocksecs ( 0.01usr0.00sys+0.04cusr0.02csys=0.07CPU)Result:PASS
