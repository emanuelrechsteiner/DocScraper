---
url: https://supabase.com/docs/reference/self-hosting-auth/logs-out-the-user
scraped_at: 2025-05-25T09:27:08.941327
...
### Client libraries[#](https://supabase.com/docs/reference/self-hosting-auth/logs-out-the-user#client-libraries)
  * [JavaScript](https://github.com/supabase/gotrue-js)
  * [Dart](https://github.com/supabase/gotrue-dart)


### Additional links[#](https://supabase.com/docs/reference/self-hosting-auth/logs-out-the-user#additional-links)
