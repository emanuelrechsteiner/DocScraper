---
url: https://supabase.com/docs/reference/swift/auth-mfa-challengeandverify
scraped_at: 2025-05-25T09:06:41.676509
...
v2.0
  ...
  * Auth
    ...
    * Auth MFA
[Auth MFA](https://supabase.com/docs/reference/swift/auth-mfa-api)
      * [Enroll a factor](https://supabase.com/docs/reference/swift/auth-mfa-enroll)
      * [Create a challenge](https://supabase.com/docs/reference/swift/auth-mfa-challenge)
      * [Verify a challenge](https://supabase.com/docs/reference/swift/auth-mfa-verify)
      * [Create and verify a challenge](https://supabase.com/docs/reference/swift/auth-mfa-challengeandverify)
      * [Unenroll a factor](https://supabase.com/docs/reference/swift/auth-mfa-unenroll)
      * [Get Authenticator Assurance Level](https://supabase.com/docs/reference/swift/auth-mfa-getauthenticatorassurancelevel)
    * Auth Admin
  * Edge Functions
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/auth-mfa-challengeandverify#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/auth-mfa-challengeandverify#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/auth-mfa-challengeandverify#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/auth-mfa-challengeandverify#swiftui-app-lifecycle)
