...
scraped_at: 2025-05-25T08:41:52.290801
...
[outline-color](https://tailwindcss.com/docs/outline-color)[outline-offset](https://tailwindcss.com/docs/outline-offset)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/outline-style#quick-reference)
  * [Examples](https://tailwindcss.com/docs/outline-style#examples)
    * [Basic example](https://tailwindcss.com/docs/outline-style#basic-example)
    * [Hiding an outline](https://tailwindcss.com/docs/outline-style#hiding-an-outline)
    * [Removing outlines](https://tailwindcss.com/docs/outline-style#removing-outlines)
