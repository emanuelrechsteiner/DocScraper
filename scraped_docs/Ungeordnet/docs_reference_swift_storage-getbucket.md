---
url: https://supabase.com/docs/reference/swift/storage-getbucket
scraped_at: 2025-05-25T09:44:51.338474
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/storage-getbucket#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/storage-getbucket#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/storage-getbucket#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/storage-getbucket#swiftui-app-lifecycle)
