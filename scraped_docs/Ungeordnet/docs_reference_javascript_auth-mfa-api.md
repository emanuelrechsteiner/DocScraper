---
url: https://supabase.com/docs/reference/javascript/auth-mfa-api
scraped_at: 2025-05-25T09:20:08.918057
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/auth-mfa-api#all-changes)
  * `supabase-js`
