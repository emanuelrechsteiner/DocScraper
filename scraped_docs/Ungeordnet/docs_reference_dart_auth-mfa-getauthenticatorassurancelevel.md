---
url: https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel
scraped_at: 2025-05-25T09:21:43.537982
...
v2.0
  ...
  * Auth
    ...
    * Auth MFA
[Auth MFA](https://supabase.com/docs/reference/dart/auth-mfa-api)
      * [Enroll a factor](https://supabase.com/docs/reference/dart/auth-mfa-enroll)
      * [Create a challenge](https://supabase.com/docs/reference/dart/auth-mfa-challenge)
      * [Verify a challenge](https://supabase.com/docs/reference/dart/auth-mfa-verify)
      * [Create and verify a challenge](https://supabase.com/docs/reference/dart/auth-mfa-challengeandverify)
      * [Unenroll a factor](https://supabase.com/docs/reference/dart/auth-mfa-unenroll)
      * [Get Authenticator Assurance Level](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel)
    * Auth Admin
  * Edge Functions
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-mfa-getauthenticatorassurancelevel#presence)
