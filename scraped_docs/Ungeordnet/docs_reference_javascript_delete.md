...
scraped_at: 2025-05-25T09:05:18.268769
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/delete#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/delete#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/delete#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/delete#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/delete#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/delete#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/delete#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/delete#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/delete#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/delete#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/delete#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/delete#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/delete#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/delete#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/delete#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/delete#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/delete#all-changes)
  * `supabase-js`
