...
scraped_at: 2025-05-25T09:39:34.966936
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/storage-createbucket#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/storage-createbucket#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/storage-createbucket#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/storage-createbucket#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/storage-createbucket#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/storage-createbucket#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/storage-createbucket#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/storage-createbucket#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/storage-createbucket#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/storage-createbucket#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/storage-createbucket#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/storage-createbucket#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/storage-createbucket#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/storage-createbucket#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/storage-createbucket#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/storage-createbucket#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/storage-createbucket#all-changes)
  * `supabase-js`
