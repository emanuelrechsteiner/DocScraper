---
url: https://supabase.com/docs/reference/swift/storage-from-download
scraped_at: 2025-05-25T09:33:30.962073
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/storage-from-download#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/storage-from-download#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/storage-from-download#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/storage-from-download#swiftui-app-lifecycle)
