---
url: https://supabase.com/docs/reference/kotlin/update
scraped_at: 2025-05-25T09:45:49.853093
...
## Installing
### Add one or more modules to your project[#](https://supabase.com/docs/reference/kotlin/update#add-one-or-more-modules-to-your-project)
...
### Add Ktor Client Engine to each of your Kotlin targets (required)[#](https://supabase.com/docs/reference/kotlin/update#add-ktor-client-engine-to-each-of-your-kotlin-targets-required)
...
### Serialization[#](https://supabase.com/docs/reference/kotlin/update#serialization)
...
## Initializing
### Create Supabase Client[#](https://supabase.com/docs/reference/kotlin/update#create-supabase-client)
...
### OAuth and OTP link verification[#](https://supabase.com/docs/reference/kotlin/update#oauth-and-otp-link-verification)
...
### Configure deeplink callbacks for Authentication[#](https://supabase.com/docs/reference/kotlin/update#configure-deeplink-callbacks-for-authentication)
...
### PKCE Authentication flow[#](https://supabase.com/docs/reference/kotlin/update#pkce-authentication-flow)
