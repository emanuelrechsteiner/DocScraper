---
url: https://supabase.com/docs/reference/dart/auth-mfa-enroll
scraped_at: 2025-05-25T09:11:07.047813
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-mfa-enroll#presence)
