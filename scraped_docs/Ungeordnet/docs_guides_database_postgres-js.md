...
scraped_at: 2025-05-25T09:16:45.860678
...
Database
  ...
  2. ORM Quickstarts
  3. [Postgres.js](https://supabase.com/docs/guides/database/postgres-js)
...
6
7
// db.jsimportpostgresfrom'postgres'constconnectionString=process.env.DATABASE_URLconstsql=postgres(connectionString)exportdefaultsql
...
10
11
importsqlfrom'./db.js'asyncfunctiongetUsersOver(age){constusers=await sql`selectname, agefrom userswhere age >${age} `// users = Result [{ name: "Walter", age: 80 }, { name: 'Murray', age: 68 }, ...]returnusers}
