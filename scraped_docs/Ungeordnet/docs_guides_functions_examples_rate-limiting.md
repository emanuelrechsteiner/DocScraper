...
scraped_at: 2025-05-25T08:37:11.512415
title: Rate Limiting Edge Functions | Supabase Docs
---
...
Edge Functions
  ...
  2. Examples
  3. [Rate-limiting with Redis](https://supabase.com/docs/guides/functions/examples/rate-limiting)
...
[Edit this page on GitHub ](https://github.com/supabase/supabase/blob/master/apps/docs/content/guides/functions/examples/rate-limiting.mdx)
### Is this helpful?
No Yes
  * Need some help?
