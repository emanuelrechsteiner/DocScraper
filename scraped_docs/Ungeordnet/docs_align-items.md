...
scraped_at: 2025-05-25T09:00:27.031874
...
[align-content](https://tailwindcss.com/docs/align-content)[align-self](https://tailwindcss.com/docs/align-self)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/align-items#quick-reference)
  * [Examples](https://tailwindcss.com/docs/align-items#examples)
    * [Stretch](https://tailwindcss.com/docs/align-items#stretch)
    * [Start](https://tailwindcss.com/docs/align-items#start)
    * [Center](https://tailwindcss.com/docs/align-items#center)
