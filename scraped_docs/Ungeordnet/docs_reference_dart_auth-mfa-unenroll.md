---
url: https://supabase.com/docs/reference/dart/auth-mfa-unenroll
scraped_at: 2025-05-25T09:44:43.201672
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/auth-mfa-unenroll#presence)
