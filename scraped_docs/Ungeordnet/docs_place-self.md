...
scraped_at: 2025-05-25T08:37:37.253633
...
[place-items](https://tailwindcss.com/docs/place-items)[padding](https://tailwindcss.com/docs/padding)
### On this page
  * [Quick reference](https://tailwindcss.com/docs/place-self#quick-reference)
  * [Examples](https://tailwindcss.com/docs/place-self#examples)
    * [Auto](https://tailwindcss.com/docs/place-self#auto)
    * [Start](https://tailwindcss.com/docs/place-self#start)
    * [Center](https://tailwindcss.com/docs/place-self#center)
