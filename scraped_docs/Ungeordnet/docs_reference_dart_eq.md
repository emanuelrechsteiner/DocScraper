...
scraped_at: 2025-05-25T09:12:05.192953
...
## Installing
### Install from pub.dev[#](https://supabase.com/docs/reference/dart/eq#install-from-pubdev)
...
## Upgrade the client library[#](https://supabase.com/docs/reference/dart/eq#upgrade-the-client-library)
...
### Auth updates[#](https://supabase.com/docs/reference/dart/eq#auth-updates)
#### Renaming Provider to OAuthProvider[#](https://supabase.com/docs/reference/dart/eq#renaming-provider-to-oauthprovider)
...
#### Sign in with Apple method deprecated[#](https://supabase.com/docs/reference/dart/eq#sign-in-with-apple-method-deprecated)
...
#### Initialization does not await for session refresh[#](https://supabase.com/docs/reference/dart/eq#initialization-does-not-await-for-session-refresh)
...
#### Removing Flutter Webview dependency for OAuth sign in[#](https://supabase.com/docs/reference/dart/eq#removing-flutter-webview-dependency-for-oauth-sign-in)
...
#### PKCE is the default auth flow type[#](https://supabase.com/docs/reference/dart/eq#pkce-is-the-default-auth-flow-type)
...
#### Auth callback host name parameter removed[#](https://supabase.com/docs/reference/dart/eq#auth-callback-host-name-parameter-removed)
...
#### SupabaseAuth class removed[#](https://supabase.com/docs/reference/dart/eq#supabaseauth-class-removed)
...
### Data methods[#](https://supabase.com/docs/reference/dart/eq#data-methods)
#### Insert and return data[#](https://supabase.com/docs/reference/dart/eq#insert-and-return-data)
...
#### Renaming is and in filter[#](https://supabase.com/docs/reference/dart/eq#renaming-is-and-in-filter)
...
#### Deprecate FetchOption in favor of `count()` and `head()` methods[#](https://supabase.com/docs/reference/dart/eq#deprecate-fetchoption-in-favor-of-count-and-head-methods)
...
#### PostgREST error codes[#](https://supabase.com/docs/reference/dart/eq#postgrest-error-codes)
...
### Realtime methods[#](https://supabase.com/docs/reference/dart/eq#realtime-methods)
...
#### Postgres Changes[#](https://supabase.com/docs/reference/dart/eq#postgres-changes)
...
#### Broadcast[#](https://supabase.com/docs/reference/dart/eq#broadcast)
...
#### Presence[#](https://supabase.com/docs/reference/dart/eq#presence)
