...
scraped_at: 2025-05-25T09:24:41.324115
title: http: RESTful Client | Supabase Docs
---
...
Database
  ...
  2. Extensions
  3. [http: RESTful Client](https://supabase.com/docs/guides/database/extensions/http)
...
4
5
-- Example: enable the "http" extensioncreate extension httpwithschema extensions;-- Example: disable the "http" extensiondrop extension ifexistshttp;
