---
url: https://supabase.com/docs/reference/javascript/auth-reauthentication
scraped_at: 2025-05-25T09:46:46.517772
...
## Installing
### Install as package[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#install-as-package)
...
### Install via CDN[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#install-via-cdn)
...
### Use at runtime in Deno[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#use-at-runtime-in-deno)
...
## Generating TypeScript Types[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#generating-typescript-types)
...
## Using TypeScript type definitions[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#using-typescript-type-definitions)
...
## Helper types for Tables and Joins[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#helper-types-for-tables-and-joins)
...
### Response types for complex queries[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#response-types-for-complex-queries)
...
### Explicit constructor options[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#explicit-constructor-options)
...
### TypeScript support[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#typescript-support)
...
### Data operations return minimal[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#data-operations-return-minimal)
...
### New ordering defaults[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#new-ordering-defaults)
...
### Cookies and localstorage namespace[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#cookies-and-localstorage-namespace)
...
### New Auth Types[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#new-auth-types)
...
### New Auth methods[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#new-auth-methods)
...
### New Realtime methods[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#new-realtime-methods)
...
### Deprecated setAuth()[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#deprecated-setauth)
...
### All changes[#](https://supabase.com/docs/reference/javascript/auth-reauthentication#all-changes)
  * `supabase-js`
