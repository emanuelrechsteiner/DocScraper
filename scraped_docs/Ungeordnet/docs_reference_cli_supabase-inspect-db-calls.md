---
url: https://supabase.com/docs/reference/cli/supabase-inspect-db-calls
scraped_at: 2025-05-25T08:58:47.910295
...
### Additional links[#](https://supabase.com/docs/reference/cli/supabase-inspect-db-calls#additional-links)
