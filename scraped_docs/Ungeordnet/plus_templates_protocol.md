---
url: https://tailwindcss.com/plus/templates/protocol
scraped_at: 2025-05-25T08:31:47.774081
...
React
Next.js
[Live preview](https://tailwindcss.com/plus/templates/protocol/preview)[Get template](https://tailwindcss.com/plus/templates/protocol#pricing)
![](https://tailwindcss.com/plus-assets/img/templates/protocol/screenshot.png)
...
Powered by [MDX](https://mdxjs.com/), we've sweat all the nitty-gritty details to make sure the authoring experience is an awesome one, letting you focus on just writing great API docs, not the tooling around it.
...
## Screenshots
![This is a detail image](https://tailwindcss.com/plus-assets/img/templates/protocol/detail-01.png)![This is a detail image](https://tailwindcss.com/plus-assets/img/templates/protocol/detail-02.png)![This is a detail image](https://tailwindcss.com/plus-assets/img/templates/protocol/detail-03.png)![This is a detail image](https://tailwindcss.com/plus-assets/img/templates/protocol/detail-04.png)
## The technology
...
React
Next.js
Protocol — API reference template
89 €
one time payment
plus local taxes
[Get template](https://tailwindcss.com/plus/checkout/6ef9edc3-1962-45a4-968a-c307b2cb8001)
