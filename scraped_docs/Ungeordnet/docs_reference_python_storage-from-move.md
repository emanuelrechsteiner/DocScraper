---
url: https://supabase.com/docs/reference/python/storage-from-move
scraped_at: 2025-05-25T09:29:33.888590
...
## Installing
### Install with PyPi[#](https://supabase.com/docs/reference/python/storage-from-move#install-with-pypi)
