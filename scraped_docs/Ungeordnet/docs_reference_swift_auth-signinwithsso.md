---
url: https://supabase.com/docs/reference/swift/auth-signinwithsso
scraped_at: 2025-05-25T09:08:22.958738
...
## Installing
### Install using Swift Package Manager[#](https://supabase.com/docs/reference/swift/auth-signinwithsso#install-using-swift-package-manager)
...
### Handling deep links[#](https://supabase.com/docs/reference/swift/auth-signinwithsso#handling-deep-links)
#### UIKit app lifecycle[#](https://supabase.com/docs/reference/swift/auth-signinwithsso#uikit-app-lifecycle)
```
...
#### SwiftUI app lifecycle[#](https://supabase.com/docs/reference/swift/auth-signinwithsso#swiftui-app-lifecycle)
