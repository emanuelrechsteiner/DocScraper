...
scraped_at: 2025-05-24T22:26:57.763985
...
Open in Copy
Airplane Mode
## [](https://ui.shadcn.com/docs/components/switch#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/switch#usage)Usage
```
...
```
Copy
## [](https://ui.shadcn.com/docs/components/switch#examples)Examples
### [](https://ui.shadcn.com/docs/components/switch#form)Form
PreviewCode
Style: New York
Copy
### Email Notifications
