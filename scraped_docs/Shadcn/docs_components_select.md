...
scraped_at: 2025-05-24T22:27:41.807844
...
Open in Copy
Select a fruit
## [](https://ui.shadcn.com/docs/components/select#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/select#usage)Usage
```
import {
 Select,
 SelectContent,
...
```
Copy
## [](https://ui.shadcn.com/docs/components/select#examples)Examples
### [](https://ui.shadcn.com/docs/components/select#scrollable)Scrollable
PreviewCode
Style: New York
Open in Copy
Select a timezone
### [](https://ui.shadcn.com/docs/components/select#form)Form
PreviewCode
Style: New York
Copy
