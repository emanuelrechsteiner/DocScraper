...
scraped_at: 2025-05-24T22:27:20.042397
...
Style: New York
Open in Copy
## [](https://ui.shadcn.com/docs/components/toggle#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/toggle#usage)Usage
```
...
```
Copy
## [](https://ui.shadcn.com/docs/components/toggle#examples)Examples
### [](https://ui.shadcn.com/docs/components/toggle#default)Default
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/toggle#outline)Outline
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/toggle#with-text)With Text
PreviewCode
Style: New York
Open in Copy
Italic
### [](https://ui.shadcn.com/docs/components/toggle#small)Small
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/toggle#large)Large
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/toggle#disabled)Disabled
PreviewCode
Style: New York
Open in Copy
