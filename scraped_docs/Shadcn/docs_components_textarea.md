...
scraped_at: 2025-05-24T22:27:36.422143
...
Style: New York
Open in Copy
## [](https://ui.shadcn.com/docs/components/textarea#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/textarea#usage)Usage
```
...
```
Copy
## [](https://ui.shadcn.com/docs/components/textarea#examples)Examples
### [](https://ui.shadcn.com/docs/components/textarea#default)Default
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/textarea#disabled)Disabled
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/textarea#with-label)With Label
PreviewCode
Style: New York
Open in Copy
Your message
### [](https://ui.shadcn.com/docs/components/textarea#with-text)With Text
PreviewCode
Style: New York
Open in Copy
Your Message
Your message will be copied to the support team.
### [](https://ui.shadcn.com/docs/components/textarea#with-button)With Button
PreviewCode
Style: New York
Open in Copy
Send message
### [](https://ui.shadcn.com/docs/components/textarea#form)Form
PreviewCode
Style: New York
Copy
Bio
