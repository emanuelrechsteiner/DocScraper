...
scraped_at: 2025-05-24T22:26:28.007883
...
Open in Copy
@nextjs
## [](https://ui.shadcn.com/docs/components/hover-card#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/hover-card#usage)Usage
```
import {
 HoverCard,
 HoverCardContent,
