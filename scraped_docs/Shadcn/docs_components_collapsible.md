...
scraped_at: 2025-05-24T22:27:48.242521
...
Toggle
@radix-ui/primitives
## [](https://ui.shadcn.com/docs/components/collapsible#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/collapsible#usage)Usage
```
import {
 Collapsible,
 CollapsibleContent,
