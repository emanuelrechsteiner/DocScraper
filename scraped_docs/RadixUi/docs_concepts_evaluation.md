...
scraped_at: 2025-05-25T17:57:01.081528
title: Evaluation | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/concepts/evaluation/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/concepts/evaluation/)
...
[v0.3](https://python.langchain.com/docs/concepts/evaluation/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/concepts/evaluation/)
...
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/concepts/evaluation.mdx)
# Evaluation
...
[PreviousEmbedding models](https://python.langchain.com/docs/concepts/embedding_models/)[NextExample selectors](https://python.langchain.com/docs/concepts/example_selectors/)
Community
