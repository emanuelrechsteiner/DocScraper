---
url: https://python.langchain.com/docs/integrations/document_loaders/google_firestore/
scraped_at: 2025-05-25T18:15:57.638190
title: Google Firestore (Native Mode) | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/)
...
## Before You Begin[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#before-you-begin "Direct link to Before You Begin")
...
### 🦜🔗 Library Installation[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#-library-installation "Direct link to 🦜🔗 Library Installation")
...
### ☁ Set Your Google Cloud Project[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#-set-your-google-cloud-project "Direct link to ☁ Set Your Google Cloud Project")
...
### 🔐 Authentication[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#-authentication "Direct link to 🔐 Authentication")
...
## Basic Usage[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#basic-usage "Direct link to Basic Usage")
### Save documents[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#save-documents "Direct link to Save documents")
...
#### Save documents without reference[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#save-documents-without-reference "Direct link to Save documents without reference")
...
#### Save documents with other references[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#save-documents-with-other-references "Direct link to Save documents with other references")
```
doc_ids =["AnotherCollection/doc_id","foo/bar"]saver = FirestoreSaver()saver.upsert_documents(documents=data, document_ids=doc_ids)
```

### Load from Collection or SubCollection[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-from-collection-or-subcollection "Direct link to Load from Collection or SubCollection")
...
### Load a single Document[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-a-single-document "Direct link to Load a single Document")
```
...
### Load from CollectionGroup or Query[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-from-collectiongroup-or-query "Direct link to Load from CollectionGroup or Query")
```
...
### Delete documents[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#delete-documents "Direct link to Delete documents")
...
## Advanced Usage[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#advanced-usage "Direct link to Advanced Usage")
### Load documents with customize document page content & metadata[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-documents-with-customize-document-page-content--metadata "Direct link to Load documents with customize document page content & metadata")
...
#### Customize Page Content Format[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#customize-page-content-format "Direct link to Customize Page Content Format")
...
### Customize Connection & Authentication[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#customize-connection--authentication "Direct link to Customize Connection & Authentication")
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/google_firestore.ipynb)
#### Was this page helpful?
[PreviousGoogle El Carro for Oracle Workloads](https://python.langchain.com/docs/integrations/document_loaders/google_el_carro/)[NextGoogle Memorystore for Redis](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/)
  * [Before You Begin](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#before-you-begin)
    * [🦜🔗 Library Installation](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#-library-installation)
    * [☁ Set Your Google Cloud Project](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#-set-your-google-cloud-project)
    * [🔐 Authentication](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#-authentication)
  * [Basic Usage](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#basic-usage)
    * [Save documents](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#save-documents)
    * [Load from Collection or SubCollection](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-from-collection-or-subcollection)
    * [Load a single Document](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-a-single-document)
    * [Load from CollectionGroup or Query](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-from-collectiongroup-or-query)
    * [Delete documents](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#delete-documents)
  * [Advanced Usage](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#advanced-usage)
    * [Load documents with customize document page content & metadata](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#load-documents-with-customize-document-page-content--metadata)
    * [Customize Connection & Authentication](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#customize-connection--authentication)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/#related)
