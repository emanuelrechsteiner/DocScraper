...
scraped_at: 2025-05-25T18:13:30.790581
title: IMSDbLoader — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#main-content)
Back to top `⌘`+`K`
...
# IMSDbLoader[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#imsdbloader "Link to this heading") 

_class_ langchain_community.document_loaders.imsdb.IMSDbLoader( 
    _web_path :str|Sequence[str]=''_,     _header_template :dict|None=None_,     _verify_ssl :bool=True_,     _proxies :dict|None=None_,     _continue_on_failure :bool=False_,     _autoset_encoding :bool=True_,     _encoding :str|None=None_,     _web_paths :Sequence[str]=()_,     _requests_per_second :int=2_,     _default_parser :str='html.parser'_,     _requests_kwargs :Dict[str,Any]|None=None_,     _raise_for_status :bool=False_,     _bs_get_text_kwargs :Dict[str,Any]|None=None_,     _bs_kwargs :Dict[str,Any]|None=None_,     _session :Any=None_,     _*_ ,     _show_progress :bool=True_,     _trust_env :bool=False_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/imsdb.html#IMSDbLoader)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader "Link to this definition")     
Load IMSDb webpages.
Initialize loader. 

Parameters:
    
  * **web_paths** (_Sequence_ _[__str_ _]_) – Web paths to load from.
  * **requests_per_second** (_int_) – Max number of concurrent requests to make.
  * **default_parser** (_str_) – Default parser to use for BeautifulSoup.
  * **requests_kwargs** (_Dict_ _[__str_ _,__Any_ _]__|__None_) – kwargs for requests
  * **raise_for_status** (_bool_) – Raise an exception if http status code denotes an error.
  * **bs_get_text_kwargs** (_Dict_ _[__str_ _,__Any_ _]__|__None_) – kwargs for beatifulsoup4 get_text
  * **bs_kwargs** (_Dict_ _[__str_ _,__Any_ _]__|__None_) – kwargs for beatifulsoup4 web page parsing
  * **show_progress** (_bool_) – Show progress bar when loading pages.
  * **trust_env** (_bool_) – set to True if using proxy to make web requests, for example using http(s)_proxy environment variables. Defaults to False.
  * **web_path** (_str_ _|__Sequence_ _[__str_ _]_)
  * **header_template** (_dict_ _|__None_)
  * **verify_ssl** (_bool_)
  * **proxies** (_dict_ _|__None_)
  * **continue_on_failure** (_bool_)
  * **autoset_encoding** (_bool_)
...
---|---  
Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.__init__ "langchain_community.document_loaders.imsdb.IMSDbLoader.__init__")([web_path, header_template, ...]) | Initialize loader.  
---|---  
[`alazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.alazy_load "langchain_community.document_loaders.imsdb.IMSDbLoader.alazy_load")() | Async lazy load text from the url(s) in web_path.  
[`aload`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.aload "langchain_community.document_loaders.imsdb.IMSDbLoader.aload")() |   
[`ascrape_all`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.ascrape_all "langchain_community.document_loaders.imsdb.IMSDbLoader.ascrape_all")(urls[, parser]) | Async fetch all urls, then return soups for all results.  
[`fetch_all`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.fetch_all "langchain_community.document_loaders.imsdb.IMSDbLoader.fetch_all")(urls) | Fetch all urls concurrently with rate limiting.  
[`lazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.lazy_load "langchain_community.document_loaders.imsdb.IMSDbLoader.lazy_load")() | Lazy load text from the url(s) in web_path.  
[`load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.load "langchain_community.document_loaders.imsdb.IMSDbLoader.load")() | Load webpage.  
[`load_and_split`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.load_and_split "langchain_community.document_loaders.imsdb.IMSDbLoader.load_and_split")([text_splitter]) | Load Documents and split into chunks.  
[`scrape`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.scrape "langchain_community.document_loaders.imsdb.IMSDbLoader.scrape")([parser]) | Scrape data from webpage and return it in BeautifulSoup format.  
[`scrape_all`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.scrape_all "langchain_community.document_loaders.imsdb.IMSDbLoader.scrape_all")(urls[, parser]) | Fetch all urls, then return soups for all results. 

__init__( 
    _web_path :str|Sequence[str]=''_,     _header_template :dict|None=None_,     _verify_ssl :bool=True_,     _proxies :dict|None=None_,     _continue_on_failure :bool=False_,     _autoset_encoding :bool=True_,     _encoding :str|None=None_,     _web_paths :Sequence[str]=()_,     _requests_per_second :int=2_,     _default_parser :str='html.parser'_,     _requests_kwargs :Dict[str,Any]|None=None_,     _raise_for_status :bool=False_,     _bs_get_text_kwargs :Dict[str,Any]|None=None_,     _bs_kwargs :Dict[str,Any]|None=None_,     _session :Any=None_,     _*_ ,     _show_progress :bool=True_,     _trust_env :bool=False_, ) → None[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.__init__ "Link to this definition")       
Initialize loader. 
...
aload() → List[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.aload "Link to this definition")
...
_async_ ascrape_all( 
    _urls :List[str]_,     _parser :str|None=None_, ) → List[Any][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.ascrape_all "Link to this definition")     
...
_async_ fetch_all( 
    _urls :List[str]_, ) → Any[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.fetch_all "Link to this definition")     
...
lazy_load() → Iterator[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.lazy_load "Link to this definition")
...
load() → List[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/imsdb.html#IMSDbLoader.load)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.load "Link to this definition")
...
load_and_split( 
    _text_splitter :[TextSplitter](https://python.langchain.com/api_reference/text_splitters/base/langchain_text_splitters.base.TextSplitter.html#langchain_text_splitters.base.TextSplitter "langchain_text_splitters.base.TextSplitter")|None=None_, ) → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.load_and_split "Link to this definition")     
...
scrape(_parser :str|None=None_) → Any[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.scrape "Link to this definition")
...
scrape_all( 
    _urls :List[str]_,     _parser :str|None=None_, ) → List[Any][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.scrape_all "Link to this definition")     
...
On this page 
  * [`IMSDbLoader`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.__init__)
    * [`alazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.alazy_load)
    * [`aload()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.aload)
    * [`ascrape_all()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.ascrape_all)
    * [`fetch_all()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.fetch_all)
    * [`lazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.lazy_load)
    * [`load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.load)
    * [`load_and_split()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.load_and_split)
    * [`scrape()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.scrape)
    * [`scrape_all()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.imsdb.IMSDbLoader.html#langchain_community.document_loaders.imsdb.IMSDbLoader.scrape_all)
