...
scraped_at: 2025-05-25T18:02:01.620108
title: TiDBLoader — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#main-content)
Back to top `⌘`+`K`
...
# TiDBLoader[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#tidbloader "Link to this heading") 

_class_ langchain_community.document_loaders.tidb.TiDBLoader( 
    _connection_string :str_,     _query :str_,     _page_content_columns :List[str]|None=None_,     _metadata_columns :List[str]|None=None_,     _engine_args :Dict[str,Any]|None=None_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/tidb.html#TiDBLoader)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader "Link to this definition")     
Load documents from TiDB.
Initialize TiDB document loader. 

Parameters:
    
  * **connection_string** (_str_) – The connection string for the TiDB database, format: “mysql+pymysql://root@127.0.0.1:4000/test”.
  * **query** (_str_) – The query to run in TiDB.
  * **page_content_columns** (_List_ _[__str_ _]__|__None_) – Optional. Columns written to Document page_content, default(None) to all columns.
  * **metadata_columns** (_List_ _[__str_ _]__|__None_) – Optional. Columns written to Document metadata, default(None) to no columns.
  * **engine_args** (_Dict_ _[__str_ _,__Any_ _]__|__None_) – Optional. Additional arguments to pass to sqlalchemy engine.


Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.__init__ "langchain_community.document_loaders.tidb.TiDBLoader.__init__")(connection_string, query[, ...]) | Initialize TiDB document loader.  
---|---  
[`alazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.alazy_load "langchain_community.document_loaders.tidb.TiDBLoader.alazy_load")() | A lazy loader for Documents.  
[`aload`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.aload "langchain_community.document_loaders.tidb.TiDBLoader.aload")() | Load data into Document objects.  
[`lazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.lazy_load "langchain_community.document_loaders.tidb.TiDBLoader.lazy_load")() | Lazy load TiDB data into document objects.  
[`load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.load "langchain_community.document_loaders.tidb.TiDBLoader.load")() | Load data into Document objects.  
[`load_and_split`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.load_and_split "langchain_community.document_loaders.tidb.TiDBLoader.load_and_split")([text_splitter]) | Load Documents and split into chunks. 

__init__( 
    _connection_string :str_,     _query :str_,     _page_content_columns :List[str]|None=None_,     _metadata_columns :List[str]|None=None_,     _engine_args :Dict[str,Any]|None=None_, ) → None[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/tidb.html#TiDBLoader.__init__)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.__init__ "Link to this definition")       
Initialize TiDB document loader. 
...
_async_ aload() → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.aload "Link to this definition")
...
lazy_load() → Iterator[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/tidb.html#TiDBLoader.lazy_load)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.lazy_load "Link to this definition")
...
load() → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.load "Link to this definition")
...
load_and_split( 
    _text_splitter :[TextSplitter](https://python.langchain.com/api_reference/text_splitters/base/langchain_text_splitters.base.TextSplitter.html#langchain_text_splitters.base.TextSplitter "langchain_text_splitters.base.TextSplitter")|None=None_, ) → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.load_and_split "Link to this definition")     
...
On this page 
  * [`TiDBLoader`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.__init__)
    * [`alazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.alazy_load)
    * [`aload()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.aload)
    * [`lazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.lazy_load)
    * [`load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.load)
    * [`load_and_split()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.tidb.TiDBLoader.html#langchain_community.document_loaders.tidb.TiDBLoader.load_and_split)
