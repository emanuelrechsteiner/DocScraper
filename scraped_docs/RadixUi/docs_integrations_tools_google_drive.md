---
url: https://python.langchain.com/docs/integrations/tools/google_drive/
scraped_at: 2025-05-25T18:04:23.848276
title: Google Drive | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/google_drive/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/google_drive/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/google_drive/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/google_drive/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/google_drive/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/google_drive/)
...
## Instructions for retrieving your Google Docs data[​](https://python.langchain.com/docs/integrations/tools/google_drive/#instructions-for-retrieving-your-google-docs-data "Direct link to Instructions for retrieving your Google Docs data")
...
## Use the tool within a ReAct agent[​](https://python.langchain.com/docs/integrations/tools/google_drive/#use-the-tool-within-a-react-agent "Direct link to Use the tool within a ReAct agent")
...
## Related[​](https://python.langchain.com/docs/integrations/tools/google_drive/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/google_drive.ipynb)
#### Was this page helpful?
[PreviousGoogle Cloud Text-to-Speech](https://python.langchain.com/docs/integrations/tools/google_cloud_texttospeech/)[NextGoogle Finance](https://python.langchain.com/docs/integrations/tools/google_finance/)
  * [Prerequisites](https://python.langchain.com/docs/integrations/tools/google_drive/#prerequisites)
  * [Instructions for retrieving your Google Docs data](https://python.langchain.com/docs/integrations/tools/google_drive/#instructions-for-retrieving-your-google-docs-data)
  * [Use the tool within a ReAct agent](https://python.langchain.com/docs/integrations/tools/google_drive/#use-the-tool-within-a-react-agent)
  * [Related](https://python.langchain.com/docs/integrations/tools/google_drive/#related)
