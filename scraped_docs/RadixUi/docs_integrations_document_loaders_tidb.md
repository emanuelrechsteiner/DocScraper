---
url: https://python.langchain.com/docs/integrations/document_loaders/tidb
scraped_at: 2025-05-25T18:00:52.230963
title: TiDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/tidb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/tidb/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/tidb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/tidb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/tidb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/tidb/)
...
## Prerequisites[​](https://python.langchain.com/docs/integrations/document_loaders/tidb/#prerequisites "Direct link to Prerequisites")
...
```
import getpass# copy from tidb cloud console，replace it with your owntidb_connection_string_template ="mysql+pymysql://<USER>:<PASSWORD>@<HOST>:4000/<DB>?ssl_ca=/etc/ssl/cert.pem&ssl_verify_cert=true&ssl_verify_identity=true"tidb_password = getpass.getpass("Input your TiDB password:")tidb_connection_string = tidb_connection_string_template.replace("<PASSWORD>", tidb_password)
```

## Load Data from TiDB[​](https://python.langchain.com/docs/integrations/document_loaders/tidb/#load-data-from-tidb "Direct link to Load Data from TiDB")
...
```
------------------------------content: name: Item 1description: Description of Item 1metada: {'id': 1}------------------------------content: name: Item 2description: Description of Item 2metada: {'id': 2}------------------------------content: name: Item 3description: Description of Item 3metada: {'id': 3}
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/tidb/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/tidb.ipynb)
#### Was this page helpful?
[PreviousTensorFlow Datasets](https://python.langchain.com/docs/integrations/document_loaders/tensorflow_datasets/)[Next2Markdown](https://python.langchain.com/docs/integrations/document_loaders/tomarkdown/)
  * [Prerequisites](https://python.langchain.com/docs/integrations/document_loaders/tidb/#prerequisites)
  * [Load Data from TiDB](https://python.langchain.com/docs/integrations/document_loaders/tidb/#load-data-from-tidb)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/tidb/#related)
