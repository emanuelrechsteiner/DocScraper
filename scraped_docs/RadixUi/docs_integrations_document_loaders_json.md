---
url: https://python.langchain.com/docs/integrations/document_loaders/json
scraped_at: 2025-05-25T18:05:17.732043
title: JSONLoader | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/json/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/json/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/json/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/json/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/json/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/json/)
...
## Overview[​](https://python.langchain.com/docs/integrations/document_loaders/json/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/document_loaders/json/#integration-details "Direct link to Integration details")
...
### Loader features[​](https://python.langchain.com/docs/integrations/document_loaders/json/#loader-features "Direct link to Loader features")
Source| Document Lazy Loading| Native Async Support  
---|---|---  
JSONLoader| ✅| ❌  
## Setup[​](https://python.langchain.com/docs/integrations/document_loaders/json/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/document_loaders/json/#credentials "Direct link to Credentials")
...
### Installation[​](https://python.langchain.com/docs/integrations/document_loaders/json/#installation "Direct link to Installation")
Install **langchain_community** and **jq** :
```
%pip install -qU langchain_community jq 
```

## Initialization[​](https://python.langchain.com/docs/integrations/document_loaders/json/#initialization "Direct link to Initialization")
Now we can instantiate our model object and load documents:
  * TODO: Update model instantiation with relevant params.


```
from langchain_community.document_loaders import JSONLoaderloader = JSONLoader(  file_path="./example_data/facebook_chat.json",  jq_schema=".messages[].content",  text_content=False,)
```
...
## Load[​](https://python.langchain.com/docs/integrations/document_loaders/json/#load "Direct link to Load")
```
...
## Lazy Load[​](https://python.langchain.com/docs/integrations/document_loaders/json/#lazy-load "Direct link to Lazy Load")
```
pages =[]for doc in loader.lazy_load():  pages.append(doc)iflen(pages)>=10:# do some paged operation, e.g.# index.upsert(pages)    pages =[]
```

## Read from JSON Lines file[​](https://python.langchain.com/docs/integrations/document_loaders/json/#read-from-json-lines-file "Direct link to Read from JSON Lines file")
...
```
loader = JSONLoader(  file_path="./example_data/facebook_chat_messages.jsonl",  jq_schema=".content",  text_content=False,  json_lines=True,)docs = loader.load()print(docs[0])
```
...
## Read specific content keys[​](https://python.langchain.com/docs/integrations/document_loaders/json/#read-specific-content-keys "Direct link to Read specific content keys")
Another option is to set `jq_schema='.'` and provide a `content_key` in order to only load specific content:
```
loader = JSONLoader(  file_path="./example_data/facebook_chat_messages.jsonl",  jq_schema=".",  content_key="sender_name",  json_lines=True,)docs = loader.load()print(docs[0])
```
...
## JSON file with jq schema `content_key`[​](https://python.langchain.com/docs/integrations/document_loaders/json/#json-file-with-jq-schema-content_key "Direct link to json-file-with-jq-schema-content_key")
...
```
loader = JSONLoader(  file_path="./example_data/facebook_chat.json",  jq_schema=".messages[]",  content_key=".content",  is_content_key_jq_parsable=True,)docs = loader.load()print(docs[0])
```
...
## Extracting metadata[​](https://python.langchain.com/docs/integrations/document_loaders/json/#extracting-metadata "Direct link to Extracting metadata")
...
## API reference[​](https://python.langchain.com/docs/integrations/document_loaders/json/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/json/#related "Direct link to Related")
...
[PreviousJoplin](https://python.langchain.com/docs/integrations/document_loaders/joplin/)[NextJupyter Notebook](https://python.langchain.com/docs/integrations/document_loaders/jupyter_notebook/)
  * [Overview](https://python.langchain.com/docs/integrations/document_loaders/json/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/document_loaders/json/#integration-details)
    * [Loader features](https://python.langchain.com/docs/integrations/document_loaders/json/#loader-features)
  * [Setup](https://python.langchain.com/docs/integrations/document_loaders/json/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/document_loaders/json/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/document_loaders/json/#installation)
  * [Initialization](https://python.langchain.com/docs/integrations/document_loaders/json/#initialization)
  * [Load](https://python.langchain.com/docs/integrations/document_loaders/json/#load)
  * [Lazy Load](https://python.langchain.com/docs/integrations/document_loaders/json/#lazy-load)
  * [Read from JSON Lines file](https://python.langchain.com/docs/integrations/document_loaders/json/#read-from-json-lines-file)
  * [Read specific content keys](https://python.langchain.com/docs/integrations/document_loaders/json/#read-specific-content-keys)
  * [JSON file with jq schema `content_key`](https://python.langchain.com/docs/integrations/document_loaders/json/#json-file-with-jq-schema-content_key)
  * [Extracting metadata](https://python.langchain.com/docs/integrations/document_loaders/json/#extracting-metadata)
  * [API reference](https://python.langchain.com/docs/integrations/document_loaders/json/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/json/#related)
