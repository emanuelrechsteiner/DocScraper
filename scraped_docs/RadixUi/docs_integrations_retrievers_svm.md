---
url: https://python.langchain.com/docs/integrations/retrievers/svm/
scraped_at: 2025-05-25T18:06:43.474313
title: SVM | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/retrievers/svm/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/retrievers/svm/)
...
[v0.3](https://python.langchain.com/docs/integrations/retrievers/svm/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/retrievers/svm/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/retrievers/svm/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/retrievers/svm/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/svm.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/svm.ipynb)
# SVM
...
## Create New Retriever with Texts[​](https://python.langchain.com/docs/integrations/retrievers/svm/#create-new-retriever-with-texts "Direct link to Create New Retriever with Texts")
```
retriever = SVMRetriever.from_texts(["foo","bar","world","hello","foo bar"], OpenAIEmbeddings())
```

## Use Retriever[​](https://python.langchain.com/docs/integrations/retrievers/svm/#use-retriever "Direct link to Use Retriever")
...
## Related[​](https://python.langchain.com/docs/integrations/retrievers/svm/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/retrievers/svm.ipynb)
#### Was this page helpful?
[PreviousWeaviate](https://python.langchain.com/docs/integrations/retrievers/self_query/weaviate_self_query/)[NextTavilySearchAPI](https://python.langchain.com/docs/integrations/retrievers/tavily/)
  * [Create New Retriever with Texts](https://python.langchain.com/docs/integrations/retrievers/svm/#create-new-retriever-with-texts)
  * [Use Retriever](https://python.langchain.com/docs/integrations/retrievers/svm/#use-retriever)
  * [Related](https://python.langchain.com/docs/integrations/retrievers/svm/#related)
