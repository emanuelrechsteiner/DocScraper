...
scraped_at: 2025-05-25T18:13:27.219415
title: StarRocks | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/vectorstores/starrocks/)
...
[v0.3](https://python.langchain.com/docs/integrations/vectorstores/starrocks/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/vectorstores/starrocks/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/vectorstores/starrocks/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/vectorstores/starrocks/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/starrocks.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/starrocks.ipynb)
# StarRocks
...
## Setup[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#setup "Direct link to Setup")
```
...
## Load docs and split them into tokens[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#load-docs-and-split-them-into-tokens "Direct link to Load docs and split them into tokens")
...
## Create vectordb instance[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#create-vectordb-instance "Direct link to Create vectordb instance")
### Use StarRocks as vectordb[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#use-starrocks-as-vectordb "Direct link to Use StarRocks as vectordb")
```
defgen_starrocks(update_vectordb, embeddings, settings):if update_vectordb:    docsearch = StarRocks.from_documents(split_docs, embeddings, config=settings)else:    docsearch = StarRocks(embeddings, settings)return docsearch
```

## Convert tokens into embeddings and put them into vectordb[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#convert-tokens-into-embeddings-and-put-them-into-vectordb "Direct link to Convert tokens into embeddings and put them into vectordb")
...
## Build QA and ask question to it[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#build-qa-and-ask-question-to-it "Direct link to Build QA and ask question to it")
```
...
## Related[​](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/vectorstores/starrocks.ipynb)
#### Was this page helpful?
[PreviousSQLServer](https://python.langchain.com/docs/integrations/vectorstores/sqlserver/)[NextSupabase (Postgres)](https://python.langchain.com/docs/integrations/vectorstores/supabase/)
  * [Setup](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#setup)
  * [Load docs and split them into tokens](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#load-docs-and-split-them-into-tokens)
  * [Create vectordb instance](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#create-vectordb-instance)
    * [Use StarRocks as vectordb](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#use-starrocks-as-vectordb)
  * [Convert tokens into embeddings and put them into vectordb](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#convert-tokens-into-embeddings-and-put-them-into-vectordb)
  * [Build QA and ask question to it](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#build-qa-and-ask-question-to-it)
  * [Related](https://python.langchain.com/docs/integrations/vectorstores/starrocks/#related)
