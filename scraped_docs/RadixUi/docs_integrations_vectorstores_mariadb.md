...
scraped_at: 2025-05-25T18:15:11.147132
title: MariaDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/vectorstores/mariadb/)
...
[v0.3](https://python.langchain.com/docs/integrations/vectorstores/mariadb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/vectorstores/mariadb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/vectorstores/mariadb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/vectorstores/mariadb/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/mariadb.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/mariadb.ipynb)
# MariaDB
...
## Setup[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#setup "Direct link to Setup")
...
### Installing the Package[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#installing-the-package "Direct link to Installing the Package")
...
## Initialization[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#initialization "Direct link to Initialization")
```
...
## Manage vector store[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#manage-vector-store "Direct link to Manage vector store")
### Adding Data[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#adding-data "Direct link to Adding Data")
...
## Query vector store[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#query-vector-store "Direct link to Query vector store")
```
...
### Filter Options[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#filter-options "Direct link to Filter Options")
...
## Usage for retrieval-augmented generation[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#usage-for-retrieval-augmented-generation "Direct link to Usage for retrieval-augmented generation")
TODO: document example
## API reference[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#api-reference "Direct link to API reference")
See the repo [here](https://github.com/mariadb-corporation/langchain-mariadb) for more detail.
## Related[​](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/vectorstores/mariadb.ipynb)
#### Was this page helpful?
[PreviousManticoreSearch VectorStore](https://python.langchain.com/docs/integrations/vectorstores/manticore_search/)[NextMarqo](https://python.langchain.com/docs/integrations/vectorstores/marqo/)
  * [Setup](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#setup)
    * [Installing the Package](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#installing-the-package)
  * [Initialization](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#initialization)
  * [Manage vector store](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#manage-vector-store)
    * [Adding Data](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#adding-data)
  * [Query vector store](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#query-vector-store)
    * [Filter Options](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#filter-options)
  * [Usage for retrieval-augmented generation](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#usage-for-retrieval-augmented-generation)
  * [API reference](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/vectorstores/mariadb/#related)
