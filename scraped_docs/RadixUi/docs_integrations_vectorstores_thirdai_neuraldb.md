---
url: https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/
scraped_at: 2025-05-25T17:59:03.344345
title: ThirdAI NeuralDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/)
...
[v0.3](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/thirdai_neuraldb.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/thirdai_neuraldb.ipynb)
# ThirdAI NeuralDB
...
## Initialization[​](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#initialization "Direct link to Initialization")
...
```
from langchain_community.vectorstores import NeuralDBVectorStore# From scratchvectorstore = NeuralDBVectorStore.from_scratch(thirdai_key="your-thirdai-key")# From checkpointvectorstore = NeuralDBVectorStore.from_checkpoint(# Path to a NeuralDB checkpoint. For example, if you call# vectorstore.save("/path/to/checkpoint.ndb") in one script, then you can# call NeuralDBVectorStore.from_checkpoint("/path/to/checkpoint.ndb") in# another script to load the saved model.  checkpoint="/path/to/checkpoint.ndb",  thirdai_key="your-thirdai-key",)
```

**API Reference:**[NeuralDBVectorStore](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.thirdai_neuraldb.NeuralDBVectorStore.html)
## Inserting document sources[​](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#inserting-document-sources "Direct link to Inserting document sources")
```
...
## Similarity search[​](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#similarity-search "Direct link to Similarity search")
...
## Fine tuning[​](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#fine-tuning "Direct link to Fine tuning")
...
## Related[​](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/vectorstores/thirdai_neuraldb.ipynb)
#### Was this page helpful?
[PreviousTencent Cloud VectorDB](https://python.langchain.com/docs/integrations/vectorstores/tencentvectordb/)[NextTiDB Vector](https://python.langchain.com/docs/integrations/vectorstores/tidb_vector/)
  * [Initialization](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#initialization)
  * [Inserting document sources](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#inserting-document-sources)
  * [Similarity search](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#similarity-search)
  * [Fine tuning](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#fine-tuning)
  * [Related](https://python.langchain.com/docs/integrations/vectorstores/thirdai_neuraldb/#related)
