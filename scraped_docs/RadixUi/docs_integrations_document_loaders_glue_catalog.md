---
url: https://python.langchain.com/docs/integrations/document_loaders/glue_catalog
scraped_at: 2025-05-25T18:08:06.891072
title: Glue Catalog | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/)
...
## Setting up[​](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#setting-up "Direct link to Setting up")
...
## Example[​](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#example "Direct link to Example")
```
...
```
database_name ="my_database"profile_name ="my_profile"loader = GlueCatalogLoader(  database=database_name,  profile_name=profile_name,)schemas = loader.load()print(schemas)
```

## Example with table filtering[​](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#example-with-table-filtering "Direct link to Example with table filtering")
...
**API Reference:**[GlueCatalogLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.glue_catalog.GlueCatalogLoader.html)
```
database_name ="my_database"profile_name ="my_profile"table_filter =["table1","table2","table3"]loader = GlueCatalogLoader(  database=database_name, profile_name=profile_name, table_filter=table_filter)schemas = loader.load()print(schemas)
```

## Related[​](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/glue_catalog.ipynb)
#### Was this page helpful?
[PreviousGitHub](https://python.langchain.com/docs/integrations/document_loaders/github/)[NextGoogle AlloyDB for PostgreSQL](https://python.langchain.com/docs/integrations/document_loaders/google_alloydb/)
  * [Setting up](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#setting-up)
  * [Example](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#example)
  * [Example with table filtering](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#example-with-table-filtering)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/glue_catalog/#related)
