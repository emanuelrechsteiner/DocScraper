---
url: https://python.langchain.com/docs/integrations/document_loaders/spreedly/
scraped_at: 2025-05-25T17:58:35.466549
title: Spreedly | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/spreedly/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/spreedly/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/spreedly/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/spreedly/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/spreedly/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/spreedly/)
...
```
import osfrom langchain.indexes import VectorstoreIndexCreatorfrom langchain_community.document_loaders import SpreedlyLoader
```

**API Reference:**[VectorstoreIndexCreator](https://python.langchain.com/api_reference/langchain/indexes/langchain.indexes.vectorstore.VectorstoreIndexCreator.html) | [SpreedlyLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.spreedly.SpreedlyLoader.html)
...
```
# Test the retrieverspreedly_doc_retriever.invoke("CRC")
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/spreedly/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/spreedly.ipynb)
#### Was this page helpful?
[PreviousSpider](https://python.langchain.com/docs/integrations/document_loaders/spider/)[NextStripe](https://python.langchain.com/docs/integrations/document_loaders/stripe/)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/spreedly/#related)
