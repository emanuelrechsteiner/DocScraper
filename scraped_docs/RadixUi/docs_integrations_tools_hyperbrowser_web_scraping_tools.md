---
url: https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/
scraped_at: 2025-05-25T18:11:19.056831
title: Hyperbrowser Web Scraping Tools | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/)
...
## Key Capabilities[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#key-capabilities "Direct link to Key Capabilities")
### Scrape[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape "Direct link to Scrape")
...
### Crawl[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl "Direct link to Crawl")
...
### Extract[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract "Direct link to Extract")
...
## Overview[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#integration-details "Direct link to Integration details")
...
## Setup[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#credentials "Direct link to Credentials")
...
### Installation[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#installation "Direct link to Installation")
Install **langchain-hyperbrowser**.
```
%pip install -qU langchain-hyperbrowser
```

## Instantiation[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#instantiation "Direct link to Instantiation")
### Crawl Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl-tool "Direct link to Crawl Tool")
...
```
from langchain_hyperbrowser import HyperbrowserCrawlTooltool = HyperbrowserCrawlTool()
```

### Scrape Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape-tool "Direct link to Scrape Tool")
...
```
from langchain_hyperbrowser import HyperbrowserScrapeTooltool = HyperbrowserScrapeTool()
```

### Extract Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract-tool "Direct link to Extract Tool")
...
```
from langchain_hyperbrowser import HyperbrowserExtractTooltool = HyperbrowserExtractTool()
```

## Invocation[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#invocation "Direct link to Invocation")
### Basic Usage[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#basic-usage "Direct link to Basic Usage")
#### Crawl Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl-tool-1 "Direct link to Crawl Tool")
```
from langchain_hyperbrowser import HyperbrowserCrawlToolresult = HyperbrowserCrawlTool().invoke({"url":"https://example.com","max_pages":2,"scrape_options":{"formats":["markdown"]},})print(result)
```
...
#### Scrape Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape-tool-1 "Direct link to Scrape Tool")
```
from langchain_hyperbrowser import HyperbrowserScrapeToolresult = HyperbrowserScrapeTool().invoke({"url":"https://example.com","scrape_options":{"formats":["markdown"]}})print(result)
```
...
#### Extract Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract-tool-1 "Direct link to Extract Tool")
```
from langchain_hyperbrowser import HyperbrowserExtractToolfrom pydantic import BaseModelclassSimpleExtractionModel(BaseModel):  title:strresult = HyperbrowserExtractTool().invoke({"url":"https://example.com","schema": SimpleExtractionModel,})print(result)
```
...
### With Custom Options[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#with-custom-options "Direct link to With Custom Options")
#### Crawl Tool with Custom Options[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl-tool-with-custom-options "Direct link to Crawl Tool with Custom Options")
```
result = HyperbrowserCrawlTool().run({"url":"https://example.com","max_pages":2,"scrape_options":{"formats":["markdown","html"],},"session_options":{"use_proxy":True,"solve_captchas":True},})print(result)
```
...
#### Scrape Tool with Custom Options[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape-tool-with-custom-options "Direct link to Scrape Tool with Custom Options")
```
result = HyperbrowserScrapeTool().run({"url":"https://example.com","scrape_options":{"formats":["markdown","html"],},"session_options":{"use_proxy":True,"solve_captchas":True},})print(result)
```
...
#### Extract Tool with Custom Schema[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract-tool-with-custom-schema "Direct link to Extract Tool with Custom Schema")
```
from typing import Listfrom pydantic import BaseModelclassProductSchema(BaseModel):  title:str  price:floatclassProductsSchema(BaseModel):  products: List[ProductSchema]result = HyperbrowserExtractTool().run({"url":"https://dummyjson.com/products?limit=10","schema": ProductsSchema,"session_options":{"session_options":{"use_proxy":True}},})print(result)
```
...
### Async Usage[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#async-usage "Direct link to Async Usage")
All tools support async usage:
```
from typing import Listfrom langchain_hyperbrowser import(  HyperbrowserCrawlTool,  HyperbrowserExtractTool,  HyperbrowserScrapeTool,)from pydantic import BaseModelclassExtractionSchema(BaseModel):  popular_library_name: List[str]asyncdefweb_operations():# Crawl  crawl_tool = HyperbrowserCrawlTool()  crawl_result =await crawl_tool.arun({"url":"https://example.com","max_pages":5,"scrape_options":{"formats":["markdown"]},})# Scrape  scrape_tool = HyperbrowserScrapeTool()  scrape_result =await scrape_tool.arun({"url":"https://example.com","scrape_options":{"formats":["markdown"]}})# Extract  extract_tool = HyperbrowserExtractTool()  extract_result =await extract_tool.arun({"url":"https://npmjs.com","schema": ExtractionSchema,})return crawl_result, scrape_result, extract_resultresults =await web_operations()print(results)
```

```
---------------------------------------------------------------------------``````outputNameError                 Traceback (most recent call last)``````outputCell In[6], line 10   1 from langchain_hyperbrowser import (   2   HyperbrowserCrawlTool,   3   HyperbrowserExtractTool,   4   HyperbrowserScrapeTool,   5 )   7 from pydantic import BaseModel---> 10 class ExtractionSchema(BaseModel):   11   popular_library_name: List[str]   14 async def web_operations():   15   # Crawl``````outputCell In[6], line 11, in ExtractionSchema()   10 class ExtractionSchema(BaseModel):---> 11   popular_library_name: List[str]``````outputNameError: name 'List' is not defined
```

## Use within an agent[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#use-within-an-agent "Direct link to Use within an agent")
Here's how to use any of the web tools within an agent:
```
from langchain_hyperbrowser import HyperbrowserCrawlToolfrom langchain_openai import ChatOpenAIfrom langgraph.prebuilt import create_react_agent# Initialize the crawl toolcrawl_tool = HyperbrowserCrawlTool()# Create the agent with the crawl toolllm = ChatOpenAI(temperature=0)agent = create_react_agent(llm,[crawl_tool])user_input ="Crawl https://example.com and get content from up to 5 pages"for step in agent.stream({"messages": user_input},  stream_mode="values",):  step["messages"][-1].pretty_print()
```
...
```
================================[1m Human Message [0m=================================Crawl https://example.com and get content from up to 5 pages==================================[1m Ai Message [0m==================================Tool Calls: hyperbrowser_crawl_data (call_G2ofdHOqjdnJUZu4hhbuga58) Call ID: call_G2ofdHOqjdnJUZu4hhbuga58 Args:  url: https://example.com  max_pages: 5  scrape_options: {'formats': ['markdown']}=================================[1m Tool Message [0m=================================Name: hyperbrowser_crawl_data{'data': [CrawledPage(metadata={'url': 'https://www.example.com/', 'title': 'Example Domain', 'viewport': 'width=device-width, initial-scale=1', 'sourceURL': 'https://example.com'}, html=None, markdown='Example Domain\n\n# Example Domain\n\nThis domain is for use in illustrative examples in documents. You may use this\ndomain in literature without prior coordination or asking for permission.\n\n[More information...](https://www.iana.org/domains/example)', links=None, screenshot=None, url='https://example.com', status='completed', error=None)], 'error': None}==================================[1m Ai Message [0m==================================I have crawled the website [https://example.com](https://example.com) and retrieved content from the first page. Here is the content in markdown format:\`\`\`Example Domain# Example DomainThis domain is for use in illustrative examples in documents. You may use thisdomain in literature without prior coordination or asking for permission.[More information...](https://www.iana.org/domains/example)\`\`\`If you would like to crawl more pages or need additional information, please let me know!
```

## Configuration Options[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#configuration-options "Direct link to Configuration Options")
### Common Options[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#common-options "Direct link to Common Options")
...
### Tool-Specific Options[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#tool-specific-options "Direct link to Tool-Specific Options")
#### Crawl Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl-tool-2 "Direct link to Crawl Tool")
  * `max_pages`: Maximum number of pages to crawl
  * `scrape_options`: Options for scraping each page 
    * `formats`: List of output formats (markdown, html)


#### Scrape Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape-tool-2 "Direct link to Scrape Tool")
  * `scrape_options`: Options for scraping the page 
    * `formats`: List of output formats (markdown, html)


#### Extract Tool[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract-tool-2 "Direct link to Extract Tool")
...
## API reference[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#api-reference "Direct link to API reference")
  * [GitHub](https://github.com/hyperbrowserai/langchain-hyperbrowser/)
  * [PyPi](https://pypi.org/project/langchain-hyperbrowser/)
  * [Hyperbrowser Docs](https://docs.hyperbrowser.ai/)


## Related[​](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/hyperbrowser_web_scraping_tools.ipynb)
#### Was this page helpful?
[PreviousHyperbrowser Browser Agent Tools](https://python.langchain.com/docs/integrations/tools/hyperbrowser_browser_agent_tools/)[NextIBM watsonx.ai](https://python.langchain.com/docs/integrations/tools/ibm_watsonx/)
  * [Key Capabilities](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#key-capabilities)
    * [Scrape](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape)
    * [Crawl](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl)
    * [Extract](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract)
  * [Overview](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#instantiation)
    * [Crawl Tool](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#crawl-tool)
    * [Scrape Tool](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#scrape-tool)
    * [Extract Tool](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#extract-tool)
  * [Invocation](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#invocation)
    * [Basic Usage](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#basic-usage)
    * [With Custom Options](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#with-custom-options)
    * [Async Usage](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#async-usage)
  * [Use within an agent](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#use-within-an-agent)
  * [Configuration Options](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#configuration-options)
    * [Common Options](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#common-options)
    * [Tool-Specific Options](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#tool-specific-options)
  * [API reference](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/hyperbrowser_web_scraping_tools/#related)
