---
url: https://python.langchain.com/docs/integrations/graphs/arangodb/
scraped_at: 2025-05-25T18:02:42.384040
title: ArangoDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/graphs/arangodb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/graphs/arangodb/)
...
[v0.3](https://python.langchain.com/docs/integrations/graphs/arangodb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/graphs/arangodb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/graphs/arangodb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/graphs/arangodb/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/graphs/arangodb.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/graphs/arangodb.ipynb)
# ArangoDB
...
## Setting up[​](https://python.langchain.com/docs/integrations/graphs/arangodb/#setting-up "Direct link to Setting up")
...
## Populating database[​](https://python.langchain.com/docs/integrations/graphs/arangodb/#populating-database "Direct link to Populating database")
...
## Getting and setting the ArangoDB schema[​](https://python.langchain.com/docs/integrations/graphs/arangodb/#getting-and-setting-the-arangodb-schema "Direct link to Getting and setting the ArangoDB schema")
...
## Querying the ArangoDB database[​](https://python.langchain.com/docs/integrations/graphs/arangodb/#querying-the-arangodb-database "Direct link to Querying the ArangoDB database")
...
## Chain modifiers[​](https://python.langchain.com/docs/integrations/graphs/arangodb/#chain-modifiers "Direct link to Chain modifiers")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/graphs/arangodb.ipynb)
#### Was this page helpful?
[PreviousApache AGE](https://python.langchain.com/docs/integrations/graphs/apache_age/)[NextAzure Cosmos DB for Apache Gremlin](https://python.langchain.com/docs/integrations/graphs/azure_cosmosdb_gremlin/)
  * [Setting up](https://python.langchain.com/docs/integrations/graphs/arangodb/#setting-up)
  * [Populating database](https://python.langchain.com/docs/integrations/graphs/arangodb/#populating-database)
  * [Getting and setting the ArangoDB schema](https://python.langchain.com/docs/integrations/graphs/arangodb/#getting-and-setting-the-arangodb-schema)
  * [Querying the ArangoDB database](https://python.langchain.com/docs/integrations/graphs/arangodb/#querying-the-arangodb-database)
  * [Chain modifiers](https://python.langchain.com/docs/integrations/graphs/arangodb/#chain-modifiers)
