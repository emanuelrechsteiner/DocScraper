---
url: https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/
scraped_at: 2025-05-25T17:57:04.644579
title: IPEX-LLM: Local BGE Embeddings on Intel GPU | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/)
...
[v0.3](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/ipex_llm_gpu.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/ipex_llm_gpu.ipynb)
# IPEX-LLM: Local BGE Embeddings on Intel GPU
...
## Install Prerequisites[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#install-prerequisites "Direct link to Install Prerequisites")
...
## Setup[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#setup "Direct link to Setup")
...
```
%pip install --pre --upgrade ipex-llm[xpu]--extra-index-url https://pytorch-extension.intel.com/release-whl/stable/xpu/us/%pip install sentence-transformers
```

> **Note**
> You can also use `https://pytorch-extension.intel.com/release-whl/stable/xpu/cn/` as the extra-indel-url.
## Runtime Configuration[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#runtime-configuration "Direct link to Runtime Configuration")
For optimal performance, it is recommended to set several environment variables based on your device:
### For Windows Users with Intel Core Ultra integrated GPU[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#for-windows-users-with-intel-core-ultra-integrated-gpu "Direct link to For Windows Users with Intel Core Ultra integrated GPU")
```
import osos.environ["SYCL_CACHE_PERSISTENT"]="1"os.environ["BIGDL_LLM_XMX_DISABLED"]="1"
```

### For Windows Users with Intel Arc A-Series GPU[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#for-windows-users-with-intel-arc-a-series-gpu "Direct link to For Windows Users with Intel Arc A-Series GPU")
```
import osos.environ["SYCL_CACHE_PERSISTENT"]="1"
```
...
## Basic Usage[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#basic-usage "Direct link to Basic Usage")
...
```
from langchain_community.embeddings import IpexLLMBgeEmbeddingsembedding_model = IpexLLMBgeEmbeddings(  model_name="BAAI/bge-large-en-v1.5",  model_kwargs={"device":"xpu"},  encode_kwargs={"normalize_embeddings":True},)
```
...
```
sentence ="IPEX-LLM is a PyTorch library for running LLM on Intel CPU and GPU (e.g., local PC with iGPU, discrete GPU such as Arc, Flex and Max) with very low latency."query ="What is IPEX-LLM?"text_embeddings = embedding_model.embed_documents([sentence, query])print(f"text_embeddings[0][:10]: {text_embeddings[0][:10]}")print(f"text_embeddings[1][:10]: {text_embeddings[1][:10]}")query_embedding = embedding_model.embed_query(query)print(f"query_embedding[:10]: {query_embedding[:10]}")
```

## Related[​](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/text_embedding/ipex_llm_gpu.ipynb)
#### Was this page helpful?
[PreviousIPEX-LLM: Local BGE Embeddings on Intel CPU](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm/)[NextIntel® Extension for Transformers Quantized Text Embeddings](https://python.langchain.com/docs/integrations/text_embedding/itrex/)
  * [Install Prerequisites](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#install-prerequisites)
  * [Setup](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#setup)
  * [Runtime Configuration](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#runtime-configuration)
    * [For Windows Users with Intel Core Ultra integrated GPU](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#for-windows-users-with-intel-core-ultra-integrated-gpu)
    * [For Windows Users with Intel Arc A-Series GPU](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#for-windows-users-with-intel-arc-a-series-gpu)
  * [Basic Usage](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#basic-usage)
  * [Related](https://python.langchain.com/docs/integrations/text_embedding/ipex_llm_gpu/#related)
