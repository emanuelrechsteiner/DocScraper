---
url: https://python.langchain.com/docs/integrations/chat/anyscale/
scraped_at: 2025-05-25T17:56:43.198138
title: ChatAnyscale | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/anyscale/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/anyscale/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/anyscale/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/anyscale/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/anyscale/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/anyscale/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/chat/anyscale.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/chat/anyscale.ipynb)
# ChatAnyscale
...
```
import osfrom getpass import getpassif"ANYSCALE_API_KEY"notin os.environ:  os.environ["ANYSCALE_API_KEY"]= getpass()
```
...
```
from langchain_community.chat_models import ChatAnyscalechats ={  model: ChatAnyscale(model_name=model, temperature=1.0)for model in ChatAnyscale.get_available_models()}print(chats.keys())
```
...
```
import asynciofrom langchain_core.messages import HumanMessage, SystemMessagemessages =[  SystemMessage(content="You are a helpful AI that shares everything you know."),  HumanMessage(    content="Tell me technical facts about yourself. Are you a transformer model? How many billions of parameters do you have?"),]asyncdefget_msgs():  tasks =[chat.apredict_messages(messages)for chat in chats.values()]  responses =await asyncio.gather(*tasks)returndict(zip(chats.keys(), responses))
```
...
```
%%timeresponse_dict = asyncio.run(get_msgs())for model_name, response in response_dict.items():print(f"\t{model_name}")print()print(response.content)print("\n---\n")
```
...
## Related[​](https://python.langchain.com/docs/integrations/chat/anyscale/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/chat/anyscale.ipynb)
#### Was this page helpful?
[Previous[Deprecated] Experimental Anthropic Tools Wrapper](https://python.langchain.com/docs/integrations/chat/anthropic_functions/)[NextAzureAIChatCompletionsModel](https://python.langchain.com/docs/integrations/chat/azure_ai/)
  * [Related](https://python.langchain.com/docs/integrations/chat/anyscale/#related)
