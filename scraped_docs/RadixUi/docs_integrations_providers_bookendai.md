---
url: https://python.langchain.com/docs/integrations/providers/bookendai/
scraped_at: 2025-05-25T17:57:40.838577
title: bookend.ai | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/bookendai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/bookendai/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/bookendai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/bookendai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/bookendai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/bookendai/)
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/bookendai/#installation-and-setup "Direct link to Installation and Setup")
You need to register and get the `API_KEY` from the [bookend.ai](https://bookend.ai/) website.
## Embedding model[​](https://python.langchain.com/docs/integrations/providers/bookendai/#embedding-model "Direct link to Embedding model")
See a [usage example](https://python.langchain.com/docs/integrations/text_embedding/bookend/).
```
...
[PreviousBlackboard](https://python.langchain.com/docs/integrations/providers/blackboard/)[NextBox](https://python.langchain.com/docs/integrations/providers/box/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/bookendai/#installation-and-setup)
  * [Embedding model](https://python.langchain.com/docs/integrations/providers/bookendai/#embedding-model)
