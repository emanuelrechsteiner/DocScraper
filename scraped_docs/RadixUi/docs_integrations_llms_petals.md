...
scraped_at: 2025-05-25T18:15:47.138717
title: Petals | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/llms/petals/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/llms/petals/)
...
[v0.3](https://python.langchain.com/docs/integrations/llms/petals/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/llms/petals/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/llms/petals/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/llms/petals/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/llms/petals.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/llms/petals.ipynb)
# Petals
`Petals` runs 100B+ language models at home, BitTorrent-style.
This notebook goes over how to use Langchain with [Petals](https://github.com/bigscience-workshop/petals).
## Install petals[​](https://python.langchain.com/docs/integrations/llms/petals/#install-petals "Direct link to Install petals")
...
## Imports[​](https://python.langchain.com/docs/integrations/llms/petals/#imports "Direct link to Imports")
```
...
## Set the Environment API Key[​](https://python.langchain.com/docs/integrations/llms/petals/#set-the-environment-api-key "Direct link to Set the Environment API Key")
...
## Create the Petals instance[​](https://python.langchain.com/docs/integrations/llms/petals/#create-the-petals-instance "Direct link to Create the Petals instance")
...
## Create a Prompt Template[​](https://python.langchain.com/docs/integrations/llms/petals/#create-a-prompt-template "Direct link to Create a Prompt Template")
We will create a prompt template for Question and Answer.
```
template ="""Question: {question}Answer: Let's think step by step."""prompt = PromptTemplate.from_template(template)
```

## Initiate the LLMChain[​](https://python.langchain.com/docs/integrations/llms/petals/#initiate-the-llmchain "Direct link to Initiate the LLMChain")
```
llm_chain = LLMChain(prompt=prompt, llm=llm)
```

## Run the LLMChain[​](https://python.langchain.com/docs/integrations/llms/petals/#run-the-llmchain "Direct link to Run the LLMChain")
Provide a question and run the LLMChain.
```
question ="What NFL team won the Super Bowl in the year Justin Beiber was born?"llm_chain.run(question)
```

## Related[​](https://python.langchain.com/docs/integrations/llms/petals/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/llms/petals.ipynb)
#### Was this page helpful?
[PreviousOutlines](https://python.langchain.com/docs/integrations/llms/outlines/)[NextPipelineAI](https://python.langchain.com/docs/integrations/llms/pipelineai/)
  * [Install petals](https://python.langchain.com/docs/integrations/llms/petals/#install-petals)
  * [Imports](https://python.langchain.com/docs/integrations/llms/petals/#imports)
  * [Set the Environment API Key](https://python.langchain.com/docs/integrations/llms/petals/#set-the-environment-api-key)
  * [Create the Petals instance](https://python.langchain.com/docs/integrations/llms/petals/#create-the-petals-instance)
  * [Create a Prompt Template](https://python.langchain.com/docs/integrations/llms/petals/#create-a-prompt-template)
  * [Initiate the LLMChain](https://python.langchain.com/docs/integrations/llms/petals/#initiate-the-llmchain)
  * [Run the LLMChain](https://python.langchain.com/docs/integrations/llms/petals/#run-the-llmchain)
  * [Related](https://python.langchain.com/docs/integrations/llms/petals/#related)
