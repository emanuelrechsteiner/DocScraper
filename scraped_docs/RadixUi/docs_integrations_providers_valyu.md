...
scraped_at: 2025-05-25T18:02:31.208264
title: ValyuContext | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/valyu/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/valyu/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/valyu/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/valyu/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/valyu/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/valyu/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/valyu.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/valyu.ipynb)
# ValyuContext
...
## Setup[​](https://python.langchain.com/docs/integrations/providers/valyu/#setup "Direct link to Setup")
...
## Context Retriever[​](https://python.langchain.com/docs/integrations/providers/valyu/#context-retriever "Direct link to Context Retriever")
You can use the [`ValyuContextRetriever`](https://pypi.org/project/langchain-valyu/) in a standard retrieval pipeline.
```
from langchain_valyu import ValyuContextRetrievervalyu_api_key ="YOUR API KEY"# Create a new instance of the ValyuContextRetrievervalyu_retriever = ValyuContextRetriever(valyu_api_key=valyu_api_key)# Search for a query and save the resultsdocs = valyu_retriever.invoke("What are the benefits of renewable energy?")# Print the resultsfor doc in docs:print(doc.page_content)print(doc.metadata)
```

## Context Search Tool[​](https://python.langchain.com/docs/integrations/providers/valyu/#context-search-tool "Direct link to Context Search Tool")
You can use the `ValyuSearchTool` for advanced search queries.
```
from langchain_valyu import ValyuSearchTool# Initialize the ValyuSearchToolsearch_tool = ValyuSearchTool(valyu_api_key="YOUR API KEY")# Perform a search querysearch_results = search_tool._run(  query="What are agentic search-enhanced large reasoning models?",  search_type="all",  max_num_results=5,  similarity_threshold=0.4,  query_rewrite=False,  max_price=20.0,)print("Search Results:", search_results)
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/valyu.ipynb)
#### Was this page helpful?
[PreviousValthera](https://python.langchain.com/docs/integrations/providers/valthera/)[NextVDMS](https://python.langchain.com/docs/integrations/providers/vdms/)
  * [Setup](https://python.langchain.com/docs/integrations/providers/valyu/#setup)
  * [Context Retriever](https://python.langchain.com/docs/integrations/providers/valyu/#context-retriever)
  * [Context Search Tool](https://python.langchain.com/docs/integrations/providers/valyu/#context-search-tool)
