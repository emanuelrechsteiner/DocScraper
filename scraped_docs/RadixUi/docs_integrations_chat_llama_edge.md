---
url: https://python.langchain.com/docs/integrations/chat/llama_edge/
scraped_at: 2025-05-25T18:12:01.222339
title: LlamaEdge | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/llama_edge/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/llama_edge/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/llama_edge/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/llama_edge/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/llama_edge/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/llama_edge/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/chat/llama_edge.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/chat/llama_edge.ipynb)
# LlamaEdge
...
## Chat via API Service[​](https://python.langchain.com/docs/integrations/chat/llama_edge/#chat-via-api-service "Direct link to Chat via API Service")
...
**API Reference:**[LlamaEdgeChatService](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.llama_edge.LlamaEdgeChatService.html) | [HumanMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessage.html) | [SystemMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.system.SystemMessage.html)
### Chat with LLMs in the non-streaming mode[​](https://python.langchain.com/docs/integrations/chat/llama_edge/#chat-with-llms-in-the-non-streaming-mode "Direct link to Chat with LLMs in the non-streaming mode")
```
# service urlservice_url ="https://b008-54-186-154-209.ngrok-free.app"# create wasm-chat service instancechat = LlamaEdgeChatService(service_url=service_url)# create message sequencesystem_message = SystemMessage(content="You are an AI assistant")user_message = HumanMessage(content="What is the capital of France?")messages =[system_message, user_message]# chat with wasm-chat serviceresponse = chat.invoke(messages)print(f"[Bot] {response.content}")
```
...
### Chat with LLMs in the streaming mode[​](https://python.langchain.com/docs/integrations/chat/llama_edge/#chat-with-llms-in-the-streaming-mode "Direct link to Chat with LLMs in the streaming mode")
```
...
## Related[​](https://python.langchain.com/docs/integrations/chat/llama_edge/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/chat/llama_edge.ipynb)
#### Was this page helpful?
[PreviousLlama API](https://python.langchain.com/docs/integrations/chat/llama_api/)[NextLlama.cpp](https://python.langchain.com/docs/integrations/chat/llamacpp/)
  * [Chat via API Service](https://python.langchain.com/docs/integrations/chat/llama_edge/#chat-via-api-service)
    * [Chat with LLMs in the non-streaming mode](https://python.langchain.com/docs/integrations/chat/llama_edge/#chat-with-llms-in-the-non-streaming-mode)
    * [Chat with LLMs in the streaming mode](https://python.langchain.com/docs/integrations/chat/llama_edge/#chat-with-llms-in-the-streaming-mode)
  * [Related](https://python.langchain.com/docs/integrations/chat/llama_edge/#related)
