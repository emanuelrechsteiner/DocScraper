...
scraped_at: 2025-05-25T18:05:31.926815
title: SurrealDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/)
...
## Overview[​](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#overview "Direct link to Overview")
...
```
Document(  page_content=<json encoded string containing the result document>,  metadata={    'id': <document id>,    'ns': <namespace name>,    'db': <database_name>,    'table': <table name>,    ... <additional fields from metadata property of the document>  })
```

## Setup[​](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#setup "Direct link to Setup")
...
```
import jsonfrom langchain_community.document_loaders.surrealdb import SurrealDBLoader
```

**API Reference:**[SurrealDBLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.surrealdb.SurrealDBLoader.html)
```
loader = SurrealDBLoader(  dburl="ws://localhost:8000/rpc",  ns="langchain",  db="database",  table="documents",  db_user="root",  db_pass="root",  filter_criteria={},)docs = loader.load()len(docs)
```
...
```
doc = docs[-1]doc.metadata
```

```
{'id': 'documents:zzz434sa584xl3b4ohvk', 'source': '../../how_to/state_of_the_union.txt', 'ns': 'langchain', 'db': 'database', 'table': 'documents'}
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/surrealdb.ipynb)
#### Was this page helpful?
[PreviousSubtitle](https://python.langchain.com/docs/integrations/document_loaders/subtitle/)[NextTelegram](https://python.langchain.com/docs/integrations/document_loaders/telegram/)
  * [Overview](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#overview)
  * [Setup](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#setup)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/surrealdb/#related)
