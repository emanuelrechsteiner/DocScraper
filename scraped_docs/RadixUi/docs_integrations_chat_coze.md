---
url: https://python.langchain.com/docs/integrations/chat/coze/
scraped_at: 2025-05-25T18:10:13.449378
title: Chat with Coze Bot | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/coze/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/coze/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/coze/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/coze/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/coze/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/coze/)
...
## Chat with Coze Streaming[​](https://python.langchain.com/docs/integrations/chat/coze/#chat-with-coze-streaming "Direct link to Chat with Coze Streaming")
```
...
## Related[​](https://python.langchain.com/docs/integrations/chat/coze/#related "Direct link to Related")
...
[PreviousContextualAI](https://python.langchain.com/docs/integrations/chat/contextual/)[NextDappier AI](https://python.langchain.com/docs/integrations/chat/dappier/)
  * [Chat with Coze Streaming](https://python.langchain.com/docs/integrations/chat/coze/#chat-with-coze-streaming)
  * [Related](https://python.langchain.com/docs/integrations/chat/coze/#related)
