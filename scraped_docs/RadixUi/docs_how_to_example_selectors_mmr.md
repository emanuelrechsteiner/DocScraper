...
scraped_at: 2025-05-25T17:55:03.555442
title: How to select examples by maximal marginal relevance (MMR) | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/how_to/example_selectors_mmr/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/how_to/example_selectors_mmr/)
...
[v0.3](https://python.langchain.com/docs/how_to/example_selectors_mmr/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/how_to/example_selectors_mmr/)
