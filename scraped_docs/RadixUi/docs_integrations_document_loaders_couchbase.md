---
url: https://python.langchain.com/docs/integrations/document_loaders/couchbase
scraped_at: 2025-05-25T18:05:03.341732
title: Couchbase | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/couchbase/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/couchbase/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/couchbase/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/couchbase/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/couchbase/)
...
## Installation[​](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#installation "Direct link to Installation")
```
%pip install --upgrade --quiet couchbase
```

## Querying for Documents from Couchbase[​](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#querying-for-documents-from-couchbase "Direct link to Querying for Documents from Couchbase")
...
## Create the Loader[​](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#create-the-loader "Direct link to Create the Loader")
```
loader = CouchbaseLoader(  connection_string,  db_username,  db_password,  query,)
```
...
```
docs_iterator = loader.lazy_load()for doc in docs_iterator:print(doc)break
```
...
## Specifying Fields with Content and Metadata[​](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#specifying-fields-with-content-and-metadata "Direct link to Specifying Fields with Content and Metadata")
...
```
loader_with_selected_fields = CouchbaseLoader(  connection_string,  db_username,  db_password,  query,  page_content_fields=["address","name","city","phone","country","geo","description","reviews",],  metadata_fields=["id"],)docs_with_selected_fields = loader_with_selected_fields.load()print(docs_with_selected_fields)
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/couchbase.ipynb)
#### Was this page helpful?
[PreviousCopy Paste](https://python.langchain.com/docs/integrations/document_loaders/copypaste/)[NextCSV](https://python.langchain.com/docs/integrations/document_loaders/csv/)
  * [Installation](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#installation)
  * [Querying for Documents from Couchbase](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#querying-for-documents-from-couchbase)
  * [Create the Loader](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#create-the-loader)
  * [Specifying Fields with Content and Metadata](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#specifying-fields-with-content-and-metadata)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/couchbase/#related)
