---
url: https://python.langchain.com/docs/integrations/providers/deepinfra/
scraped_at: 2025-05-25T17:57:59.382601
title: DeepInfra | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/deepinfra/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/deepinfra/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/deepinfra/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/deepinfra/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/deepinfra/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/deepinfra/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/deepinfra.mdx)
# DeepInfra
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/deepinfra/#installation-and-setup "Direct link to Installation and Setup")
  * Get your DeepInfra api key from this link [here](https://deepinfra.com/).
  * Get an DeepInfra api key and set it as an environment variable (`DEEPINFRA_API_TOKEN`)


## Available Models[​](https://python.langchain.com/docs/integrations/providers/deepinfra/#available-models "Direct link to Available Models")
DeepInfra provides a range of Open Source LLMs ready for deployment.
You can see supported models for [text-generation](https://deepinfra.com/models?type=text-generation) and [embeddings](https://deepinfra.com/models?type=embeddings).
...
## LLM[​](https://python.langchain.com/docs/integrations/providers/deepinfra/#llm "Direct link to LLM")
See a [usage example](https://python.langchain.com/docs/integrations/llms/deepinfra/).
```
...
## Embeddings[​](https://python.langchain.com/docs/integrations/providers/deepinfra/#embeddings "Direct link to Embeddings")
See a [usage example](https://python.langchain.com/docs/integrations/text_embedding/deepinfra/).
```
from langchain_community.embeddings import DeepInfraEmbeddings
```

**API Reference:**[DeepInfraEmbeddings](https://python.langchain.com/api_reference/community/embeddings/langchain_community.embeddings.deepinfra.DeepInfraEmbeddings.html)
## Chat Models[​](https://python.langchain.com/docs/integrations/providers/deepinfra/#chat-models "Direct link to Chat Models")
See a [usage example](https://python.langchain.com/docs/integrations/chat/deepinfra/).
```
from langchain_community.chat_models import ChatDeepInfra
```

**API Reference:**[ChatDeepInfra](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.deepinfra.ChatDeepInfra.html)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/deepinfra.mdx)
#### Was this page helpful?
[PreviousDedoc](https://python.langchain.com/docs/integrations/providers/dedoc/)[NextDeeplake](https://python.langchain.com/docs/integrations/providers/deeplake/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/deepinfra/#installation-and-setup)
  * [Available Models](https://python.langchain.com/docs/integrations/providers/deepinfra/#available-models)
  * [LLM](https://python.langchain.com/docs/integrations/providers/deepinfra/#llm)
  * [Embeddings](https://python.langchain.com/docs/integrations/providers/deepinfra/#embeddings)
  * [Chat Models](https://python.langchain.com/docs/integrations/providers/deepinfra/#chat-models)
