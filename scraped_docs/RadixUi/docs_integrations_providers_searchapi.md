...
scraped_at: 2025-05-25T18:14:49.630820
title: SearchApi | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/searchapi/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/searchapi/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/searchapi/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/searchapi/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/searchapi/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/searchapi/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/searchapi.mdx)
# SearchApi
...
## Setup[​](https://python.langchain.com/docs/integrations/providers/searchapi/#setup "Direct link to Setup")
...
## Wrappers[​](https://python.langchain.com/docs/integrations/providers/searchapi/#wrappers "Direct link to Wrappers")
### Utility[​](https://python.langchain.com/docs/integrations/providers/searchapi/#utility "Direct link to Utility")
...
**API Reference:**[SearchApiAPIWrapper](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.searchapi.SearchApiAPIWrapper.html) | [OpenAI](https://python.langchain.com/api_reference/openai/llms/langchain_openai.llms.base.OpenAI.html) | [initialize_agent](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.initialize.initialize_agent.html) | [Tool](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.simple.Tool.html) | [AgentType](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.agent_types.AgentType.html)
#### Output[​](https://python.langchain.com/docs/integrations/providers/searchapi/#output "Direct link to Output")
```
...
### Tool[​](https://python.langchain.com/docs/integrations/providers/searchapi/#tool "Direct link to Tool")
You can also easily load this wrapper as a Tool (to use with an Agent). You can do this with:
```
from langchain_community.agent_toolkits.load_tools import load_toolstools = load_tools(["searchapi"])
```

**API Reference:**[load_tools](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.load_tools.load_tools.html)
For more information on tools, see [this page](https://python.langchain.com/docs/how_to/tools_builtin/).
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/searchapi.mdx)
#### Was this page helpful?
[PreviousScrapeGraph AI](https://python.langchain.com/docs/integrations/providers/scrapegraph/)[NextSearxNG Search API](https://python.langchain.com/docs/integrations/providers/searx/)
  * [Setup](https://python.langchain.com/docs/integrations/providers/searchapi/#setup)
  * [Wrappers](https://python.langchain.com/docs/integrations/providers/searchapi/#wrappers)
    * [Utility](https://python.langchain.com/docs/integrations/providers/searchapi/#utility)
    * [Tool](https://python.langchain.com/docs/integrations/providers/searchapi/#tool)
