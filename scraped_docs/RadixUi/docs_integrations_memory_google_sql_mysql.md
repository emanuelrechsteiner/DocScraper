---
url: https://python.langchain.com/docs/integrations/memory/google_sql_mysql/
scraped_at: 2025-05-25T18:01:14.108514
title: Google SQL for MySQL | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/)
...
[v0.3](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/memory/google_sql_mysql.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/memory/google_sql_mysql.ipynb)
# Google SQL for MySQL
...
## Before You Begin[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#before-you-begin "Direct link to Before You Begin")
...
### 🦜🔗 Library Installation[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-library-installation "Direct link to 🦜🔗 Library Installation")
...
### 🔐 Authentication[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-authentication "Direct link to 🔐 Authentication")
...
### ☁ Set Your Google Cloud Project[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-set-your-google-cloud-project "Direct link to ☁ Set Your Google Cloud Project")
...
### 💡 API Enablement[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-api-enablement "Direct link to 💡 API Enablement")
...
## Basic Usage[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#basic-usage "Direct link to Basic Usage")
### Set Cloud SQL database values[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#set-cloud-sql-database-values "Direct link to Set Cloud SQL database values")
Find your database values, in the [Cloud SQL Instances page](https://console.cloud.google.com/sql?_ga=2.223735448.2062268965.1707700487-2088871159.1707257687).
```
# @title Set Your Values Here { display-mode: "form" }REGION ="us-central1"# @param {type: "string"}INSTANCE ="my-mysql-instance"# @param {type: "string"}DATABASE ="my-database"# @param {type: "string"}TABLE_NAME ="message_store"# @param {type: "string"}
```

### MySQLEngine Connection Pool[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#mysqlengine-connection-pool "Direct link to MySQLEngine Connection Pool")
...
### Initialize a table[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#initialize-a-table "Direct link to Initialize a table")
...
### MySQLChatMessageHistory[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#mysqlchatmessagehistory "Direct link to MySQLChatMessageHistory")
...
```
from langchain_google_cloud_sql_mysql import MySQLChatMessageHistoryhistory = MySQLChatMessageHistory(  engine, session_id="test_session", table_name=TABLE_NAME)history.add_user_message("hi!")history.add_ai_message("whats up?")
```
...
#### Cleaning up[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#cleaning-up "Direct link to Cleaning up")
...
## 🔗 Chaining[​](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-chaining "Direct link to 🔗 Chaining")
...
```
chain_with_history = RunnableWithMessageHistory(  chain,lambda session_id: MySQLChatMessageHistory(    engine,    session_id=session_id,    table_name=TABLE_NAME,),  input_messages_key="question",  history_messages_key="history",)
```
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/memory/google_sql_mysql.ipynb)
#### Was this page helpful?
[PreviousGoogle SQL for SQL Server](https://python.langchain.com/docs/integrations/memory/google_sql_mssql/)[NextGoogle SQL for PostgreSQL](https://python.langchain.com/docs/integrations/memory/google_sql_pg/)
  * [Before You Begin](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#before-you-begin)
    * [🦜🔗 Library Installation](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-library-installation)
    * [🔐 Authentication](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-authentication)
    * [☁ Set Your Google Cloud Project](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-set-your-google-cloud-project)
    * [💡 API Enablement](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-api-enablement)
  * [Basic Usage](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#basic-usage)
    * [Set Cloud SQL database values](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#set-cloud-sql-database-values)
    * [MySQLEngine Connection Pool](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#mysqlengine-connection-pool)
    * [Initialize a table](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#initialize-a-table)
    * [MySQLChatMessageHistory](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#mysqlchatmessagehistory)
  * [🔗 Chaining](https://python.langchain.com/docs/integrations/memory/google_sql_mysql/#-chaining)
