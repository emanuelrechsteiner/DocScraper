...
scraped_at: 2025-05-25T18:15:07.601472
title: Security Policy | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/security/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/security/)
...
[v0.3](https://python.langchain.com/docs/security/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/security/)
...
## Best practices[​](https://python.langchain.com/docs/security/#best-practices "Direct link to Best practices")
...
## Reporting OSS Vulnerabilities[​](https://python.langchain.com/docs/security/#reporting-oss-vulnerabilities "Direct link to Reporting OSS Vulnerabilities")
...
Before reporting a vulnerability, please review:
  ...
  3. The [Best practicies](https://python.langchain.com/docs/security/#best-practices) above to understand what we consider to be a security vulnerability vs. developer responsibility.


### In-Scope Targets[​](https://python.langchain.com/docs/security/#in-scope-targets "Direct link to In-Scope Targets")
...
### Out of Scope Targets[​](https://python.langchain.com/docs/security/#out-of-scope-targets "Direct link to Out of Scope Targets")
All out of scope targets defined by huntr as well as:
  ...
  * **tools** : Tools in either langchain or langchain-community are not eligible for bug bounties. This includes the following directories 
    ...
    * Please review the [best practices](https://python.langchain.com/docs/security/#best-practices) for more details, but generally tools interact with the real world. Developers are expected to understand the security implications of their code and are responsible for the security of their tools.
  ...
  * Any LangSmith related repositories or APIs (see [Reporting LangSmith Vulnerabilities](https://python.langchain.com/docs/security/#reporting-langsmith-vulnerabilities)).


## Reporting LangSmith Vulnerabilities[​](https://python.langchain.com/docs/security/#reporting-langsmith-vulnerabilities "Direct link to Reporting LangSmith Vulnerabilities")
Please report security vulnerabilities associated with LangSmith by email to `security@langchain.dev`.
  * LangSmith site: <https://smith.langchain.com>
  * SDK client: <https://github.com/langchain-ai/langsmith-sdk>


### Other Security Concerns[​](https://python.langchain.com/docs/security/#other-security-concerns "Direct link to Other Security Concerns")
For any other security concerns, please contact us at `security@langchain.dev`.
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/security.md)
#### Was this page helpful?
[PreviousRelease policy](https://python.langchain.com/docs/versions/release_policy/)
  * [Best practices](https://python.langchain.com/docs/security/#best-practices)
  * [Reporting OSS Vulnerabilities](https://python.langchain.com/docs/security/#reporting-oss-vulnerabilities)
    * [In-Scope Targets](https://python.langchain.com/docs/security/#in-scope-targets)
    * [Out of Scope Targets](https://python.langchain.com/docs/security/#out-of-scope-targets)
  * [Reporting LangSmith Vulnerabilities](https://python.langchain.com/docs/security/#reporting-langsmith-vulnerabilities)
    * [Other Security Concerns](https://python.langchain.com/docs/security/#other-security-concerns)
