...
scraped_at: 2025-05-25T18:07:05.659323
title: Architecture | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/concepts/architecture/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/concepts/architecture/)
...
[v0.3](https://python.langchain.com/docs/concepts/architecture/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/concepts/architecture/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/concepts/architecture.mdx)
# Architecture
...
## langchain-core[​](https://python.langchain.com/docs/concepts/architecture/#langchain-core "Direct link to langchain-core")
...
## langchain[​](https://python.langchain.com/docs/concepts/architecture/#langchain "Direct link to langchain")
...
## Integration packages[​](https://python.langchain.com/docs/concepts/architecture/#integration-packages "Direct link to Integration packages")
...
For more information see:
  * A list [integrations packages](https://python.langchain.com/docs/integrations/providers/)
...
## langchain-community[​](https://python.langchain.com/docs/concepts/architecture/#langchain-community "Direct link to langchain-community")
...
## langgraph[​](https://python.langchain.com/docs/concepts/architecture/#langgraph "Direct link to langgraph")
...
## langserve[​](https://python.langchain.com/docs/concepts/architecture/#langserve "Direct link to langserve")
...
For more information, see the [LangServe documentation](https://python.langchain.com/docs/langserve/).
## LangSmith[​](https://python.langchain.com/docs/concepts/architecture/#langsmith "Direct link to LangSmith")
...
[PreviousAgents](https://python.langchain.com/docs/concepts/agents/)[NextAsync programming with langchain](https://python.langchain.com/docs/concepts/async/)
  * [langchain-core](https://python.langchain.com/docs/concepts/architecture/#langchain-core)
  * [langchain](https://python.langchain.com/docs/concepts/architecture/#langchain)
  * [Integration packages](https://python.langchain.com/docs/concepts/architecture/#integration-packages)
  ...
  * [langserve](https://python.langchain.com/docs/concepts/architecture/#langserve)
  * [LangSmith](https://python.langchain.com/docs/concepts/architecture/#langsmith)
