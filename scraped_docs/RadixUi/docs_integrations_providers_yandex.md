---
url: https://python.langchain.com/docs/integrations/providers/yandex/
scraped_at: 2025-05-25T18:02:46.285249
title: Yandex | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/yandex/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/yandex/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/yandex/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/yandex/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/yandex/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/yandex/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/yandex.mdx)
# Yandex
All functionality related to Yandex Cloud
> [Yandex Cloud](https://cloud.yandex.com/en/) is a public cloud platform.
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/yandex/#installation-and-setup "Direct link to Installation and Setup")
Yandex Cloud SDK can be installed via pip from PyPI:
```
pip install yandexcloud
```

## LLMs[​](https://python.langchain.com/docs/integrations/providers/yandex/#llms "Direct link to LLMs")
### YandexGPT[​](https://python.langchain.com/docs/integrations/providers/yandex/#yandexgpt "Direct link to YandexGPT")
...
## Chat models[​](https://python.langchain.com/docs/integrations/providers/yandex/#chat-models "Direct link to Chat models")
### YandexGPT[​](https://python.langchain.com/docs/integrations/providers/yandex/#yandexgpt-1 "Direct link to YandexGPT")
...
## Embedding models[​](https://python.langchain.com/docs/integrations/providers/yandex/#embedding-models "Direct link to Embedding models")
### YandexGPT[​](https://python.langchain.com/docs/integrations/providers/yandex/#yandexgpt-2 "Direct link to YandexGPT")
See a [usage example](https://python.langchain.com/docs/integrations/text_embedding/yandex/).
```
...
## Parser[​](https://python.langchain.com/docs/integrations/providers/yandex/#parser "Direct link to Parser")
### YandexSTTParser[​](https://python.langchain.com/docs/integrations/providers/yandex/#yandexsttparser "Direct link to YandexSTTParser")
It transcribes and parses audio files.
`YandexSTTParser` is similar to the `OpenAIWhisperParser`. See a [usage example with OpenAIWhisperParser](https://python.langchain.com/docs/integrations/document_loaders/youtube_audio/).
```
from langchain_community.document_loaders import YandexSTTParser
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/yandex.mdx)
#### Was this page helpful?
[PreviousYahoo](https://python.langchain.com/docs/integrations/providers/yahoo/)[NextYDB](https://python.langchain.com/docs/integrations/providers/ydb/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/yandex/#installation-and-setup)
  * [LLMs](https://python.langchain.com/docs/integrations/providers/yandex/#llms)
    * [YandexGPT](https://python.langchain.com/docs/integrations/providers/yandex/#yandexgpt)
  * [Chat models](https://python.langchain.com/docs/integrations/providers/yandex/#chat-models)
    * [YandexGPT](https://python.langchain.com/docs/integrations/providers/yandex/#yandexgpt-1)
  * [Embedding models](https://python.langchain.com/docs/integrations/providers/yandex/#embedding-models)
    * [YandexGPT](https://python.langchain.com/docs/integrations/providers/yandex/#yandexgpt-2)
  * [Parser](https://python.langchain.com/docs/integrations/providers/yandex/#parser)
    * [YandexSTTParser](https://python.langchain.com/docs/integrations/providers/yandex/#yandexsttparser)
