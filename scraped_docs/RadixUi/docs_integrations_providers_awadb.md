---
url: https://python.langchain.com/docs/integrations/providers/awadb/
scraped_at: 2025-05-25T17:55:59.814703
title: AwaDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/awadb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/awadb/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/awadb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/awadb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/awadb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/awadb/)
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/awadb/#installation-and-setup "Direct link to Installation and Setup")
```
pip install awadb
```

## Vector store[​](https://python.langchain.com/docs/integrations/providers/awadb/#vector-store "Direct link to Vector store")
```
...
## Embedding models[​](https://python.langchain.com/docs/integrations/providers/awadb/#embedding-models "Direct link to Embedding models")
```
...
[PreviousAtlas](https://python.langchain.com/docs/integrations/providers/atlas/)[NextAWS](https://python.langchain.com/docs/integrations/providers/aws/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/awadb/#installation-and-setup)
  * [Vector store](https://python.langchain.com/docs/integrations/providers/awadb/#vector-store)
  * [Embedding models](https://python.langchain.com/docs/integrations/providers/awadb/#embedding-models)
