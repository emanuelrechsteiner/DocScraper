...
scraped_at: 2025-05-25T18:08:39.522764
title: ArcGIS | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/arcgis/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/arcgis/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/arcgis/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/arcgis/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/arcgis/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/arcgis/)
...
```
from langchain_community.document_loaders import ArcGISLoaderURL ="https://maps1.vcgov.org/arcgis/rest/services/Beaches/MapServer/7"loader = ArcGISLoader(URL)docs = loader.load()
```

**API Reference:**[ArcGISLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.arcgis_loader.ArcGISLoader.html)
Let's measure loader latency.
```
%%timedocs = loader.load()
```
...
### Retrieving Geometries[​](https://python.langchain.com/docs/integrations/document_loaders/arcgis/#retrieving-geometries "Direct link to Retrieving Geometries")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/arcgis/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/arcgis.ipynb)
#### Was this page helpful?
[PreviousApify Dataset](https://python.langchain.com/docs/integrations/document_loaders/apify_dataset/)[NextArxivLoader](https://python.langchain.com/docs/integrations/document_loaders/arxiv/)
  * [Retrieving Geometries](https://python.langchain.com/docs/integrations/document_loaders/arcgis/#retrieving-geometries)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/arcgis/#related)
