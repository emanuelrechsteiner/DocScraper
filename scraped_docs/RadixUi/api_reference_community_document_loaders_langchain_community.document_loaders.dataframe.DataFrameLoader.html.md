...
scraped_at: 2025-05-25T18:15:54.002132
title: DataFrameLoader — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#main-content)
Back to top `⌘`+`K`
...
# DataFrameLoader[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#dataframeloader "Link to this heading") 

_class_ langchain_community.document_loaders.dataframe.DataFrameLoader( 
    _data_frame :Any_,     _page_content_column :str='text'_,     _engine :Literal['pandas','modin']='pandas'_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/dataframe.html#DataFrameLoader)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader "Link to this definition")     
Load Pandas DataFrame.
Initialize with dataframe object. 

Parameters:
    
  * **data_frame** (_Any_) – Pandas DataFrame object.
  * **page_content_column** (_str_) – Name of the column containing the page content. Defaults to “text”.
  * **engine** (_Literal_ _[__'pandas'__,__'modin'__]_)


Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.__init__ "langchain_community.document_loaders.dataframe.DataFrameLoader.__init__")(data_frame[, page_content_column, ...]) | Initialize with dataframe object.  
---|---  
[`alazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.alazy_load "langchain_community.document_loaders.dataframe.DataFrameLoader.alazy_load")() | A lazy loader for Documents.  
[`aload`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.aload "langchain_community.document_loaders.dataframe.DataFrameLoader.aload")() | Load data into Document objects.  
[`lazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.lazy_load "langchain_community.document_loaders.dataframe.DataFrameLoader.lazy_load")() | Lazy load records from dataframe.  
[`load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.load "langchain_community.document_loaders.dataframe.DataFrameLoader.load")() | Load data into Document objects.  
[`load_and_split`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.load_and_split "langchain_community.document_loaders.dataframe.DataFrameLoader.load_and_split")([text_splitter]) | Load Documents and split into chunks. 

__init__( 
    _data_frame :Any_,     _page_content_column :str='text'_,     _engine :Literal['pandas','modin']='pandas'_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/dataframe.html#DataFrameLoader.__init__)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.__init__ "Link to this definition")       
Initialize with dataframe object. 
...
load() → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.load "Link to this definition")
...
On this page 
  * [`DataFrameLoader`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.__init__)
    * [`alazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.alazy_load)
    * [`aload()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.aload)
    * [`lazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.lazy_load)
    * [`load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.load)
    * [`load_and_split()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.dataframe.DataFrameLoader.html#langchain_community.document_loaders.dataframe.DataFrameLoader.load_and_split)
