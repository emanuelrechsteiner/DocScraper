...
scraped_at: 2025-05-25T18:07:35.317397
title: How deal with high cardinality categoricals when doing query analysis | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/how_to/query_high_cardinality/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/how_to/query_high_cardinality/)
...
[v0.3](https://python.langchain.com/docs/how_to/query_high_cardinality/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/how_to/query_high_cardinality/)
...
## Setup[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#setup "Direct link to Setup")
#### Install dependencies[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#install-dependencies "Direct link to Install dependencies")
```
...
#### Set environment variables[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#set-environment-variables "Direct link to Set environment variables")
...
#### Set up data[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#set-up-data "Direct link to Set up data")
...
## Query Analysis[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#query-analysis "Direct link to Query Analysis")
...
### Add in all values[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#add-in-all-values "Direct link to Add in all values")
...
### Find and all relevant values[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#find-and-all-relevant-values "Direct link to Find and all relevant values")
...
### Replace after selection[​](https://python.langchain.com/docs/how_to/query_high_cardinality/#replace-after-selection "Direct link to Replace after selection")
...
#### Was this page helpful?
  * [Setup](https://python.langchain.com/docs/how_to/query_high_cardinality/#setup)
  * [Query Analysis](https://python.langchain.com/docs/how_to/query_high_cardinality/#query-analysis)
    * [Add in all values](https://python.langchain.com/docs/how_to/query_high_cardinality/#add-in-all-values)
    * [Find and all relevant values](https://python.langchain.com/docs/how_to/query_high_cardinality/#find-and-all-relevant-values)
    * [Replace after selection](https://python.langchain.com/docs/how_to/query_high_cardinality/#replace-after-selection)
