---
url: https://python.langchain.com/docs/integrations/document_loaders/kinetica/
scraped_at: 2025-05-25T18:05:42.248961
title: Kinetica | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/kinetica/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/kinetica/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/kinetica/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/kinetica/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/kinetica/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/kinetica/)
...
```
# Kinetica needs the connection to the database.# This is how to set it up.HOST = os.getenv("KINETICA_HOST","http://127.0.0.1:9191")USERNAME = os.getenv("KINETICA_USERNAME","")PASSWORD = os.getenv("KINETICA_PASSWORD","")defcreate_config()-> KineticaSettings:return KineticaSettings(host=HOST, username=USERNAME, password=PASSWORD)
```
...
**API Reference:**[KineticaLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.kinetica_loader.KineticaLoader.html)
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/kinetica/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/kinetica.ipynb)
#### Was this page helpful?
[PreviousJupyter Notebook](https://python.langchain.com/docs/integrations/document_loaders/jupyter_notebook/)[NextlakeFS](https://python.langchain.com/docs/integrations/document_loaders/lakefs/)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/kinetica/#related)
