---
url: https://python.langchain.com/docs/integrations/providers/lancedb/
scraped_at: 2025-05-25T18:11:04.453360
title: LanceDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/lancedb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/lancedb/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/lancedb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/lancedb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/lancedb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/lancedb/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/lancedb.mdx)
# LanceDB
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/lancedb/#installation-and-setup "Direct link to Installation and Setup")
  * Install the Python SDK with `pip install lancedb`


## Wrappers[​](https://python.langchain.com/docs/integrations/providers/lancedb/#wrappers "Direct link to Wrappers")
### VectorStore[​](https://python.langchain.com/docs/integrations/providers/lancedb/#vectorstore "Direct link to VectorStore")
...
For a more detailed walkthrough of the LanceDB wrapper, see [this notebook](https://python.langchain.com/docs/integrations/vectorstores/lancedb/)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/lancedb.mdx)
#### Was this page helpful?
[PreviouslakeFS](https://python.langchain.com/docs/integrations/providers/lakefs/)[NextLangChain Decorators ✨](https://python.langchain.com/docs/integrations/providers/langchain_decorators/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/lancedb/#installation-and-setup)
  * [Wrappers](https://python.langchain.com/docs/integrations/providers/lancedb/#wrappers)
    * [VectorStore](https://python.langchain.com/docs/integrations/providers/lancedb/#vectorstore)
