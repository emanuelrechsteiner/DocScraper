...
scraped_at: 2025-05-25T17:57:15.681311
title: Blockchain | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/blockchain/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/blockchain/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/blockchain/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/blockchain/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/blockchain/)
...
## Load NFTs into Document Loader[​](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#load-nfts-into-document-loader "Direct link to Load NFTs into Document Loader")
```
# get ALCHEMY_API_KEY from https://www.alchemy.com/alchemyApiKey ="..."
```

### Option 1: Ethereum Mainnet (default BlockchainType)[​](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#option-1-ethereum-mainnet-default-blockchaintype "Direct link to Option 1: Ethereum Mainnet \(default BlockchainType\)")
```
...
### Option 2: Polygon Mainnet[​](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#option-2-polygon-mainnet "Direct link to Option 2: Polygon Mainnet")
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/blockchain.ipynb)
#### Was this page helpful?
[PreviousBlackboard](https://python.langchain.com/docs/integrations/document_loaders/blackboard/)[NextBox](https://python.langchain.com/docs/integrations/document_loaders/box/)
  * [Overview](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#overview)
  * [Load NFTs into Document Loader](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#load-nfts-into-document-loader)
    * [Option 1: Ethereum Mainnet (default BlockchainType)](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#option-1-ethereum-mainnet-default-blockchaintype)
    * [Option 2: Polygon Mainnet](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#option-2-polygon-mainnet)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/blockchain/#related)
