...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/marqo.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/marqo.ipynb)
# Marqo
...
**API Reference:**[TextLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.text.TextLoader.html) | [Marqo](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.marqo.Marqo.html) | [CharacterTextSplitter](https://python.langchain.com/api_reference/text_splitters/character/langchain_text_splitters.character.CharacterTextSplitter.html)
```
from langchain_community.document_loaders import TextLoaderloader = TextLoader("../../how_to/state_of_the_union.txt")documents = loader.load()text_splitter = CharacterTextSplitter(chunk_size=1000, chunk_overlap=0)docs = text_splitter.split_documents(documents)
```
...
## Additional features[​](https://python.langchain.com/docs/integrations/vectorstores/marqo/#additional-features "Direct link to Additional features")
...
#### Multimodal Example[​](https://python.langchain.com/docs/integrations/vectorstores/marqo/#multimodal-example "Direct link to Multimodal Example")
```
...
```
defget_content(res):"""Helper to format Marqo's documents into text to be used as page_content"""returnf"{res['caption']}: {res['image']}"docsearch = Marqo(client, index_name, page_content_builder=get_content)query ="vehicles that fly"doc_results = docsearch.similarity_search(query)
```
...
#### Text only example[​](https://python.langchain.com/docs/integrations/vectorstores/marqo/#text-only-example "Direct link to Text only example")
```
...
```
# Note text indexes retain the ability to use add_texts despite different field names in documents# this is because the page_content_builder callback lets you handle these document fields as requireddefget_content(res):"""Helper to format Marqo's documents into text to be used as page_content"""if"text"in res:return res["text"]return res["Description"]docsearch = Marqo(client, index_name, page_content_builder=get_content)docsearch.add_texts(["This is a document that is about elephants"])
```
...
## Weighted Queries[​](https://python.langchain.com/docs/integrations/vectorstores/marqo/#weighted-queries "Direct link to Weighted Queries")
...
```
import getpassimport osfrom langchain.chains import RetrievalQAWithSourcesChainfrom langchain_openai import OpenAIif"OPENAI_API_KEY"notin os.environ:  os.environ["OPENAI_API_KEY"]= getpass.getpass("OpenAI API Key:")
```

**API Reference:**[RetrievalQAWithSourcesChain](https://python.langchain.com/api_reference/langchain/chains/langchain.chains.qa_with_sources.retrieval.RetrievalQAWithSourcesChain.html) | [OpenAI](https://python.langchain.com/api_reference/openai/llms/langchain_openai.llms.base.OpenAI.html)
```
OpenAI API Key:········
```

```
withopen("../../how_to/state_of_the_union.txt")as f:  state_of_the_union = f.read()text_splitter = CharacterTextSplitter(chunk_size=1000, chunk_overlap=0)texts = text_splitter.split_text(state_of_the_union)
```
...
## Related[​](https://python.langchain.com/docs/integrations/vectorstores/marqo/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/vectorstores/marqo.ipynb)
#### Was this page helpful?
[PreviousMariaDB](https://python.langchain.com/docs/integrations/vectorstores/mariadb/)[NextMeilisearch](https://python.langchain.com/docs/integrations/vectorstores/meilisearch/)
  * [Additional features](https://python.langchain.com/docs/integrations/vectorstores/marqo/#additional-features)
  * [Weighted Queries](https://python.langchain.com/docs/integrations/vectorstores/marqo/#weighted-queries)
  * [Related](https://python.langchain.com/docs/integrations/vectorstores/marqo/#related)
