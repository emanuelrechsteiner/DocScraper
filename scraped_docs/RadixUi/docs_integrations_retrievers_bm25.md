...
scraped_at: 2025-05-25T17:55:20.682246
title: BM25 | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/retrievers/bm25/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/retrievers/bm25/)
...
[v0.3](https://python.langchain.com/docs/integrations/retrievers/bm25/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/retrievers/bm25/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/retrievers/bm25/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/retrievers/bm25/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/bm25.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/bm25.ipynb)
# BM25
...
## Create New Retriever with Texts[​](https://python.langchain.com/docs/integrations/retrievers/bm25/#create-new-retriever-with-texts "Direct link to Create New Retriever with Texts")
```
retriever = BM25Retriever.from_texts(["foo","bar","world","hello","foo bar"])
```

## Create a New Retriever with Documents[​](https://python.langchain.com/docs/integrations/retrievers/bm25/#create-a-new-retriever-with-documents "Direct link to Create a New Retriever with Documents")
...
## Use Retriever[​](https://python.langchain.com/docs/integrations/retrievers/bm25/#use-retriever "Direct link to Use Retriever")
...
## Preprocessing Function[​](https://python.langchain.com/docs/integrations/retrievers/bm25/#preprocessing-function "Direct link to Preprocessing Function")
...
## Related[​](https://python.langchain.com/docs/integrations/retrievers/bm25/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/retrievers/bm25.ipynb)
#### Was this page helpful?
[PreviousBedrock (Knowledge Bases)](https://python.langchain.com/docs/integrations/retrievers/bedrock/)[NextBox](https://python.langchain.com/docs/integrations/retrievers/box/)
  * [Create New Retriever with Texts](https://python.langchain.com/docs/integrations/retrievers/bm25/#create-new-retriever-with-texts)
  * [Create a New Retriever with Documents](https://python.langchain.com/docs/integrations/retrievers/bm25/#create-a-new-retriever-with-documents)
  * [Use Retriever](https://python.langchain.com/docs/integrations/retrievers/bm25/#use-retriever)
  * [Preprocessing Function](https://python.langchain.com/docs/integrations/retrievers/bm25/#preprocessing-function)
  * [Related](https://python.langchain.com/docs/integrations/retrievers/bm25/#related)
