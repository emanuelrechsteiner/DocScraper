---
url: https://python.langchain.com/docs/integrations/llms/gooseai/
scraped_at: 2025-05-25T18:03:37.169573
title: GooseAI | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/llms/gooseai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/llms/gooseai/)
...
[v0.3](https://python.langchain.com/docs/integrations/llms/gooseai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/llms/gooseai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/llms/gooseai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/llms/gooseai/)
...
## Install openai[​](https://python.langchain.com/docs/integrations/llms/gooseai/#install-openai "Direct link to Install openai")
The `openai` package is required to use the GooseAI API. Install `openai` using `pip install openai`.
```
%pip install --upgrade --quiet langchain-openai
```

## Imports[​](https://python.langchain.com/docs/integrations/llms/gooseai/#imports "Direct link to Imports")
```
...
## Set the Environment API Key[​](https://python.langchain.com/docs/integrations/llms/gooseai/#set-the-environment-api-key "Direct link to Set the Environment API Key")
...
## Create the GooseAI instance[​](https://python.langchain.com/docs/integrations/llms/gooseai/#create-the-gooseai-instance "Direct link to Create the GooseAI instance")
You can specify different parameters such as the model name, max tokens generated, temperature, etc.
```
llm = GooseAI()
```

## Create a Prompt Template[​](https://python.langchain.com/docs/integrations/llms/gooseai/#create-a-prompt-template "Direct link to Create a Prompt Template")
We will create a prompt template for Question and Answer.
```
template ="""Question: {question}Answer: Let's think step by step."""prompt = PromptTemplate.from_template(template)
```

## Initiate the LLMChain[​](https://python.langchain.com/docs/integrations/llms/gooseai/#initiate-the-llmchain "Direct link to Initiate the LLMChain")
```
llm_chain = LLMChain(prompt=prompt, llm=llm)
```

## Run the LLMChain[​](https://python.langchain.com/docs/integrations/llms/gooseai/#run-the-llmchain "Direct link to Run the LLMChain")
Provide a question and run the LLMChain.
```
question ="What NFL team won the Super Bowl in the year Justin Beiber was born?"llm_chain.run(question)
```

## Related[​](https://python.langchain.com/docs/integrations/llms/gooseai/#related "Direct link to Related")
...
[PreviousGoogle Cloud Vertex AI](https://python.langchain.com/docs/integrations/llms/google_vertex_ai_palm/)[NextGPT4All](https://python.langchain.com/docs/integrations/llms/gpt4all/)
  * [Install openai](https://python.langchain.com/docs/integrations/llms/gooseai/#install-openai)
  * [Imports](https://python.langchain.com/docs/integrations/llms/gooseai/#imports)
  * [Set the Environment API Key](https://python.langchain.com/docs/integrations/llms/gooseai/#set-the-environment-api-key)
  * [Create the GooseAI instance](https://python.langchain.com/docs/integrations/llms/gooseai/#create-the-gooseai-instance)
  * [Create a Prompt Template](https://python.langchain.com/docs/integrations/llms/gooseai/#create-a-prompt-template)
  * [Initiate the LLMChain](https://python.langchain.com/docs/integrations/llms/gooseai/#initiate-the-llmchain)
  * [Run the LLMChain](https://python.langchain.com/docs/integrations/llms/gooseai/#run-the-llmchain)
  * [Related](https://python.langchain.com/docs/integrations/llms/gooseai/#related)
