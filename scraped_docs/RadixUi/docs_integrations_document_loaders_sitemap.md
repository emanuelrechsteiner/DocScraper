---
url: https://python.langchain.com/docs/integrations/document_loaders/sitemap/
scraped_at: 2025-05-25T18:10:17.139871
title: Sitemap | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/sitemap/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/sitemap/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/sitemap/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/sitemap/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/sitemap/)
...
## Overview[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#integration-details "Direct link to Integration details")
...
### Loader features[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#loader-features "Direct link to Loader features")
Source| Document Lazy Loading| Native Async Support  
---|---|---  
SiteMapLoader| ✅| ❌  
## Setup[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#setup "Direct link to Setup")
To access SiteMap document loader you'll need to install the `langchain-community` integration package.
### Credentials[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#credentials "Direct link to Credentials")
...
### Installation[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#installation "Direct link to Installation")
Install **langchain_community**.
```
%pip install -qU langchain-community
```

### Fix notebook asyncio bug[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#fix-notebook-asyncio-bug "Direct link to Fix notebook asyncio bug")
```
import nest_asyncionest_asyncio.apply()
```

## Initialization[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#initialization "Direct link to Initialization")
...
## Load[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#load "Direct link to Load")
```
...
## Lazy Load[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#lazy-load "Direct link to Lazy Load")
You can also load the pages lazily in order to minimize the memory load.
```
page =[]for doc in sitemap_loader.lazy_load():  page.append(doc)iflen(page)>=10:# do some paged operation, e.g.# index.upsert(page)    page =[]
```
...
## Filtering sitemap URLs[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#filtering-sitemap-urls "Direct link to Filtering sitemap URLs")
...
## Add custom scraping rules[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#add-custom-scraping-rules "Direct link to Add custom scraping rules")
...
```
from bs4 import BeautifulSoupdefremove_nav_and_header_elements(content: BeautifulSoup)->str:# Find all 'nav' and 'header' elements in the BeautifulSoup object  nav_elements = content.find_all("nav")  header_elements = content.find_all("header")# Remove each 'nav' and 'header' element from the BeautifulSoup objectfor element in nav_elements + header_elements:    element.decompose()returnstr(content.get_text())
```
...
## Local Sitemap[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#local-sitemap "Direct link to Local Sitemap")
The sitemap loader can also be used to load local files.
```
sitemap_loader = SitemapLoader(web_path="example_data/sitemap.xml", is_local=True)docs = sitemap_loader.load()
```

## API reference[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/sitemap.ipynb)
#### Was this page helpful?
[PreviousSingleStore](https://python.langchain.com/docs/integrations/document_loaders/singlestore/)[NextSlack](https://python.langchain.com/docs/integrations/document_loaders/slack/)
  * [Overview](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#integration-details)
    * [Loader features](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#loader-features)
  * [Setup](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#installation)
    * [Fix notebook asyncio bug](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#fix-notebook-asyncio-bug)
  * [Initialization](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#initialization)
  * [Load](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#load)
  * [Lazy Load](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#lazy-load)
  * [Filtering sitemap URLs](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#filtering-sitemap-urls)
  * [Add custom scraping rules](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#add-custom-scraping-rules)
  * [Local Sitemap](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#local-sitemap)
  * [API reference](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/sitemap/#related)
