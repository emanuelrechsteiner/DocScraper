...
scraped_at: 2025-05-25T17:55:56.180890
title: Airbyte Zendesk Support (Deprecated) | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/)
...
## Installation[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#installation "Direct link to Installation")
...
## Example[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#example "Direct link to Example")
Check out the [Airbyte documentation page](https://docs.airbyte.com/integrations/sources/zendesk-support/) for details about how to configure the reader. The JSON schema the config object should adhere to can be found on Github: <https://github.com/airbytehq/airbyte/blob/master/airbyte-integrations/connectors/source-zendesk-support/source_zendesk_support/spec.json>.
...
**API Reference:**[AirbyteZendeskSupportLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.airbyte.AirbyteZendeskSupportLoader.html)
...
```
from langchain_core.documents import Documentdefhandle_record(record,id):return Document(page_content=record.data["title"], metadata=record.data)loader = AirbyteZendeskSupportLoader(  config=config, record_handler=handle_record, stream_name="tickets")docs = loader.load()
```
...
## Incremental loads[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#incremental-loads "Direct link to Incremental loads")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/airbyte_zendesk_support.ipynb)
#### Was this page helpful?
[PreviousAirbyte Typeform (Deprecated)](https://python.langchain.com/docs/integrations/document_loaders/airbyte_typeform/)[NextAirtable](https://python.langchain.com/docs/integrations/document_loaders/airtable/)
  * [Installation](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#installation)
  * [Example](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#example)
  * [Incremental loads](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#incremental-loads)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/airbyte_zendesk_support/#related)
