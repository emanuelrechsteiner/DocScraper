...
scraped_at: 2025-05-25T18:06:36.427236
title: AsyncChromiumLoader — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#main-content)
Back to top `⌘`+`K`
...
# AsyncChromiumLoader[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#asyncchromiumloader "Link to this heading") 

_class_ langchain_community.document_loaders.chromium.AsyncChromiumLoader( 
    _urls :List[str]_,     _*_ ,     _headless :bool=True_,     _user_agent :str|None=None_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/chromium.html#AsyncChromiumLoader)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader "Link to this definition")     
...
Parameters:
  ...
  * **user_agent** (_str_ _|__None_) – The user agent to use for the browser
...
Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.__init__ "langchain_community.document_loaders.chromium.AsyncChromiumLoader.__init__")(urls, *[, headless, user_agent]) | Initialize the loader with a list of URL paths.  
---|---  
[`alazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.alazy_load "langchain_community.document_loaders.chromium.AsyncChromiumLoader.alazy_load")() | Asynchronously load text content from the provided URLs.  
[`aload`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.aload "langchain_community.document_loaders.chromium.AsyncChromiumLoader.aload")() | Load data into Document objects.  
[`ascrape_playwright`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.ascrape_playwright "langchain_community.document_loaders.chromium.AsyncChromiumLoader.ascrape_playwright")(url) | Asynchronously scrape the content of a given URL using Playwright's async API.  
[`lazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.lazy_load "langchain_community.document_loaders.chromium.AsyncChromiumLoader.lazy_load")() | Lazily load text content from the provided URLs.  
[`load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.load "langchain_community.document_loaders.chromium.AsyncChromiumLoader.load")() | Load data into Document objects.  
[`load_and_split`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.load_and_split "langchain_community.document_loaders.chromium.AsyncChromiumLoader.load_and_split")([text_splitter]) | Load Documents and split into chunks. 

__init__( 
    _urls :List[str]_,     _*_ ,     _headless :bool=True_,     _user_agent :str|None=None_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/chromium.html#AsyncChromiumLoader.__init__)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.__init__ "Link to this definition")       
Initialize the loader with a list of URL paths. 
...
_async_ ascrape_playwright(_url :str_) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/chromium.html#AsyncChromiumLoader.ascrape_playwright)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.ascrape_playwright "Link to this definition")
...
lazy_load() → Iterator[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/chromium.html#AsyncChromiumLoader.lazy_load)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.lazy_load "Link to this definition")
...
load() → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.load "Link to this definition")
...
On this page 
  * [`AsyncChromiumLoader`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.__init__)
    * [`alazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.alazy_load)
    * [`aload()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.aload)
    * [`ascrape_playwright()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.ascrape_playwright)
    * [`lazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.lazy_load)
    * [`load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.load)
    * [`load_and_split()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.chromium.AsyncChromiumLoader.html#langchain_community.document_loaders.chromium.AsyncChromiumLoader.load_and_split)
