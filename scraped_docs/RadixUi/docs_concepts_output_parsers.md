...
scraped_at: 2025-05-25T17:54:25.932809
title: Output parsers | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/concepts/output_parsers/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/concepts/output_parsers/)
...
[v0.3](https://python.langchain.com/docs/concepts/output_parsers/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/concepts/output_parsers/)
...
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/concepts/output_parsers.mdx)
# Output parsers
note
The information here refers to parsers that take a text output from a model try to parse it into a more structured representation. More and more models are supporting function (or tool) calling, which handles this automatically. It is recommended to use function/tool calling rather than output parsing. See documentation for that [here](https://python.langchain.com/docs/concepts/tool_calling/).
...
For specifics on how to use output parsers, see the [relevant how-to guides here](https://python.langchain.com/docs/how_to/#output-parsers).
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/concepts/output_parsers.mdx)
#### Was this page helpful?
[PreviousMultimodality](https://python.langchain.com/docs/concepts/multimodality/)[NextPrompt Templates](https://python.langchain.com/docs/concepts/prompt_templates/)
Community
