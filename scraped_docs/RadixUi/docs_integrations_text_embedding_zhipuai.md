---
url: https://python.langchain.com/docs/integrations/text_embedding/zhipuai/
scraped_at: 2025-05-25T18:10:50.460482
title: ZhipuAIEmbeddings | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/)
...
[v0.3](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/zhipuai.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/zhipuai.ipynb)
# ZhipuAIEmbeddings
...
## Overview[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#integration-details "Direct link to Integration details")
Provider| Package  
---|---  
[ZhipuAI](https://python.langchain.com/docs/integrations/providers/zhipuai/)| [langchain-community](https://python.langchain.com/api_reference/community/embeddings/langchain_community.embeddings.zhipuai.ZhipuAIEmbeddings.html)  
## Setup[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#credentials "Direct link to Credentials")
...
```
import getpassimport osifnot os.getenv("ZHIPUAI_API_KEY"):  os.environ["ZHIPUAI_API_KEY"]= getpass.getpass("Enter your ZhipuAI API key: ")
```
...
### Installation[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#installation "Direct link to Installation")
...
## Instantiation[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#instantiation "Direct link to Instantiation")
Now we can instantiate our model object and generate chat completions:
```
from langchain_community.embeddings import ZhipuAIEmbeddingsembeddings = ZhipuAIEmbeddings(  model="embedding-3",# With the `embedding-3` class# of models, you can specify the size# of the embeddings you want returned.# dimensions=1024)
```

**API Reference:**[ZhipuAIEmbeddings](https://python.langchain.com/api_reference/community/embeddings/langchain_community.embeddings.zhipuai.ZhipuAIEmbeddings.html)
## Indexing and Retrieval[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#indexing-and-retrieval "Direct link to Indexing and Retrieval")
...
## Direct Usage[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#direct-usage "Direct link to Direct Usage")
Under the hood, the vectorstore and retriever implementations are calling `embeddings.embed_documents(...)` and `embeddings.embed_query(...)` to create embeddings for the text(s) used in `from_texts` and retrieval `invoke` operations, respectively.
You can directly call these methods to get embeddings for your own use cases.
### Embed single texts[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#embed-single-texts "Direct link to Embed single texts")
...
### Embed multiple texts[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#embed-multiple-texts "Direct link to Embed multiple texts")
...
```
[-0.022979736, 0.007785797, 0.04598999, 0.012741089, -0.01689148, 0.008277893, 0.016464233, 0.009246[-0.02330017, -0.013916016, 0.00022411346, 0.017196655, -0.034240723, 0.011131287, 0.011497498, -0.0
```

## API Reference[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#api-reference "Direct link to API Reference")
...
## Related[​](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/text_embedding/zhipuai.ipynb)
#### Was this page helpful?
[PreviousYandexGPT](https://python.langchain.com/docs/integrations/text_embedding/yandex/)[NextLLMs](https://python.langchain.com/docs/integrations/llms/)
  * [Overview](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#instantiation)
  * [Indexing and Retrieval](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#indexing-and-retrieval)
  * [Direct Usage](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#direct-usage)
    * [Embed single texts](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#embed-single-texts)
    * [Embed multiple texts](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#embed-multiple-texts)
  * [API Reference](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/text_embedding/zhipuai/#related)
