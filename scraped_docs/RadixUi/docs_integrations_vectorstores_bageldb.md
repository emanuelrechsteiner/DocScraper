...
scraped_at: 2025-05-25T18:02:08.907489
title: BagelDB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/vectorstores/bageldb/)
...
[v0.3](https://python.langchain.com/docs/integrations/vectorstores/bageldb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/vectorstores/bageldb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/vectorstores/bageldb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/vectorstores/bageldb/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/bageldb.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/bageldb.ipynb)
# BagelDB
...
### Installation and Setup[​](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#installation-and-setup "Direct link to Installation and Setup")
```
pip install betabageldb langchain-community
```

## Create VectorStore from texts[​](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#create-vectorstore-from-texts "Direct link to Create VectorStore from texts")
```
...
## Create VectorStore from docs[​](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#create-vectorstore-from-docs "Direct link to Create VectorStore from docs")
```
...
## Get all text/doc from Cluster[​](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#get-all-textdoc-from-cluster "Direct link to Get all text/doc from Cluster")
```
...
## Create cluster with metadata & filter using metadata[​](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#create-cluster-with-metadata--filter-using-metadata "Direct link to Create cluster with metadata & filter using metadata")
```
...
## Related[​](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/vectorstores/bageldb.ipynb)
#### Was this page helpful?
[PreviousBagel](https://python.langchain.com/docs/integrations/vectorstores/bagel/)[NextBaidu Cloud ElasticSearch VectorSearch](https://python.langchain.com/docs/integrations/vectorstores/baiducloud_vector_search/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#installation-and-setup)
  * [Create VectorStore from texts](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#create-vectorstore-from-texts)
  * [Create VectorStore from docs](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#create-vectorstore-from-docs)
  * [Get all text/doc from Cluster](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#get-all-textdoc-from-cluster)
  * [Create cluster with metadata & filter using metadata](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#create-cluster-with-metadata--filter-using-metadata)
  * [Related](https://python.langchain.com/docs/integrations/vectorstores/bageldb/#related)
