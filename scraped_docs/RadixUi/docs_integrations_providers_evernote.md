---
url: https://python.langchain.com/docs/integrations/providers/evernote/
scraped_at: 2025-05-25T17:59:10.783635
title: EverNote | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/evernote/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/evernote/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/evernote/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/evernote/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/evernote/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/evernote/)
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/evernote/#installation-and-setup "Direct link to Installation and Setup")
First, you need to install `lxml` and `html2text` python packages.
```
pip install lxmlpip install html2text
```

## Document Loader[​](https://python.langchain.com/docs/integrations/providers/evernote/#document-loader "Direct link to Document Loader")
See a [usage example](https://python.langchain.com/docs/integrations/document_loaders/evernote/).
```
...
[PreviousEverly AI](https://python.langchain.com/docs/integrations/providers/everlyai/)[NextExa](https://python.langchain.com/docs/integrations/providers/exa_search/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/evernote/#installation-and-setup)
  * [Document Loader](https://python.langchain.com/docs/integrations/providers/evernote/#document-loader)
