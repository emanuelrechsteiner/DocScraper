...
scraped_at: 2025-05-25T18:06:08.018451
title: JavaScriptSegmenter — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#main-content)
Back to top `⌘`+`K`
...
# JavaScriptSegmenter[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#javascriptsegmenter "Link to this heading") 

_class_ langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter(_code :str_)[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/javascript.html#JavaScriptSegmenter)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter "Link to this definition")
    
Code segmenter for JavaScript.
Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.__init__ "langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.__init__")(code) |   
---|---  
[`extract_functions_classes`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.extract_functions_classes "langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.extract_functions_classes")() |   
[`is_valid`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.is_valid "langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.is_valid")() |   
[`simplify_code`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.simplify_code "langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.simplify_code")() |  

Parameters:
      
**code** (_str_) 

__init__(_code :str_)[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/javascript.html#JavaScriptSegmenter.__init__)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.__init__ "Link to this definition")
...
extract_functions_classes() → List[str][[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/javascript.html#JavaScriptSegmenter.extract_functions_classes)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.extract_functions_classes "Link to this definition")
...
is_valid() → bool[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/javascript.html#JavaScriptSegmenter.is_valid)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.is_valid "Link to this definition")
...
simplify_code() → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/javascript.html#JavaScriptSegmenter.simplify_code)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.simplify_code "Link to this definition")
...
str
On this page 
  * [`JavaScriptSegmenter`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.__init__)
    * [`extract_functions_classes()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.extract_functions_classes)
    * [`is_valid()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.is_valid)
    * [`simplify_code()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.html#langchain_community.document_loaders.parsers.language.javascript.JavaScriptSegmenter.simplify_code)
