...
scraped_at: 2025-05-25T17:55:49.163599
title: Dappier | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/dappier/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/dappier/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/dappier/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/dappier/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/dappier/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/dappier/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/dappier.mdx)
# Dappier
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/dappier/#installation-and-setup "Direct link to Installation and Setup")
...
## Chat models[​](https://python.langchain.com/docs/integrations/providers/dappier/#chat-models "Direct link to Chat models")
See a [usage example](https://python.langchain.com/docs/integrations/chat/dappier/).
```
from langchain_community.chat_models import ChatDappierAI
```

## Retriever[​](https://python.langchain.com/docs/integrations/providers/dappier/#retriever "Direct link to Retriever")
See a [usage example](https://python.langchain.com/docs/integrations/retrievers/dappier/).
```
from langchain_dappier import DappierRetriever
```

## Tool[​](https://python.langchain.com/docs/integrations/providers/dappier/#tool "Direct link to Tool")
See a [usage example](https://python.langchain.com/docs/integrations/tools/dappier/).
```
from langchain_dappier import(  DappierRealTimeSearchTool,  DappierAIRecommendationTool)
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/dappier.mdx)
#### Was this page helpful?
[PreviousCube](https://python.langchain.com/docs/integrations/providers/cube/)[NextDashVector](https://python.langchain.com/docs/integrations/providers/dashvector/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/dappier/#installation-and-setup)
  * [Chat models](https://python.langchain.com/docs/integrations/providers/dappier/#chat-models)
  * [Retriever](https://python.langchain.com/docs/integrations/providers/dappier/#retriever)
  * [Tool](https://python.langchain.com/docs/integrations/providers/dappier/#tool)
