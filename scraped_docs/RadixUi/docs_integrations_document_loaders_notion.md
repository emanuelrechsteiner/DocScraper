---
url: https://python.langchain.com/docs/integrations/document_loaders/notion/
scraped_at: 2025-05-25T17:59:58.716135
title: Notion DB 2/2 | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/notion/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/notion/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/notion/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/notion/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/notion/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/notion/)
...
## Requirements[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#requirements "Direct link to Requirements")
  * A `Notion` Database
  * Notion Integration Token


## Setup[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#setup "Direct link to Setup")
### 1. Create a Notion Table Database[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#1-create-a-notion-table-database "Direct link to 1. Create a Notion Table Database")
...
## 2. Create a Notion Integration[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#2-create-a-notion-integration "Direct link to 2. Create a Notion Integration")
...
### 3. Connect the Integration to the Database[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#3-connect-the-integration-to-the-database "Direct link to 3. Connect the Integration to the Database")
...
### 4. Get the Database ID[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#4-get-the-database-id "Direct link to 4. Get the Database ID")
...
### 5. Installation[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#5-installation "Direct link to 5. Installation")
Instaall the `langchain-community` integration package.
```
%pip install -qU langchain-community
```

## Notion Database Loader[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#notion-database-loader "Direct link to Notion Database Loader")
...
**API Reference:**[NotionDBLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.notiondb.NotionDBLoader.html)
```
...
## Notion Directory Loader[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#notion-directory-loader "Direct link to Notion Directory Loader")
### Setup[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#setup-1 "Direct link to Setup")
...
### Usage[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#usage "Direct link to Usage")
Run the following command to ingest the data you just downloaded.
```
from langchain_community.document_loaders import NotionDirectoryLoaderloader = NotionDirectoryLoader("Notion_DB")
```

**API Reference:**[NotionDirectoryLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.notion.NotionDirectoryLoader.html)
```
docs = loader.load()
```

## Related[​](https://python.langchain.com/docs/integrations/document_loaders/notion/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/notion.ipynb)
#### Was this page helpful?
[PreviousNews URL](https://python.langchain.com/docs/integrations/document_loaders/news/)[NextNuclia](https://python.langchain.com/docs/integrations/document_loaders/nuclia/)
  * [Requirements](https://python.langchain.com/docs/integrations/document_loaders/notion/#requirements)
  * [Setup](https://python.langchain.com/docs/integrations/document_loaders/notion/#setup)
    * [1. Create a Notion Table Database](https://python.langchain.com/docs/integrations/document_loaders/notion/#1-create-a-notion-table-database)
  * [2. Create a Notion Integration](https://python.langchain.com/docs/integrations/document_loaders/notion/#2-create-a-notion-integration)
    * [3. Connect the Integration to the Database](https://python.langchain.com/docs/integrations/document_loaders/notion/#3-connect-the-integration-to-the-database)
    * [4. Get the Database ID](https://python.langchain.com/docs/integrations/document_loaders/notion/#4-get-the-database-id)
    * [5. Installation](https://python.langchain.com/docs/integrations/document_loaders/notion/#5-installation)
  * [Notion Database Loader](https://python.langchain.com/docs/integrations/document_loaders/notion/#notion-database-loader)
  * [Notion Directory Loader](https://python.langchain.com/docs/integrations/document_loaders/notion/#notion-directory-loader)
    * [Setup](https://python.langchain.com/docs/integrations/document_loaders/notion/#setup-1)
    * [Usage](https://python.langchain.com/docs/integrations/document_loaders/notion/#usage)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/notion/#related)
