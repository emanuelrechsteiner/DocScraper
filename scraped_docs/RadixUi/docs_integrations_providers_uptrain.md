---
url: https://python.langchain.com/docs/integrations/providers/uptrain/
scraped_at: 2025-05-25T18:01:03.124941
title: UpTrain | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/uptrain/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/uptrain/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/uptrain/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/uptrain/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/uptrain/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/uptrain/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/uptrain.md)
# UpTrain
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/uptrain/#installation-and-setup "Direct link to Installation and Setup")
```
pip install uptrain
```

## Callbacks[​](https://python.langchain.com/docs/integrations/providers/uptrain/#callbacks "Direct link to Callbacks")
```
...
See an [example](https://python.langchain.com/docs/integrations/callbacks/uptrain/).
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/uptrain.md)
#### Was this page helpful?
[Previousupstash](https://python.langchain.com/docs/integrations/providers/upstash/)[NextUSearch](https://python.langchain.com/docs/integrations/providers/usearch/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/uptrain/#installation-and-setup)
  * [Callbacks](https://python.langchain.com/docs/integrations/providers/uptrain/#callbacks)
