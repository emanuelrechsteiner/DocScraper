...
scraped_at: 2025-05-25T17:57:26.690241
title: Oracle Cloud Infrastructure (OCI) | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/oci/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/oci/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/oci/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/oci/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/oci/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/oci/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/oci.mdx)
# Oracle Cloud Infrastructure (OCI)
The `LangChain` integrations related to [Oracle Cloud Infrastructure](https://www.oracle.com/artificial-intelligence/).
## OCI Generative AI[​](https://python.langchain.com/docs/integrations/providers/oci/#oci-generative-ai "Direct link to OCI Generative AI")
...
See [chat](https://python.langchain.com/docs/integrations/llms/oci_generative_ai/), [complete](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/), and [embedding](https://python.langchain.com/docs/integrations/text_embedding/oci_generative_ai/) usage examples.
```
from langchain_community.chat_models import ChatOCIGenAIfrom langchain_community.llms import OCIGenAIfrom langchain_community.embeddings import OCIGenAIEmbeddings
```

**API Reference:**[ChatOCIGenAI](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.oci_generative_ai.ChatOCIGenAI.html) | [OCIGenAI](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.oci_generative_ai.OCIGenAI.html) | [OCIGenAIEmbeddings](https://python.langchain.com/api_reference/community/embeddings/langchain_community.embeddings.oci_generative_ai.OCIGenAIEmbeddings.html)
## OCI Data Science Model Deployment Endpoint[​](https://python.langchain.com/docs/integrations/providers/oci/#oci-data-science-model-deployment-endpoint "Direct link to OCI Data Science Model Deployment Endpoint")
...
See [chat](https://python.langchain.com/docs/integrations/chat/oci_data_science/) and [complete](https://python.langchain.com/docs/integrations/llms/oci_model_deployment_endpoint/) usage examples.
```
from langchain_community.chat_models import ChatOCIModelDeploymentfrom langchain_community.llms import OCIModelDeploymentLLM
```

**API Reference:**[ChatOCIModelDeployment](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.oci_data_science.ChatOCIModelDeployment.html) | [OCIModelDeploymentLLM](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.oci_data_science_model_deployment_endpoint.OCIModelDeploymentLLM.html)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/oci.mdx)
#### Was this page helpful?
[PreviousOceanBase](https://python.langchain.com/docs/integrations/providers/oceanbase/)[NextOctoAI](https://python.langchain.com/docs/integrations/providers/octoai/)
  * [OCI Generative AI](https://python.langchain.com/docs/integrations/providers/oci/#oci-generative-ai)
  * [OCI Data Science Model Deployment Endpoint](https://python.langchain.com/docs/integrations/providers/oci/#oci-data-science-model-deployment-endpoint)
