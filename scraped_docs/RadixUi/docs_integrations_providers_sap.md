...
scraped_at: 2025-05-25T17:59:17.908018
title: SAP | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/sap/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/sap/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/sap/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/sap/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/sap/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/sap/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/sap.mdx)
# SAP
> [SAP SE(Wikipedia)](https://www.sap.com/about/company.html) is a German multinational software company. It develops enterprise software to manage business operation and customer relations. The company is the world's leading `enterprise resource planning (ERP)` software vendor.
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/sap/#installation-and-setup "Direct link to Installation and Setup")
We need to install the `langchain-hana` python package.
```
pip install langchain-hana
```

## Vectorstore[​](https://python.langchain.com/docs/integrations/providers/sap/#vectorstore "Direct link to Vectorstore")
...
See a [usage example](https://python.langchain.com/docs/integrations/vectorstores/sap_hanavector/).
```
from langchain_hana import HanaDB
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/sap.mdx)
#### Was this page helpful?
[PreviousSambaNova](https://python.langchain.com/docs/integrations/providers/sambanova/)[NextScrapeGraph AI](https://python.langchain.com/docs/integrations/providers/scrapegraph/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/sap/#installation-and-setup)
  * [Vectorstore](https://python.langchain.com/docs/integrations/providers/sap/#vectorstore)
