...
scraped_at: 2025-05-25T18:13:19.904607
title: How to use prompting alone (no tool calling) to do extraction | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/how_to/extraction_parse/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/how_to/extraction_parse/)
...
[v0.3](https://python.langchain.com/docs/how_to/extraction_parse/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/how_to/extraction_parse/)
...
OpenAI▾
* [OpenAI](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Anthropic](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Azure](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Google Gemini](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Google Vertex](https://python.langchain.com/docs/how_to/extraction_parse/)
* [AWS](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Groq](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Cohere](https://python.langchain.com/docs/how_to/extraction_parse/)
* [NVIDIA](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Fireworks AI](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Mistral AI](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Together AI](https://python.langchain.com/docs/how_to/extraction_parse/)
* [IBM watsonx](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Databricks](https://python.langchain.com/docs/how_to/extraction_parse/)
* [xAI](https://python.langchain.com/docs/how_to/extraction_parse/)
* [Perplexity](https://python.langchain.com/docs/how_to/extraction_parse/)
```
pip install -qU "langchain[openai]"
```

```
import getpassimport osifnot os.environ.get("OPENAI_API_KEY"): os.environ["OPENAI_API_KEY"]= getpass.getpass("Enter API key for OpenAI: ")from langchain.chat_models import init_chat_modelmodel = init_chat_model("gpt-4o-mini", model_provider="openai")
```

tip
This tutorial is meant to be simple, but generally should really include reference examples to squeeze out performance!
## Using PydanticOutputParser[​](https://python.langchain.com/docs/how_to/extraction_parse/#using-pydanticoutputparser "Direct link to Using PydanticOutputParser")
...
## Custom Parsing[​](https://python.langchain.com/docs/how_to/extraction_parse/#custom-parsing "Direct link to Custom Parsing")
...
## Other Libraries[​](https://python.langchain.com/docs/how_to/extraction_parse/#other-libraries "Direct link to Other Libraries")
...
#### Was this page helpful?
  * [Using PydanticOutputParser](https://python.langchain.com/docs/how_to/extraction_parse/#using-pydanticoutputparser)
  * [Custom Parsing](https://python.langchain.com/docs/how_to/extraction_parse/#custom-parsing)
  * [Other Libraries](https://python.langchain.com/docs/how_to/extraction_parse/#other-libraries)
