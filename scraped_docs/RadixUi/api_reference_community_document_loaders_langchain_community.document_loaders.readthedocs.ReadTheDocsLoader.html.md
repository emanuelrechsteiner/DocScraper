...
scraped_at: 2025-05-25T18:08:24.519039
title: ReadTheDocsLoader — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#main-content)
Back to top `⌘`+`K`
...
# ReadTheDocsLoader[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#readthedocsloader "Link to this heading") 

_class_ langchain_community.document_loaders.readthedocs.ReadTheDocsLoader( 
    _path :str|Path_,     _encoding :str|None=None_,     _errors :str|None=None_,     _custom_html_tag :Tuple[str,dict]|None=None_,     _patterns :Sequence[str]=('*.htm', '*.html')_,     _exclude_links_ratio :float=1.0_,     _** kwargs:Any|None_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/readthedocs.html#ReadTheDocsLoader)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader "Link to this definition")     
...
Parameters:
  ...
  * **custom_html_tag** (_Optional_ _[__Tuple_ _[__str_ _,__dict_ _]__]_) – Optional custom html tag to retrieve the content from files.
  * **patterns** (_Sequence_ _[__str_ _]_) – The file patterns to load, passed to glob.rglob.
  * **exclude_links_ratio** (_float_) – The ratio of links:content to exclude pages from. This is to reduce the frequency at which index pages make their way into retrieved results. Recommended: 0.5
  * **kwargs** (_Optional_ _[__Any_ _]_) – named arguments passed to bs4.BeautifulSoup.


Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.__init__ "langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.__init__")(path[, encoding, errors, ...]) | Initialize ReadTheDocsLoader  
---|---  
[`alazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.alazy_load "langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.alazy_load")() | A lazy loader for Documents.  
[`aload`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.aload "langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.aload")() | Load data into Document objects.  
[`lazy_load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.lazy_load "langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.lazy_load")() | A lazy loader for Documents.  
[`load`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load "langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load")() | Load data into Document objects.  
[`load_and_split`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load_and_split "langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load_and_split")([text_splitter]) | Load Documents and split into chunks. 

__init__( 
    _path :str|Path_,     _encoding :str|None=None_,     _errors :str|None=None_,     _custom_html_tag :Tuple[str,dict]|None=None_,     _patterns :Sequence[str]=('*.htm', '*.html')_,     _exclude_links_ratio :float=1.0_,     _** kwargs:Any|None_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/readthedocs.html#ReadTheDocsLoader.__init__)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.__init__ "Link to this definition")       
Initialize ReadTheDocsLoader
The loader loops over all files under path and extracts the actual content of the files by retrieving main html tags. Default main html tags include <main id=”main-content>, <div role=”main>, and <article role=”main”>. You can also define your own html tags by passing custom_html_tag, e.g. (“div”, “class=main”). The loader iterates html tags with the order of custom html tags (if exists) and default html tags. If any of the tags is not empty, the loop will break and retrieve the content out of that tag. 
...
Parameters:
  ...
  * **custom_html_tag** (_Tuple_ _[__str_ _,__dict_ _]__|__None_) – Optional custom html tag to retrieve the content from files.
  * **patterns** (_Sequence_ _[__str_ _]_) – The file patterns to load, passed to glob.rglob.
  * **exclude_links_ratio** (_float_) – The ratio of links:content to exclude pages from. This is to reduce the frequency at which index pages make their way into retrieved results. Recommended: 0.5
...
_async_ aload() → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.aload "Link to this definition")
...
lazy_load() → Iterator[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/readthedocs.html#ReadTheDocsLoader.lazy_load)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.lazy_load "Link to this definition")
...
load() → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load "Link to this definition")
...
load_and_split( 
    _text_splitter :[TextSplitter](https://python.langchain.com/api_reference/text_splitters/base/langchain_text_splitters.base.TextSplitter.html#langchain_text_splitters.base.TextSplitter "langchain_text_splitters.base.TextSplitter")|None=None_, ) → list[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")][#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load_and_split "Link to this definition")     
...
On this page 
  * [`ReadTheDocsLoader`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.__init__)
    * [`alazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.alazy_load)
    * [`aload()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.aload)
    * [`lazy_load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.lazy_load)
    * [`load()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load)
    * [`load_and_split()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.html#langchain_community.document_loaders.readthedocs.ReadTheDocsLoader.load_and_split)
