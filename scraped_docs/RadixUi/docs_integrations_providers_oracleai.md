---
url: https://python.langchain.com/docs/integrations/providers/oracleai/
scraped_at: 2025-05-25T17:55:31.479691
title: OracleAI Vector Search | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/oracleai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/oracleai/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/oracleai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/oracleai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/oracleai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/oracleai/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/oracleai.mdx)
# OracleAI Vector Search
...
## Document Loaders[​](https://python.langchain.com/docs/integrations/providers/oracleai/#document-loaders "Direct link to Document Loaders")
Please check the [usage example](https://python.langchain.com/docs/integrations/document_loaders/oracleai/).
```
...
## Text Splitter[​](https://python.langchain.com/docs/integrations/providers/oracleai/#text-splitter "Direct link to Text Splitter")
Please check the [usage example](https://python.langchain.com/docs/integrations/document_loaders/oracleai/).
```
...
## Embeddings[​](https://python.langchain.com/docs/integrations/providers/oracleai/#embeddings "Direct link to Embeddings")
Please check the [usage example](https://python.langchain.com/docs/integrations/text_embedding/oracleai/).
```
...
## Summary[​](https://python.langchain.com/docs/integrations/providers/oracleai/#summary "Direct link to Summary")
Please check the [usage example](https://python.langchain.com/docs/integrations/tools/oracleai/).
```
...
## Vector Store[​](https://python.langchain.com/docs/integrations/providers/oracleai/#vector-store "Direct link to Vector Store")
Please check the [usage example](https://python.langchain.com/docs/integrations/vectorstores/oracle/).
```
...
## End to End Demo[​](https://python.langchain.com/docs/integrations/providers/oracleai/#end-to-end-demo "Direct link to End to End Demo")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/oracleai.mdx)
#### Was this page helpful?
[PreviousOpenWeatherMap](https://python.langchain.com/docs/integrations/providers/openweathermap/)[NextOutline](https://python.langchain.com/docs/integrations/providers/outline/)
  * [Document Loaders](https://python.langchain.com/docs/integrations/providers/oracleai/#document-loaders)
  * [Text Splitter](https://python.langchain.com/docs/integrations/providers/oracleai/#text-splitter)
  * [Embeddings](https://python.langchain.com/docs/integrations/providers/oracleai/#embeddings)
  * [Summary](https://python.langchain.com/docs/integrations/providers/oracleai/#summary)
  * [Vector Store](https://python.langchain.com/docs/integrations/providers/oracleai/#vector-store)
  * [End to End Demo](https://python.langchain.com/docs/integrations/providers/oracleai/#end-to-end-demo)
