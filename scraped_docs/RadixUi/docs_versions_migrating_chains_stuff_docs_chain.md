---
url: https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/
scraped_at: 2025-05-25T17:56:32.425322
title: Migrating from StuffDocumentsChain | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
...
[v0.3](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
...
OpenAI▾
* [OpenAI](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Anthropic](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Azure](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Google Gemini](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Google Vertex](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [AWS](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Groq](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Cohere](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [NVIDIA](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Fireworks AI](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Mistral AI](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Together AI](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [IBM watsonx](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Databricks](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [xAI](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
* [Perplexity](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/)
```
...
## Example[​](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#example "Direct link to Example")
...
### Legacy[​](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#legacy "Direct link to Legacy")
Details
...
### LCEL[​](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#lcel "Direct link to LCEL")
Details
...
**API Reference:**[create_stuff_documents_chain](https://python.langchain.com/api_reference/langchain/chains/langchain.chains.combine_documents.stuff.create_stuff_documents_chain.html) | [ChatPromptTemplate](https://python.langchain.com/api_reference/core/prompts/langchain_core.prompts.chat.ChatPromptTemplate.html)
...
## Next steps[​](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#next-steps "Direct link to Next steps")
Check out the [LCEL conceptual docs](https://python.langchain.com/docs/concepts/lcel/) for more background information.
See these [how-to guides](https://python.langchain.com/docs/how_to/#qa-with-rag) for more on question-answering tasks with RAG.
See [this tutorial](https://python.langchain.com/docs/tutorials/summarization/) for more LLM-based summarization strategies.
...
[PreviousMigrating from RetrievalQA](https://python.langchain.com/docs/versions/migrating_chains/retrieval_qa/)[NextHow to migrate to LangGraph memory](https://python.langchain.com/docs/versions/migrating_memory/)
  * [Example](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#example)
    * [Legacy](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#legacy)
    * [LCEL](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#lcel)
  * [Next steps](https://python.langchain.com/docs/versions/migrating_chains/stuff_docs_chain/#next-steps)
