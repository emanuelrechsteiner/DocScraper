---
url: https://python.langchain.com/docs/integrations/tools/github/
scraped_at: 2025-05-25T18:16:23.021588
title: Github Toolkit | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/github/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/github/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/github/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/github/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/github/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/github/)
...
## Setup[​](https://python.langchain.com/docs/integrations/tools/github/#setup "Direct link to Setup")
...
### Installation[​](https://python.langchain.com/docs/integrations/tools/github/#installation "Direct link to Installation")
#### 1. Install dependencies[​](https://python.langchain.com/docs/integrations/tools/github/#1-install-dependencies "Direct link to 1. Install dependencies")
This integration is implemented in `langchain-community`. We will also need the `pygithub` dependency:
```
%pip install --upgrade --quiet pygithub langchain-community
```

#### 2. Create a Github App[​](https://python.langchain.com/docs/integrations/tools/github/#2-create-a-github-app "Direct link to 2. Create a Github App")
...
#### 3. Set Environment Variables[​](https://python.langchain.com/docs/integrations/tools/github/#3-set-environment-variables "Direct link to 3. Set Environment Variables")
Before initializing your agent, the following environment variables need to be set:
  ...
  * **GITHUB_REPOSITORY** - The name of the Github repository you want your bot to act upon. Must follow the format {username}/{repo-name}. _Make sure the app has been added to this repository first!_
...
```
import getpassimport osfor env_var in["GITHUB_APP_ID","GITHUB_APP_PRIVATE_KEY","GITHUB_REPOSITORY",]:ifnot os.getenv(env_var):    os.environ[env_var]= getpass.getpass()
```

## Instantiation[​](https://python.langchain.com/docs/integrations/tools/github/#instantiation "Direct link to Instantiation")
...
## Tools[​](https://python.langchain.com/docs/integrations/tools/github/#tools "Direct link to Tools")
...
## Include release tools[​](https://python.langchain.com/docs/integrations/tools/github/#include-release-tools "Direct link to Include release tools")
...
## Use within an agent[​](https://python.langchain.com/docs/integrations/tools/github/#use-within-an-agent "Direct link to Use within an agent")
We will need a LLM or chat model:
Select [chat model](https://python.langchain.com/docs/integrations/chat/):
OpenAI▾
* [OpenAI](https://python.langchain.com/docs/integrations/tools/github/)
* [Anthropic](https://python.langchain.com/docs/integrations/tools/github/)
* [Azure](https://python.langchain.com/docs/integrations/tools/github/)
* [Google Gemini](https://python.langchain.com/docs/integrations/tools/github/)
* [Google Vertex](https://python.langchain.com/docs/integrations/tools/github/)
* [AWS](https://python.langchain.com/docs/integrations/tools/github/)
* [Groq](https://python.langchain.com/docs/integrations/tools/github/)
* [Cohere](https://python.langchain.com/docs/integrations/tools/github/)
* [NVIDIA](https://python.langchain.com/docs/integrations/tools/github/)
* [Fireworks AI](https://python.langchain.com/docs/integrations/tools/github/)
* [Mistral AI](https://python.langchain.com/docs/integrations/tools/github/)
* [Together AI](https://python.langchain.com/docs/integrations/tools/github/)
* [IBM watsonx](https://python.langchain.com/docs/integrations/tools/github/)
* [Databricks](https://python.langchain.com/docs/integrations/tools/github/)
* [xAI](https://python.langchain.com/docs/integrations/tools/github/)
* [Perplexity](https://python.langchain.com/docs/integrations/tools/github/)
```
...
```
from langgraph.prebuilt import create_react_agenttools =[tool for tool in toolkit.get_tools()if tool.name =="Get Issue"]assertlen(tools)==1tools[0].name ="get_issue"agent_executor = create_react_agent(llm, tools)
```
...
## API reference[​](https://python.langchain.com/docs/integrations/tools/github/#api-reference "Direct link to API reference")
For detailed documentation of all `GithubToolkit` features and configurations head to the [API reference](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.github.toolkit.GitHubToolkit.html).
## Related[​](https://python.langchain.com/docs/integrations/tools/github/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/github.ipynb)
#### Was this page helpful?
[PreviousFMP Data](https://python.langchain.com/docs/integrations/tools/fmp-data/)[NextGitlab Toolkit](https://python.langchain.com/docs/integrations/tools/gitlab/)
  * [Setup](https://python.langchain.com/docs/integrations/tools/github/#setup)
    * [Installation](https://python.langchain.com/docs/integrations/tools/github/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/github/#instantiation)
  * [Tools](https://python.langchain.com/docs/integrations/tools/github/#tools)
  * [Include release tools](https://python.langchain.com/docs/integrations/tools/github/#include-release-tools)
  * [Use within an agent](https://python.langchain.com/docs/integrations/tools/github/#use-within-an-agent)
  * [API reference](https://python.langchain.com/docs/integrations/tools/github/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/github/#related)
