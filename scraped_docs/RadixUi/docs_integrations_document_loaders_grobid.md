...
scraped_at: 2025-05-25T18:13:16.381353
title: Grobid | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/grobid/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/grobid/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/grobid/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/grobid/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/grobid/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/grobid/)
...
(Note: additional instructions can be found [here](https://python.langchain.com/docs/integrations/providers/grobid/).)
Once grobid is up-and-running you can interact as described below.
Now, we can use the data loader.
```
from langchain_community.document_loaders.generic import GenericLoaderfrom langchain_community.document_loaders.parsers import GrobidParser
```

**API Reference:**[GenericLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.generic.GenericLoader.html) | [GrobidParser](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.grobid.GrobidParser.html)
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/grobid/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/grobid.ipynb)
#### Was this page helpful?
[PreviousGoogle Speech-to-Text Audio Transcripts](https://python.langchain.com/docs/integrations/document_loaders/google_speech_to_text/)[NextGutenberg](https://python.langchain.com/docs/integrations/document_loaders/gutenberg/)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/grobid/#related)
