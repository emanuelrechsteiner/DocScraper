---
url: https://python.langchain.com/docs/integrations/tools/cassandra_database/
scraped_at: 2025-05-25T18:13:34.698277
title: Cassandra Database Toolkit | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/cassandra_database/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/cassandra_database/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/cassandra_database/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/cassandra_database/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/cassandra_database/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/cassandra_database/)
...
## Quick Start[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#quick-start "Direct link to Quick Start")
...
## Theory of Operation[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#theory-of-operation "Direct link to Theory of Operation")
...
## Tools Provided[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#tools-provided "Direct link to Tools Provided")
### `cassandra_db_schema`[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#cassandra_db_schema "Direct link to cassandra_db_schema")
...
### `cassandra_db_select_table_data`[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#cassandra_db_select_table_data "Direct link to cassandra_db_select_table_data")
...
### `cassandra_db_query`[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#cassandra_db_query "Direct link to cassandra_db_query")
Expiriemental alternative to `cassandra_db_select_table_data` which takes a query string completely formed by the agent instead of parameters. _Warning_ : This can lead to unusual queries that may not be as performant(or even work). This may be removed in future releases. If it does something cool, we want to know about that too. You never know!
## Environment Setup[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#environment-setup "Direct link to Environment Setup")
Install the following Python modules:
```
pip install ipykernel python-dotenv cassio langchain_openai langchain langchain-community langchainhub
```

### .env file[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#env-file "Direct link to .env file")
...
**API Reference:**[hub](https://python.langchain.com/api_reference/langchain/hub/langchain.hub.hub.html) | [AgentExecutor](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.agent.AgentExecutor.html) | [create_openai_tools_agent](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.openai_tools.base.create_openai_tools_agent.html) | [CassandraDatabaseToolkit](https://python.langchain.com/api_reference/community/agent_toolkits/langchain_community.agent_toolkits.cassandra_database.toolkit.CassandraDatabaseToolkit.html) | [CassandraDatabase](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.cassandra_database.CassandraDatabase.html) | [ChatOpenAI](https://python.langchain.com/api_reference/openai/chat_models/langchain_openai.chat_models.base.ChatOpenAI.html)
## Connect to a Cassandra Database[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#connect-to-a-cassandra-database "Direct link to Connect to a Cassandra Database")
```
cassio.init(auto=True)session = cassio.config.resolve_session()ifnot session:raise Exception("Check environment configuration or manually configure cassio connection parameters")
```
...
## Related[​](https://python.langchain.com/docs/integrations/tools/cassandra_database/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/cassandra_database.ipynb)
#### Was this page helpful?
[PreviousBrightDataUnlocker](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/)[NextCDP](https://python.langchain.com/docs/integrations/tools/cdp_agentkit/)
  * [Quick Start](https://python.langchain.com/docs/integrations/tools/cassandra_database/#quick-start)
  * [Theory of Operation](https://python.langchain.com/docs/integrations/tools/cassandra_database/#theory-of-operation)
  * [Tools Provided](https://python.langchain.com/docs/integrations/tools/cassandra_database/#tools-provided)
    * [`cassandra_db_schema`](https://python.langchain.com/docs/integrations/tools/cassandra_database/#cassandra_db_schema)
    * [`cassandra_db_select_table_data`](https://python.langchain.com/docs/integrations/tools/cassandra_database/#cassandra_db_select_table_data)
    * [`cassandra_db_query`](https://python.langchain.com/docs/integrations/tools/cassandra_database/#cassandra_db_query)
  * [Environment Setup](https://python.langchain.com/docs/integrations/tools/cassandra_database/#environment-setup)
    * [.env file](https://python.langchain.com/docs/integrations/tools/cassandra_database/#env-file)
  * [Connect to a Cassandra Database](https://python.langchain.com/docs/integrations/tools/cassandra_database/#connect-to-a-cassandra-database)
  * [Related](https://python.langchain.com/docs/integrations/tools/cassandra_database/#related)
