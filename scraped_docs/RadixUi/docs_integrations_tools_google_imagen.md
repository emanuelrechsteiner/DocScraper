...
scraped_at: 2025-05-25T18:09:55.299702
title: Google Imagen | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/google_imagen/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/google_imagen/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/google_imagen/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/google_imagen/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/google_imagen/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/google_imagen/)
...
With Imagen on Langchain , You can do the following tasks
  * [VertexAIImageGeneratorChat](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-generation) : Generate novel images using only a text prompt (text-to-image AI generation).
  * [VertexAIImageEditorChat](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-editing) : Edit an entire uploaded or generated image with a text prompt.
  * [VertexAIImageCaptioning](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-captioning) : Get text descriptions of images with visual captioning.
  * [VertexAIVisualQnAChat](https://python.langchain.com/docs/integrations/tools/google_imagen/#visual-question-answering-vqa) : Get answers to a question about an image with Visual Question Answering (VQA). 
    * NOTE : Currently we support only only single-turn chat for Visual QnA (VQA)


## Image Generation[​](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-generation "Direct link to Image Generation")
Generate novel images using only a text prompt (text-to-image AI generation)
```
from langchain_core.messages import AIMessage, HumanMessagefrom langchain_google_vertexai.vision_models import VertexAIImageGeneratorChat
```

**API Reference:**[AIMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.ai.AIMessage.html) | [HumanMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessage.html) | [VertexAIImageGeneratorChat](https://python.langchain.com/api_reference/google_vertexai/vision_models/langchain_google_vertexai.vision_models.VertexAIImageGeneratorChat.html)
```
# Create Image Gentation model Objectgenerator = VertexAIImageGeneratorChat()
```
...
```
import base64import iofrom PIL import Image# Parse response object to get base64 string for imageimg_base64 = generated_image["image_url"]["url"].split(",")[-1]# Convert base64 string to Imageimg = Image.open(io.BytesIO(base64.decodebytes(bytes(img_base64,"utf-8"))))# view Imageimg
```

![](https://python.langchain.com/docs/integrations/tools/google_imagen/)
## Image Editing[​](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-editing "Direct link to Image Editing")
Edit an entire uploaded or generated image with a text prompt.
### Edit Generated Image[​](https://python.langchain.com/docs/integrations/tools/google_imagen/#edit-generated-image "Direct link to Edit Generated Image")
```
from langchain_core.messages import AIMessage, HumanMessagefrom langchain_google_vertexai.vision_models import(  VertexAIImageEditorChat,  VertexAIImageGeneratorChat,)
```

**API Reference:**[AIMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.ai.AIMessage.html) | [HumanMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessage.html) | [VertexAIImageEditorChat](https://python.langchain.com/api_reference/google_vertexai/vision_models/langchain_google_vertexai.vision_models.VertexAIImageEditorChat.html) | [VertexAIImageGeneratorChat](https://python.langchain.com/api_reference/google_vertexai/vision_models/langchain_google_vertexai.vision_models.VertexAIImageGeneratorChat.html)
```
# Create Image Gentation model Objectgenerator = VertexAIImageGeneratorChat()# Provide a text input for imagemessages =[HumanMessage(content=["a cat at the beach"])]# call the model to generate an imageresponse = generator.invoke(messages)# read the image object from the responsegenerated_image = response.content[0]
```
...
```
import base64import iofrom PIL import Image# Parse response object to get base64 string for imageedited_img_base64 = editor_response.content[0]["image_url"]["url"].split(",")[-1]# Convert base64 string to Imageedited_img = Image.open(  io.BytesIO(base64.decodebytes(bytes(edited_img_base64,"utf-8"))))# view Imageedited_img
```

![](https://python.langchain.com/docs/integrations/tools/google_imagen/)
## Image Captioning[​](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-captioning "Direct link to Image Captioning")
```
from langchain_google_vertexai import VertexAIImageCaptioning# Initialize the Image Captioning Objectmodel = VertexAIImageCaptioning()
```
...
NOTE : we're using generated image in [Image Generation Section](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-generation)
```
# use image egenarted in Image Generation Sectionimg_base64 = generated_image["image_url"]["url"]response = model.invoke(img_base64)print(f"Generated Cpation : {response}")# Convert base64 string to Imageimg = Image.open(  io.BytesIO(base64.decodebytes(bytes(img_base64.split(",")[-1],"utf-8"))))# display Imageimg
```
...
![](https://python.langchain.com/docs/integrations/tools/google_imagen/)
## Visual Question Answering (VQA)[​](https://python.langchain.com/docs/integrations/tools/google_imagen/#visual-question-answering-vqa "Direct link to Visual Question Answering \(VQA\)")
```
from langchain_google_vertexai import VertexAIVisualQnAChatmodel = VertexAIVisualQnAChat()
```
...
![](https://python.langchain.com/docs/integrations/tools/google_imagen/)
## Related[​](https://python.langchain.com/docs/integrations/tools/google_imagen/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/google_imagen.ipynb)
#### Was this page helpful?
[PreviousGoogle Finance](https://python.langchain.com/docs/integrations/tools/google_finance/)[NextGoogle Jobs](https://python.langchain.com/docs/integrations/tools/google_jobs/)
  * [Image Generation](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-generation)
  * [Image Editing](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-editing)
    * [Edit Generated Image](https://python.langchain.com/docs/integrations/tools/google_imagen/#edit-generated-image)
  * [Image Captioning](https://python.langchain.com/docs/integrations/tools/google_imagen/#image-captioning)
  * [Visual Question Answering (VQA)](https://python.langchain.com/docs/integrations/tools/google_imagen/#visual-question-answering-vqa)
  * [Related](https://python.langchain.com/docs/integrations/tools/google_imagen/#related)
