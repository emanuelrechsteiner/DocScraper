...
scraped_at: 2025-05-25T18:05:24.663851
title: LocalAI | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/localai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/localai/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/localai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/localai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/localai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/localai/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/localai.mdx)
# LocalAI
...
info
`langchain-localai` is a 3rd party integration package for LocalAI. It provides a simple way to use LocalAI services in Langchain. The source code is available on [Github](https://github.com/mkhludnev/langchain-localai)
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/localai/#installation-and-setup "Direct link to Installation and Setup")
We have to install several python packages:
```
pip install tenacity openai
```

## Embedding models[​](https://python.langchain.com/docs/integrations/providers/localai/#embedding-models "Direct link to Embedding models")
See a [usage example](https://python.langchain.com/docs/integrations/text_embedding/localai/).
```
from langchain_localai import LocalAIEmbeddings
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/localai.mdx)
#### Was this page helpful?
[PreviousLLMonitor](https://python.langchain.com/docs/integrations/providers/llmonitor/)[NextLog10](https://python.langchain.com/docs/integrations/providers/log10/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/localai/#installation-and-setup)
  * [Embedding models](https://python.langchain.com/docs/integrations/providers/localai/#embedding-models)
