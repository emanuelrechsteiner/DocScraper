---
url: https://python.langchain.com/docs/integrations/tools/goat/
scraped_at: 2025-05-25T18:07:09.578840
title: GOAT | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/goat/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/goat/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/goat/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/goat/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/goat/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/goat/)
...
## Overview[​](https://python.langchain.com/docs/integrations/tools/goat/#overview "Direct link to Overview")
...
### How it works[​](https://python.langchain.com/docs/integrations/tools/goat/#how-it-works "Direct link to How it works")
...
### Quickstarts[​](https://python.langchain.com/docs/integrations/tools/goat/#quickstarts "Direct link to Quickstarts")
...
## Setup[​](https://python.langchain.com/docs/integrations/tools/goat/#setup "Direct link to Setup")
...
## Instantiation[​](https://python.langchain.com/docs/integrations/tools/goat/#instantiation "Direct link to Instantiation")
Now we can instantiate our toolkit:
```
from goat_adapters.langchain import get_on_chain_toolsfrom goat_wallets.solana import solana, send_solanafrom goat_plugins.spl_token import spl_token, SplTokenPluginOptionsfrom goat_plugins.spl_token.tokens import SPL_TOKENS# Initialize Solana clientclient = SolanaClient(os.getenv("SOLANA_RPC_ENDPOINT"))# Initialize regular Solana walletkeypair = Keypair.from_base58_string(os.getenv("SOLANA_WALLET_SEED")or"")wallet = solana(client, keypair)tools = get_on_chain_tools(    wallet=wallet,    plugins=[      send_solana(),      spl_token(SplTokenPluginOptions(        network="mainnet",# Using devnet as specified in .env        tokens=SPL_TOKENS)),],)
```

## Invocation[​](https://python.langchain.com/docs/integrations/tools/goat/#invocation "Direct link to Invocation")
```
tools["get_balance"].invoke({"address":"0x1234567890123456789012345678901234567890"})
```

## Use within an agent[​](https://python.langchain.com/docs/integrations/tools/goat/#use-within-an-agent "Direct link to Use within an agent")
```
import osimport asynciofrom dotenv import load_dotenv# Load environment variablesload_dotenv()from solana.rpc.api import Client as SolanaClientfrom solders.keypair import Keypairfrom goat_adapters.langchain import get_on_chain_toolsfrom goat_wallets.solana import solana, send_solanafrom goat_plugins.spl_token import spl_token, SplTokenPluginOptionsfrom goat_plugins.spl_token.tokens import SPL_TOKENS# Initialize Solana clientclient = SolanaClient(os.getenv("SOLANA_RPC_ENDPOINT"))# Initialize regular Solana walletkeypair = Keypair.from_base58_string(os.getenv("SOLANA_WALLET_SEED")or"")wallet = solana(client, keypair)# Initialize LLMllm = ChatOpenAI(model="gpt-4o-mini")defmain():# Initialize tools with Solana wallet  tools = get_on_chain_tools(    wallet=wallet,    plugins=[      send_solana(),      spl_token(SplTokenPluginOptions(        network="mainnet",# Using devnet as specified in .env        tokens=SPL_TOKENS)),],)# Initialize agent# Your agent code hereif __name__ =="__main__":  main()
```

## API reference[​](https://python.langchain.com/docs/integrations/tools/goat/#api-reference "Direct link to API reference")
  * For a complete list of tools, see the [GOAT SDK documentation](https://github.com/goat-sdk/goat).


## Related[​](https://python.langchain.com/docs/integrations/tools/goat/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/goat.ipynb)
#### Was this page helpful?
[PreviousGmail Toolkit](https://python.langchain.com/docs/integrations/tools/gmail/)[NextGolden Query](https://python.langchain.com/docs/integrations/tools/golden_query/)
  * [Overview](https://python.langchain.com/docs/integrations/tools/goat/#overview)
    * [How it works](https://python.langchain.com/docs/integrations/tools/goat/#how-it-works)
    * [Quickstarts](https://python.langchain.com/docs/integrations/tools/goat/#quickstarts)
  * [Setup](https://python.langchain.com/docs/integrations/tools/goat/#setup)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/goat/#instantiation)
  * [Invocation](https://python.langchain.com/docs/integrations/tools/goat/#invocation)
  * [Use within an agent](https://python.langchain.com/docs/integrations/tools/goat/#use-within-an-agent)
  * [API reference](https://python.langchain.com/docs/integrations/tools/goat/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/goat/#related)
