---
url: https://python.langchain.com/docs/integrations/stores/redis/
scraped_at: 2025-05-25T18:13:08.978597
title: RedisStore | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/stores/redis/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/stores/redis/)
...
[v0.3](https://python.langchain.com/docs/integrations/stores/redis/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/stores/redis/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/stores/redis/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/stores/redis/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/stores/redis.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/stores/redis.ipynb)
# RedisStore
This will help you get started with Redis [key-value stores](https://python.langchain.com/docs/concepts/key_value_stores/). For detailed documentation of all `RedisStore` features and configurations head to the [API reference](https://python.langchain.com/api_reference/community/storage/langchain_community.storage.redis.RedisStore.html).
## Overview[​](https://python.langchain.com/docs/integrations/stores/redis/#overview "Direct link to Overview")
The `RedisStore` is an implementation of `ByteStore` that stores everything in your Redis instance.
### Integration details[​](https://python.langchain.com/docs/integrations/stores/redis/#integration-details "Direct link to Integration details")
...
## Setup[​](https://python.langchain.com/docs/integrations/stores/redis/#setup "Direct link to Setup")
To create a Redis byte store, you'll need to set up a Redis instance. You can do this locally or via a provider - see our [Redis guide](https://python.langchain.com/docs/integrations/providers/redis/) for an overview of options.
### Installation[​](https://python.langchain.com/docs/integrations/stores/redis/#installation "Direct link to Installation")
The LangChain `RedisStore` integration lives in the `langchain_community` package:
```
%pip install -qU langchain_community redis
```

## Instantiation[​](https://python.langchain.com/docs/integrations/stores/redis/#instantiation "Direct link to Instantiation")
...
## Usage[​](https://python.langchain.com/docs/integrations/stores/redis/#usage "Direct link to Usage")
...
## API reference[​](https://python.langchain.com/docs/integrations/stores/redis/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/stores/redis/#related "Direct link to Related")
  * Key-value store [conceptual guide](https://python.langchain.com/docs/concepts/key_value_stores/)


[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/stores/redis.ipynb)
#### Was this page helpful?
[PreviousKey-value stores](https://python.langchain.com/docs/integrations/stores/)[NextUpstash Redis](https://python.langchain.com/docs/integrations/stores/upstash_redis/)
  * [Overview](https://python.langchain.com/docs/integrations/stores/redis/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/stores/redis/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/stores/redis/#setup)
    * [Installation](https://python.langchain.com/docs/integrations/stores/redis/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/stores/redis/#instantiation)
  * [Usage](https://python.langchain.com/docs/integrations/stores/redis/#usage)
  * [API reference](https://python.langchain.com/docs/integrations/stores/redis/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/stores/redis/#related)
