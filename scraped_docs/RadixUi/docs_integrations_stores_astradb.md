---
url: https://python.langchain.com/docs/integrations/stores/astradb/
scraped_at: 2025-05-25T18:16:08.818730
title: AstraDBByteStore | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/stores/astradb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/stores/astradb/)
...
[v0.3](https://python.langchain.com/docs/integrations/stores/astradb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/stores/astradb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/stores/astradb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/stores/astradb/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/stores/astradb.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/stores/astradb.ipynb)
# AstraDBByteStore
This will help you get started with Astra DB [key-value stores](https://python.langchain.com/docs/concepts/key_value_stores/). For detailed documentation of all `AstraDBByteStore` features and configurations head to the [API reference](https://python.langchain.com/api_reference/astradb/storage/langchain_astradb.storage.AstraDBByteStore.html).
## Overview[​](https://python.langchain.com/docs/integrations/stores/astradb/#overview "Direct link to Overview")
...
### Integration details[​](https://python.langchain.com/docs/integrations/stores/astradb/#integration-details "Direct link to Integration details")
...
## Setup[​](https://python.langchain.com/docs/integrations/stores/astradb/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/stores/astradb/#credentials "Direct link to Credentials")
...
### Installation[​](https://python.langchain.com/docs/integrations/stores/astradb/#installation "Direct link to Installation")
The LangChain AstraDB integration lives in the `langchain_astradb` package:
```
%pip install -qU langchain_astradb
```

## Instantiation[​](https://python.langchain.com/docs/integrations/stores/astradb/#instantiation "Direct link to Instantiation")
...
## Usage[​](https://python.langchain.com/docs/integrations/stores/astradb/#usage "Direct link to Usage")
...
You can use an `AstraDBByteStore` anywhere you'd use other ByteStores, including as a [cache for embeddings](https://python.langchain.com/docs/how_to/caching_embeddings/).
## API reference[​](https://python.langchain.com/docs/integrations/stores/astradb/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/stores/astradb/#related "Direct link to Related")
  * Key-value store [conceptual guide](https://python.langchain.com/docs/concepts/key_value_stores/)


[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/stores/astradb.ipynb)
#### Was this page helpful?
[PreviousKey-value stores](https://python.langchain.com/docs/integrations/stores/)[NextCassandra](https://python.langchain.com/docs/integrations/stores/cassandra/)
  * [Overview](https://python.langchain.com/docs/integrations/stores/astradb/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/stores/astradb/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/stores/astradb/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/stores/astradb/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/stores/astradb/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/stores/astradb/#instantiation)
  * [Usage](https://python.langchain.com/docs/integrations/stores/astradb/#usage)
  * [API reference](https://python.langchain.com/docs/integrations/stores/astradb/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/stores/astradb/#related)
