...
scraped_at: 2025-05-25T17:58:49.331099
title: Runpod | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/runpod/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/runpod/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/runpod/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/runpod/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/runpod/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/runpod/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/runpod.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/runpod.ipynb)
# Runpod
...
## Intstallation[​](https://python.langchain.com/docs/integrations/providers/runpod/#intstallation "Direct link to Intstallation")
Install the dedicated partner package:
```
%pip install -qU langchain-runpod
```

## Setup[​](https://python.langchain.com/docs/integrations/providers/runpod/#setup "Direct link to Setup")
### 1. Deploy an Endpoint on RunPod[​](https://python.langchain.com/docs/integrations/providers/runpod/#1-deploy-an-endpoint-on-runpod "Direct link to 1. Deploy an Endpoint on RunPod")
...
### 2. Set API Credentials[​](https://python.langchain.com/docs/integrations/providers/runpod/#2-set-api-credentials "Direct link to 2. Set API Credentials")
...
_(Optional)_ If using different endpoints for LLM and Chat models, you might need to set `RUNPOD_CHAT_ENDPOINT_ID` or pass the ID directly during initialization.
## Components[​](https://python.langchain.com/docs/integrations/providers/runpod/#components "Direct link to Components")
This package provides two main components:
### 1. LLM[​](https://python.langchain.com/docs/integrations/providers/runpod/#1-llm "Direct link to 1. LLM")
For interacting with standard text completion models.
See the [RunPod LLM Integration Guide](https://python.langchain.com/docs/integrations/llms/runpod/) for detailed usage
```
...
### 2. Chat Model[​](https://python.langchain.com/docs/integrations/providers/runpod/#2-chat-model "Direct link to 2. Chat Model")
For interacting with conversational models.
See the [RunPod Chat Model Integration Guide](https://python.langchain.com/docs/integrations/chat/runpod/) for detailed usage and feature support.
```
from langchain_core.messages import HumanMessagefrom langchain_runpod import ChatRunPod# Example initialization (uses environment variables)chat = ChatRunPod(model_kwargs={"temperature":0.8})# Add generation params here# Example Invocationtry:  response = chat.invoke([HumanMessage(content="Explain RunPod Serverless in one sentence.")])print(response.content)except Exception as e:print(f"Error invoking Chat Model: {e}. Ensure endpoint ID and API key are correct and endpoint is active.")
```

**API Reference:**[HumanMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessage.html)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/runpod.ipynb)
#### Was this page helpful?
[PreviousRunhouse](https://python.langchain.com/docs/integrations/providers/runhouse/)[NextRWKV-4](https://python.langchain.com/docs/integrations/providers/rwkv/)
  * [Intstallation](https://python.langchain.com/docs/integrations/providers/runpod/#intstallation)
  * [Setup](https://python.langchain.com/docs/integrations/providers/runpod/#setup)
    * [1. Deploy an Endpoint on RunPod](https://python.langchain.com/docs/integrations/providers/runpod/#1-deploy-an-endpoint-on-runpod)
    * [2. Set API Credentials](https://python.langchain.com/docs/integrations/providers/runpod/#2-set-api-credentials)
  * [Components](https://python.langchain.com/docs/integrations/providers/runpod/#components)
    * [1. LLM](https://python.langchain.com/docs/integrations/providers/runpod/#1-llm)
    * [2. Chat Model](https://python.langchain.com/docs/integrations/providers/runpod/#2-chat-model)
