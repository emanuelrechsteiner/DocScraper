...
scraped_at: 2025-05-25T18:02:34.846557
title: ChatAbso | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/abso/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/abso/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/abso/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/abso/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/abso/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/abso/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/chat/abso.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/chat/abso.ipynb)
# ChatAbso
...
## Overview[​](https://python.langchain.com/docs/integrations/chat/abso/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/chat/abso/#integration-details "Direct link to Integration details")
...
## Setup[​](https://python.langchain.com/docs/integrations/chat/abso/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/chat/abso/#credentials "Direct link to Credentials")
...
```
import getpassimport osifnot os.getenv("OPENAI_API_KEY"):  os.environ["OPENAI_API_KEY"]= getpass.getpass("Enter your OpenAI API key: ")
```

### Installation[​](https://python.langchain.com/docs/integrations/chat/abso/#installation "Direct link to Installation")
The LangChain ChatAbso integration lives in the `langchain-abso` package:
```
%pip install -qU langchain-abso
```

## Instantiation[​](https://python.langchain.com/docs/integrations/chat/abso/#instantiation "Direct link to Instantiation")
Now we can instantiate our model object and generate chat completions:
```
from langchain_abso import ChatAbsollm = ChatAbso(fast_model="gpt-4o", slow_model="o3-mini")
```

## Invocation[​](https://python.langchain.com/docs/integrations/chat/abso/#invocation "Direct link to Invocation")
```
...
## Chaining[​](https://python.langchain.com/docs/integrations/chat/abso/#chaining "Direct link to Chaining")
...
## API reference[​](https://python.langchain.com/docs/integrations/chat/abso/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/chat/abso/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/chat/abso.ipynb)
#### Was this page helpful?
[PreviousChat models](https://python.langchain.com/docs/integrations/chat/)[NextAI21 Labs](https://python.langchain.com/docs/integrations/chat/ai21/)
  * [Overview](https://python.langchain.com/docs/integrations/chat/abso/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/chat/abso/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/chat/abso/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/chat/abso/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/chat/abso/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/chat/abso/#instantiation)
  * [Invocation](https://python.langchain.com/docs/integrations/chat/abso/#invocation)
  * [Chaining](https://python.langchain.com/docs/integrations/chat/abso/#chaining)
  * [API reference](https://python.langchain.com/docs/integrations/chat/abso/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/chat/abso/#related)
