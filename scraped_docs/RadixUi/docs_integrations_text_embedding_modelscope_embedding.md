---
url: https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/
scraped_at: 2025-05-25T17:57:11.791947
title: ModelScopeEmbeddings | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/)
...
[v0.3](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/modelscope_embedding.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/modelscope_embedding.ipynb)
...
## Overview[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#integration-details "Direct link to Integration details")
Provider| Package  
---|---  
[ModelScope](https://python.langchain.com/docs/integrations/providers/modelscope/)| [langchain-modelscope-integration](https://pypi.org/project/langchain-modelscope-integration/)  
## Setup[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#credentials "Direct link to Credentials")
Head to [ModelScope](https://modelscope.cn/) to sign up to ModelScope.
```
import getpassimport osifnot os.getenv("MODELSCOPE_SDK_TOKEN"):  os.environ["MODELSCOPE_SDK_TOKEN"]= getpass.getpass("Enter your ModelScope SDK token: ")
```

### Installation[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#installation "Direct link to Installation")
...
## Instantiation[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#instantiation "Direct link to Instantiation")
Now we can instantiate our model object:
```
from langchain_modelscope import ModelScopeEmbeddingsembeddings = ModelScopeEmbeddings(  model_id="damo/nlp_corom_sentence-embedding_english-base",)
```

```
Downloading Model to directory: /root/.cache/modelscope/hub/damo/nlp_corom_sentence-embedding_english-base``````output2024-12-27 16:15:11,175 - modelscope - WARNING - Model revision not specified, use revision: v1.0.02024-12-27 16:15:11,443 - modelscope - INFO - initiate model from /root/.cache/modelscope/hub/damo/nlp_corom_sentence-embedding_english-base2024-12-27 16:15:11,444 - modelscope - INFO - initiate model from location /root/.cache/modelscope/hub/damo/nlp_corom_sentence-embedding_english-base.2024-12-27 16:15:11,445 - modelscope - INFO - initialize model from /root/.cache/modelscope/hub/damo/nlp_corom_sentence-embedding_english-base2024-12-27 16:15:12,115 - modelscope - WARNING - No preprocessor field found in cfg.2024-12-27 16:15:12,116 - modelscope - WARNING - No val key and type key found in preprocessor domain of configuration.json file.2024-12-27 16:15:12,116 - modelscope - WARNING - Cannot find available config to build preprocessor at mode inference, current config: {'model_dir': '/root/.cache/modelscope/hub/damo/nlp_corom_sentence-embedding_english-base'}. trying to build by task and model information.2024-12-27 16:15:12,318 - modelscope - WARNING - No preprocessor field found in cfg.2024-12-27 16:15:12,319 - modelscope - WARNING - No val key and type key found in preprocessor domain of configuration.json file.2024-12-27 16:15:12,319 - modelscope - WARNING - Cannot find available config to build preprocessor at mode inference, current config: {'model_dir': '/root/.cache/modelscope/hub/damo/nlp_corom_sentence-embedding_english-base', 'sequence_length': 128}. trying to build by task and model information.
```

## Indexing and Retrieval[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#indexing-and-retrieval "Direct link to Indexing and Retrieval")
...
```
/root/miniconda3/envs/langchain/lib/python3.10/site-packages/transformers/modeling_utils.py:1113: FutureWarning: The `device` argument is deprecated and will be removed in v5 of Transformers. warnings.warn(/root/miniconda3/envs/langchain/lib/python3.10/site-packages/transformers/modeling_utils.py:1113: FutureWarning: The `device` argument is deprecated and will be removed in v5 of Transformers. warnings.warn(
```
...
## Direct Usage[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#direct-usage "Direct link to Direct Usage")
Under the hood, the vectorstore and retriever implementations are calling `embeddings.embed_documents(...)` and `embeddings.embed_query(...)` to create embeddings for the text(s) used in `from_texts` and retrieval `invoke` operations, respectively.
You can directly call these methods to get embeddings for your own use cases.
### Embed single texts[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#embed-single-texts "Direct link to Embed single texts")
...
### Embed multiple texts[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#embed-multiple-texts "Direct link to Embed multiple texts")
...
```
[-0.6046381592750549, -0.3595949709415436, 0.11333223432302475, -0.030444379895925522, 0.23397321999[-0.36103254556655884, -0.7602502107620239, 0.6505364775657654, 0.000658963865134865, 1.185304522514
```

## API Reference[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#api-reference "Direct link to API Reference")
...
## Related[​](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/text_embedding/modelscope_embedding.ipynb)
#### Was this page helpful?
[Previousmodel2vec](https://python.langchain.com/docs/integrations/text_embedding/model2vec/)[NextMosaicML](https://python.langchain.com/docs/integrations/text_embedding/mosaicml/)
  * [Overview](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#instantiation)
  * [Indexing and Retrieval](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#indexing-and-retrieval)
  * [Direct Usage](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#direct-usage)
    * [Embed single texts](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#embed-single-texts)
    * [Embed multiple texts](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#embed-multiple-texts)
  * [API Reference](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/text_embedding/modelscope_embedding/#related)
