---
url: https://python.langchain.com/docs/integrations/tools/searx_search/
scraped_at: 2025-05-25T18:05:28.298206
title: SearxNG Search | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/searx_search/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/searx_search/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/searx_search/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/searx_search/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/searx_search/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/searx_search/)
...
```
import pprintfrom langchain_community.utilities import SearxSearchWrapper
```

**API Reference:**[SearxSearchWrapper](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.searx_search.SearxSearchWrapper.html)
```
...
## Custom Parameters[​](https://python.langchain.com/docs/integrations/tools/searx_search/#custom-parameters "Direct link to Custom Parameters")
...
## Obtaining results with metadata[​](https://python.langchain.com/docs/integrations/tools/searx_search/#obtaining-results-with-metadata "Direct link to Obtaining results with metadata")
...
## Related[​](https://python.langchain.com/docs/integrations/tools/searx_search/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/searx_search.ipynb)
#### Was this page helpful?
[PreviousSearchApi](https://python.langchain.com/docs/integrations/tools/searchapi/)[NextSemantic Scholar API Tool](https://python.langchain.com/docs/integrations/tools/semanticscholar/)
  * [Custom Parameters](https://python.langchain.com/docs/integrations/tools/searx_search/#custom-parameters)
  * [Obtaining results with metadata](https://python.langchain.com/docs/integrations/tools/searx_search/#obtaining-results-with-metadata)
  * [Related](https://python.langchain.com/docs/integrations/tools/searx_search/#related)
