...
scraped_at: 2025-05-25T18:07:45.831873
title: How to add examples to the prompt for query analysis | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/how_to/query_few_shot/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/how_to/query_few_shot/)
...
[v0.3](https://python.langchain.com/docs/how_to/query_few_shot/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/how_to/query_few_shot/)
...
## Setup[​](https://python.langchain.com/docs/how_to/query_few_shot/#setup "Direct link to Setup")
#### Install dependencies[​](https://python.langchain.com/docs/how_to/query_few_shot/#install-dependencies "Direct link to Install dependencies")
```
# %pip install -qU langchain-core langchain-openai
```

#### Set environment variables[​](https://python.langchain.com/docs/how_to/query_few_shot/#set-environment-variables "Direct link to Set environment variables")
...
## Query schema[​](https://python.langchain.com/docs/how_to/query_few_shot/#query-schema "Direct link to Query schema")
...
## Query generation[​](https://python.langchain.com/docs/how_to/query_few_shot/#query-generation "Direct link to Query generation")
```
...
## Adding examples and tuning the prompt[​](https://python.langchain.com/docs/how_to/query_few_shot/#adding-examples-and-tuning-the-prompt "Direct link to Adding examples and tuning the prompt")
...
#### Was this page helpful?
  * [Setup](https://python.langchain.com/docs/how_to/query_few_shot/#setup)
  * [Query schema](https://python.langchain.com/docs/how_to/query_few_shot/#query-schema)
  * [Query generation](https://python.langchain.com/docs/how_to/query_few_shot/#query-generation)
  * [Adding examples and tuning the prompt](https://python.langchain.com/docs/how_to/query_few_shot/#adding-examples-and-tuning-the-prompt)
