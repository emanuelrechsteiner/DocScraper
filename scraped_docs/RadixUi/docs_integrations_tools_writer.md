---
url: https://python.langchain.com/docs/integrations/tools/writer/
scraped_at: 2025-05-25T18:02:16.432188
title: Writer Tools | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/writer/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/writer/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/writer/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/writer/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/writer/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/writer/)
...
## Overview[​](https://python.langchain.com/docs/integrations/tools/writer/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/tools/writer/#integration-details "Direct link to Integration details")
...
### Features[​](https://python.langchain.com/docs/integrations/tools/writer/#features "Direct link to Features")
We provide usage of two types of tools for use with `ChatWriter`: `function` and `graph`.
#### Function[​](https://python.langchain.com/docs/integrations/tools/writer/#function "Direct link to Function")
...
#### Graph[​](https://python.langchain.com/docs/integrations/tools/writer/#graph "Direct link to Graph")
...
## Setup[​](https://python.langchain.com/docs/integrations/tools/writer/#setup "Direct link to Setup")
...
```
import getpassimport osifnot os.getenv("WRITER_API_KEY"):  os.environ["WRITER_API_KEY"]= getpass.getpass("Enter your Writer API key: ")
```

## Usage[​](https://python.langchain.com/docs/integrations/tools/writer/#usage "Direct link to Usage")
You can bind graph or function tools to `ChatWriter`.
### Graph Tools[​](https://python.langchain.com/docs/integrations/tools/writer/#graph-tools "Direct link to Graph Tools")
To bind graph tools, first create and initialize a `GraphTool` instance with the `graph_ids` you want to use as sources:
```
from langchain_writer.chat_models import ChatWriterfrom langchain_writer.tools import GraphToolchat = ChatWriter()graph_id = getpass.getpass("Enter Writer Knowledge Graph ID: ")graph_tool = GraphTool(graph_ids=[graph_id])
```

## Instantiation[​](https://python.langchain.com/docs/integrations/tools/writer/#instantiation "Direct link to Instantiation")
```
from typing import Optionalfrom langchain_core.tools import toolfrom pydantic import BaseModel, Field@tooldefget_supercopa_trophies_count(club_name:str)-> Optional[int]:"""Returns information about supercopa trophies count.  Args:    club_name: Club you want to investigate info of supercopa trophies about  Returns:    Number of supercopa trophies or None if there is no info about requested club  """if club_name =="Barcelona":return15elif club_name =="Real Madrid":return13elif club_name =="Atletico Madrid":return2else:returnNoneclassGetWeather(BaseModel):"""Get the current weather in a given location"""  location:str= Field(..., description="The city and state, e.g. San Francisco, CA")get_product_info ={"type":"function","function":{"name":"get_product_info","description":"Get information about a product by its id","parameters":{"type":"object","properties":{"product_id":{"type":"number","description":"The unique identifier of the product to retrieve information for",}},"required":["product_id"],},},}
```

**API Reference:**[tool](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.convert.tool.html)
### Binding tools[​](https://python.langchain.com/docs/integrations/tools/writer/#binding-tools "Direct link to Binding tools")
...
## Invocation[​](https://python.langchain.com/docs/integrations/tools/writer/#invocation "Direct link to Invocation")
The model will automatically choose the tool during invocation with all modes (streaming/non-streaming, sync/async).
```
from langchain_core.messages import HumanMessagemessages =[  HumanMessage("Use knowledge graph tool to compose this answer. Tell me what th first line of documents stored in your KG. Also I want to know: how many SuperCopa trophies have Barcelona won?")]response = chat.invoke(messages)messages.append(response)
```
...
```
for tool_call in response.tool_calls:  selected_tool ={"get_supercopa_trophies_count": get_supercopa_trophies_count,}[tool_call["name"].lower()]  tool_msg = selected_tool.invoke(tool_call)  messages.append(tool_msg)response = chat.invoke(messages)print(response.content)
```
...
## Chaining[​](https://python.langchain.com/docs/integrations/tools/writer/#chaining "Direct link to Chaining")
...
## API reference[​](https://python.langchain.com/docs/integrations/tools/writer/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/tools/writer/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/writer.ipynb)
#### Was this page helpful?
[PreviousWolfram Alpha](https://python.langchain.com/docs/integrations/tools/wolfram_alpha/)[NextYahoo Finance News](https://python.langchain.com/docs/integrations/tools/yahoo_finance_news/)
  * [Overview](https://python.langchain.com/docs/integrations/tools/writer/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/tools/writer/#integration-details)
    * [Features](https://python.langchain.com/docs/integrations/tools/writer/#features)
  * [Setup](https://python.langchain.com/docs/integrations/tools/writer/#setup)
  * [Usage](https://python.langchain.com/docs/integrations/tools/writer/#usage)
    * [Graph Tools](https://python.langchain.com/docs/integrations/tools/writer/#graph-tools)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/writer/#instantiation)
    * [Binding tools](https://python.langchain.com/docs/integrations/tools/writer/#binding-tools)
  * [Invocation](https://python.langchain.com/docs/integrations/tools/writer/#invocation)
  * [Chaining](https://python.langchain.com/docs/integrations/tools/writer/#chaining)
  * [API reference](https://python.langchain.com/docs/integrations/tools/writer/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/writer/#related)
