...
## Load chat model[​](https://python.langchain.com/docs/how_to/summarize_refine/#load-chat-model "Direct link to Load chat model")
...
## Load documents[​](https://python.langchain.com/docs/how_to/summarize_refine/#load-documents "Direct link to Load documents")
...
## Create graph[​](https://python.langchain.com/docs/how_to/summarize_refine/#create-graph "Direct link to Create graph")
...
## Invoke graph[​](https://python.langchain.com/docs/how_to/summarize_refine/#invoke-graph "Direct link to Invoke graph")
...
## Next steps[​](https://python.langchain.com/docs/how_to/summarize_refine/#next-steps "Direct link to Next steps")
