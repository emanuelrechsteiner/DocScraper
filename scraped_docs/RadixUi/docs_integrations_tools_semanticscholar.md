---
url: https://python.langchain.com/docs/integrations/tools/semanticscholar/
scraped_at: 2025-05-25T18:07:31.748282
title: Semantic Scholar API Tool | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/semanticscholar/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/semanticscholar/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/semanticscholar/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/semanticscholar/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/semanticscholar/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/semanticscholar/)
...
```
instructions ="""You are an expert researcher."""base_prompt = hub.pull("langchain-ai/openai-functions-template")prompt = base_prompt.partial(instructions=instructions)
```
...
```
from langchain_community.tools.semanticscholar.tool import SemanticScholarQueryRuntools =[SemanticScholarQueryRun()]
```

**API Reference:**[SemanticScholarQueryRun](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.semanticscholar.tool.SemanticScholarQueryRun.html)
```
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/semanticscholar.ipynb)
#### Was this page helpful?
[PreviousSearxNG Search](https://python.langchain.com/docs/integrations/tools/searx_search/)[NextSerpAPI](https://python.langchain.com/docs/integrations/tools/serpapi/)
  * [Related](https://python.langchain.com/docs/integrations/tools/semanticscholar/#related)
