...
scraped_at: 2025-05-25T18:03:04.622943
title: LLMRails | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/)
...
[v0.3](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/llm_rails.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/vectorstores/llm_rails.ipynb)
# LLMRails
...
## Adding text[​](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#adding-text "Direct link to Adding text")
...
**API Reference:**[LLMRails](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.llm_rails.LLMRails.html)
## Similarity search[​](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#similarity-search "Direct link to Similarity search")
...
## Similarity search with score[​](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#similarity-search-with-score "Direct link to Similarity search with score")
...
## LLMRails as a Retriever[​](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#llmrails-as-a-retriever "Direct link to LLMRails as a Retriever")
...
## Related[​](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/vectorstores/llm_rails.ipynb)
#### Was this page helpful?
[PreviousLindorm](https://python.langchain.com/docs/integrations/vectorstores/lindorm/)[NextManticoreSearch VectorStore](https://python.langchain.com/docs/integrations/vectorstores/manticore_search/)
  * [Adding text](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#adding-text)
  * [Similarity search](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#similarity-search)
  * [Similarity search with score](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#similarity-search-with-score)
  * [LLMRails as a Retriever](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#llmrails-as-a-retriever)
  * [Related](https://python.langchain.com/docs/integrations/vectorstores/llm_rails/#related)
