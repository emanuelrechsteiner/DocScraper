---
url: https://python.langchain.com/docs/integrations/document_loaders/airbyte
scraped_at: 2025-05-25T18:05:57.232624
title: AirbyteLoader | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/airbyte/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/airbyte/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/airbyte/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/airbyte/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/airbyte/)
...
## Loading Documents[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#loading-documents "Direct link to Loading Documents")
...
## Lazy Loading Documents[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#lazy-loading-documents "Direct link to Lazy Loading Documents")
...
```
loader = AirbyteLoader(  source="source-faker",  stream="users",  config={"count":3},  template=PromptTemplate.from_template("My name is {name} and I am {height} meters tall."),)my_async_iterator = loader.alazy_load()asyncfor doc in my_async_iterator:print(doc.page_content)
```
...
## Configuration[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#configuration "Direct link to Configuration")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/airbyte.ipynb)
#### Was this page helpful?
[PreviousAgentQLLoader](https://python.langchain.com/docs/integrations/document_loaders/agentql/)[NextAirbyte CDK (Deprecated)](https://python.langchain.com/docs/integrations/document_loaders/airbyte_cdk/)
  * [Installation](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#installation)
  * [Loading Documents](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#loading-documents)
  * [Lazy Loading Documents](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#lazy-loading-documents)
  * [Configuration](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#configuration)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/airbyte/#related)
