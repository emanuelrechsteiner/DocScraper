...
scraped_at: 2025-05-25T18:07:38.743165
title: LambdaWrapper — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#main-content)
Back to top `⌘`+`K`
...
# LambdaWrapper[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#lambdawrapper "Link to this heading") 

_class_ langchain_community.utilities.awslambda.LambdaWrapper[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/awslambda.html#LambdaWrapper)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper "Link to this definition")
...
_param_ awslambda_tool_description _: str|None_ _= None_[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.awslambda_tool_description "Link to this definition")
    
If passing to an agent as a tool, the description 

_param_ awslambda_tool_name _: str|None_ _= None_[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.awslambda_tool_name "Link to this definition")
    
If passing to an agent as a tool, the tool name 

_param_ function_name _: str|None_ _= None_[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.function_name "Link to this definition")
    
The name of your lambda function 

_param_ lambda_client _: Any_ _= None_[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.lambda_client "Link to this definition")
    
The configured boto3 client 

run(_query :str_) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/awslambda.html#LambdaWrapper.run)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.run "Link to this definition")
...
str
On this page 
  * [`LambdaWrapper`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper)
    * [`awslambda_tool_description`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.awslambda_tool_description)
    * [`awslambda_tool_name`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.awslambda_tool_name)
    * [`function_name`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.function_name)
    * [`lambda_client`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.lambda_client)
    * [`run()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.awslambda.LambdaWrapper.html#langchain_community.utilities.awslambda.LambdaWrapper.run)
