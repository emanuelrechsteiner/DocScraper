...
scraped_at: 2025-05-25T17:55:52.648330
title: Permit | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/permit/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/permit/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/permit/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/permit/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/permit/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/permit/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/permit.mdx)
# Permit
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/permit/#installation-and-setup "Direct link to Installation and Setup")
```
...
## Tools[​](https://python.langchain.com/docs/integrations/providers/permit/#tools "Direct link to Tools")
See detail on available tools [here](https://python.langchain.com/docs/integrations/tools/permit/).
## Retrievers[​](https://python.langchain.com/docs/integrations/providers/permit/#retrievers "Direct link to Retrievers")
See detail on available retrievers [here](https://python.langchain.com/docs/integrations/retrievers/permit/).
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/permit.mdx)
#### Was this page helpful?
[PreviousIdentity-enabled RAG using PebbloRetrievalQA](https://python.langchain.com/docs/integrations/providers/pebblo/pebblo_retrieval_qa/)[NextPerplexity](https://python.langchain.com/docs/integrations/providers/perplexity/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/permit/#installation-and-setup)
  * [Tools](https://python.langchain.com/docs/integrations/providers/permit/#tools)
  * [Retrievers](https://python.langchain.com/docs/integrations/providers/permit/#retrievers)
