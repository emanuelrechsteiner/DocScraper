---
url: https://python.langchain.com/docs/integrations/providers/nuclia/
scraped_at: 2025-05-25T18:04:16.690350
title: Nuclia | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/nuclia/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/nuclia/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/nuclia/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/nuclia/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/nuclia/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/nuclia/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/nuclia.mdx)
# Nuclia
> [Nuclia](https://nuclia.com) automatically indexes your unstructured data from any internal and external source, providing optimized search results and generative answers. It can handle video and audio transcription, image content extraction, and document parsing.
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/nuclia/#installation-and-setup "Direct link to Installation and Setup")
We need to install the `nucliadb-protos` package to use the `Nuclia Understanding API`
```
pip install nucliadb-protos
```

We need to have a `Nuclia account`. We can create one for free at <https://nuclia.cloud>, and then [create a NUA key](https://docs.nuclia.dev/docs/docs/using/understanding/intro).
## Document Transformer[​](https://python.langchain.com/docs/integrations/providers/nuclia/#document-transformer "Direct link to Document Transformer")
### Nuclia[​](https://python.langchain.com/docs/integrations/providers/nuclia/#nuclia-1 "Direct link to Nuclia")
...
See a [usage example](https://python.langchain.com/docs/integrations/document_transformers/nuclia_transformer/).
```
...
## Document Loaders[​](https://python.langchain.com/docs/integrations/providers/nuclia/#document-loaders "Direct link to Document Loaders")
### Nuclea loader[​](https://python.langchain.com/docs/integrations/providers/nuclia/#nuclea-loader "Direct link to Nuclea loader")
See a [usage example](https://python.langchain.com/docs/integrations/document_loaders/nuclia/).
```
...
## Vector store[​](https://python.langchain.com/docs/integrations/providers/nuclia/#vector-store "Direct link to Vector store")
### NucliaDB[​](https://python.langchain.com/docs/integrations/providers/nuclia/#nucliadb "Direct link to NucliaDB")
We need to install a python package:
```
pip install nuclia
```

See a [usage example](https://python.langchain.com/docs/integrations/vectorstores/nucliadb/).
```
...
## Tools[​](https://python.langchain.com/docs/integrations/providers/nuclia/#tools "Direct link to Tools")
### Nuclia Understanding[​](https://python.langchain.com/docs/integrations/providers/nuclia/#nuclia-understanding "Direct link to Nuclia Understanding")
See a [usage example](https://python.langchain.com/docs/integrations/tools/nuclia/).
```
from langchain_community.tools.nuclia import NucliaUnderstandingAPI
```

**API Reference:**[NucliaUnderstandingAPI](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.nuclia.tool.NucliaUnderstandingAPI.html)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/nuclia.mdx)
#### Was this page helpful?
[PreviousNotion DB](https://python.langchain.com/docs/integrations/providers/notion/)[NextNVIDIA](https://python.langchain.com/docs/integrations/providers/nvidia/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/nuclia/#installation-and-setup)
  * [Document Transformer](https://python.langchain.com/docs/integrations/providers/nuclia/#document-transformer)
    * [Nuclia](https://python.langchain.com/docs/integrations/providers/nuclia/#nuclia-1)
  * [Document Loaders](https://python.langchain.com/docs/integrations/providers/nuclia/#document-loaders)
    * [Nuclea loader](https://python.langchain.com/docs/integrations/providers/nuclia/#nuclea-loader)
  * [Vector store](https://python.langchain.com/docs/integrations/providers/nuclia/#vector-store)
    * [NucliaDB](https://python.langchain.com/docs/integrations/providers/nuclia/#nucliadb)
  * [Tools](https://python.langchain.com/docs/integrations/providers/nuclia/#tools)
    * [Nuclia Understanding](https://python.langchain.com/docs/integrations/providers/nuclia/#nuclia-understanding)
