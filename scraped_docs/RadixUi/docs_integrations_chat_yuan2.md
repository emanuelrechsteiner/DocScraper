---
url: https://python.langchain.com/docs/integrations/chat/yuan2/
scraped_at: 2025-05-25T18:13:52.515247
title: Yuan2.0 | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/yuan2/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/yuan2/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/yuan2/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/yuan2/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/yuan2/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/yuan2/)
...
## Getting started[​](https://python.langchain.com/docs/integrations/chat/yuan2/#getting-started "Direct link to Getting started")
### Installation[​](https://python.langchain.com/docs/integrations/chat/yuan2/#installation "Direct link to Installation")
...
### Importing the Required Modules[​](https://python.langchain.com/docs/integrations/chat/yuan2/#importing-the-required-modules "Direct link to Importing the Required Modules")
...
### Setting Up Your API server[​](https://python.langchain.com/docs/integrations/chat/yuan2/#setting-up-your-api-server "Direct link to Setting Up Your API server")
...
### Initialize the ChatYuan2 Model[​](https://python.langchain.com/docs/integrations/chat/yuan2/#initialize-the-chatyuan2-model "Direct link to Initialize the ChatYuan2 Model")
...
### Basic Usage[​](https://python.langchain.com/docs/integrations/chat/yuan2/#basic-usage "Direct link to Basic Usage")
...
### Basic Usage with streaming[​](https://python.langchain.com/docs/integrations/chat/yuan2/#basic-usage-with-streaming "Direct link to Basic Usage with streaming")
...
## Advanced Features[​](https://python.langchain.com/docs/integrations/chat/yuan2/#advanced-features "Direct link to Advanced Features")
### Usage with async calls[​](https://python.langchain.com/docs/integrations/chat/yuan2/#usage-with-async-calls "Direct link to Usage with async calls")
Invoke the model with non-blocking calls, like this:
```
asyncdefbasic_agenerate():  chat = ChatYuan2(    yuan2_api_base="http://127.0.0.1:8001/v1",    temperature=1.0,    model_name="yuan2",    max_retries=3,)  messages =[[      SystemMessage(content="你是个旅游小助手。"),      HumanMessage(content="给我介绍一下北京有哪些好玩的。"),]]  result =await chat.agenerate(messages)print(result)
```
...
### Usage with async calls in streaming[​](https://python.langchain.com/docs/integrations/chat/yuan2/#usage-with-async-calls-in-streaming "Direct link to Usage with async calls in streaming")
For non-blocking calls with streaming output, use the astream method:
```
asyncdefbasic_astream():  chat = ChatYuan2(    yuan2_api_base="http://127.0.0.1:8001/v1",    temperature=1.0,    model_name="yuan2",    max_retries=3,)  messages =[    SystemMessage(content="你是个旅游小助手。"),    HumanMessage(content="给我介绍一下北京有哪些好玩的。"),]  result = chat.astream(messages)asyncfor chunk in result:print(chunk.content, end="", flush=True)
```
...
## Related[​](https://python.langchain.com/docs/integrations/chat/yuan2/#related "Direct link to Related")
...
[PreviousChatYI](https://python.langchain.com/docs/integrations/chat/yi/)[NextZHIPU AI](https://python.langchain.com/docs/integrations/chat/zhipuai/)
  * [Getting started](https://python.langchain.com/docs/integrations/chat/yuan2/#getting-started)
    * [Installation](https://python.langchain.com/docs/integrations/chat/yuan2/#installation)
    * [Importing the Required Modules](https://python.langchain.com/docs/integrations/chat/yuan2/#importing-the-required-modules)
    * [Setting Up Your API server](https://python.langchain.com/docs/integrations/chat/yuan2/#setting-up-your-api-server)
    * [Initialize the ChatYuan2 Model](https://python.langchain.com/docs/integrations/chat/yuan2/#initialize-the-chatyuan2-model)
    * [Basic Usage](https://python.langchain.com/docs/integrations/chat/yuan2/#basic-usage)
    * [Basic Usage with streaming](https://python.langchain.com/docs/integrations/chat/yuan2/#basic-usage-with-streaming)
  * [Advanced Features](https://python.langchain.com/docs/integrations/chat/yuan2/#advanced-features)
    * [Usage with async calls](https://python.langchain.com/docs/integrations/chat/yuan2/#usage-with-async-calls)
    * [Usage with prompt template](https://python.langchain.com/docs/integrations/chat/yuan2/#usage-with-prompt-template)
    * [Usage with async calls in streaming](https://python.langchain.com/docs/integrations/chat/yuan2/#usage-with-async-calls-in-streaming)
  * [Related](https://python.langchain.com/docs/integrations/chat/yuan2/#related)
