...
scraped_at: 2025-05-25T18:15:18.455267
title: Async Chromium | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/)
...
In the below example we'll use the `AsyncChromiumLoader` to loads the page, and then the [`Html2TextTransformer`](https://python.langchain.com/docs/integrations/document_transformers/html2text/) to strip out the HTML tags and other semantic information.
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/async_chromium.ipynb)
#### Was this page helpful?
[PreviousAstraDB](https://python.langchain.com/docs/integrations/document_loaders/astradb/)[NextAsyncHtml](https://python.langchain.com/docs/integrations/document_loaders/async_html/)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/#related)
