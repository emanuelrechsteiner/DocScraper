---
url: https://python.langchain.com/docs/integrations/providers/cassandra/
scraped_at: 2025-05-25T18:15:36.674664
title: Cassandra | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/cassandra/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/cassandra/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/cassandra/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/cassandra/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/cassandra/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/cassandra/)
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/cassandra/#installation-and-setup "Direct link to Installation and Setup")
Install the following Python package:
```
pip install "cassio>=0.1.6"
```

## Vector Store[​](https://python.langchain.com/docs/integrations/providers/cassandra/#vector-store "Direct link to Vector Store")
```
...
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/vectorstores/cassandra/).
## Chat message history[​](https://python.langchain.com/docs/integrations/providers/cassandra/#chat-message-history "Direct link to Chat message history")
```
...
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/memory/cassandra_chat_message_history/).
## LLM Cache[​](https://python.langchain.com/docs/integrations/providers/cassandra/#llm-cache "Direct link to LLM Cache")
```
from langchain.globalsimport set_llm_cachefrom langchain_community.cache import CassandraCacheset_llm_cache(CassandraCache())
```

**API Reference:**[set_llm_cache](https://python.langchain.com/api_reference/langchain/globals/langchain.globals.set_llm_cache.html) | [CassandraCache](https://python.langchain.com/api_reference/community/cache/langchain_community.cache.CassandraCache.html)
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/llm_caching/#cassandra-caches) (scroll to the Cassandra section).
## Semantic LLM Cache[​](https://python.langchain.com/docs/integrations/providers/cassandra/#semantic-llm-cache "Direct link to Semantic LLM Cache")
```
from langchain.globalsimport set_llm_cachefrom langchain_community.cache import CassandraSemanticCacheset_llm_cache(CassandraSemanticCache(  embedding=my_embedding,  table_name="my_store",))
```

**API Reference:**[set_llm_cache](https://python.langchain.com/api_reference/langchain/globals/langchain.globals.set_llm_cache.html) | [CassandraSemanticCache](https://python.langchain.com/api_reference/community/cache/langchain_community.cache.CassandraSemanticCache.html)
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/llm_caching/#cassandra-caches) (scroll to the appropriate section).
## Document loader[​](https://python.langchain.com/docs/integrations/providers/cassandra/#document-loader "Direct link to Document loader")
```
...
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/document_loaders/cassandra/).
#### Attribution statement[​](https://python.langchain.com/docs/integrations/providers/cassandra/#attribution-statement "Direct link to Attribution statement")
> Apache Cassandra, Cassandra and Apache are either registered trademarks or trademarks of the [Apache Software Foundation](http://www.apache.org/) in the United States and/or other countries.
## Toolkit[​](https://python.langchain.com/docs/integrations/providers/cassandra/#toolkit "Direct link to Toolkit")
...
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/tools/cassandra_database/).
Cassandra Database individual tools:
### Get Schema[​](https://python.langchain.com/docs/integrations/providers/cassandra/#get-schema "Direct link to Get Schema")
...
### Get Table Data[​](https://python.langchain.com/docs/integrations/providers/cassandra/#get-table-data "Direct link to Get Table Data")
Tool for getting data from a table in an Apache Cassandra database.
```
from langchain_community.tools import GetTableDataCassandraDatabaseTool
```

### Query[​](https://python.langchain.com/docs/integrations/providers/cassandra/#query "Direct link to Query")
...
[PreviousByteDance](https://python.langchain.com/docs/integrations/providers/byte_dance/)[NextCerebras](https://python.langchain.com/docs/integrations/providers/cerebras/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/cassandra/#installation-and-setup)
  * [Vector Store](https://python.langchain.com/docs/integrations/providers/cassandra/#vector-store)
  * [Chat message history](https://python.langchain.com/docs/integrations/providers/cassandra/#chat-message-history)
  * [LLM Cache](https://python.langchain.com/docs/integrations/providers/cassandra/#llm-cache)
  * [Semantic LLM Cache](https://python.langchain.com/docs/integrations/providers/cassandra/#semantic-llm-cache)
  * [Document loader](https://python.langchain.com/docs/integrations/providers/cassandra/#document-loader)
  * [Toolkit](https://python.langchain.com/docs/integrations/providers/cassandra/#toolkit)
    * [Get Schema](https://python.langchain.com/docs/integrations/providers/cassandra/#get-schema)
    * [Get Table Data](https://python.langchain.com/docs/integrations/providers/cassandra/#get-table-data)
    * [Query](https://python.langchain.com/docs/integrations/providers/cassandra/#query)
