...
scraped_at: 2025-05-25T18:07:56.225548
title: NonLocals — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#main-content)
Back to top `⌘`+`K`
...
# NonLocals[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#nonlocals "Link to this heading") 

_class_ langchain_core.runnables.utils.NonLocals[[source]](https://python.langchain.com/api_reference/_modules/langchain_core/runnables/utils.html#NonLocals)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals "Link to this definition")
    
Get nonlocal variables accessed.
Create a NonLocals visitor.
Methods
[`__init__`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.__init__ "langchain_core.runnables.utils.NonLocals.__init__")() | Create a NonLocals visitor.  
---|---  
[`generic_visit`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.generic_visit "langchain_core.runnables.utils.NonLocals.generic_visit")(node) | Called if no explicit visitor function exists for a node.  
[`visit`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit "langchain_core.runnables.utils.NonLocals.visit")(node) | Visit a node.  
[`visit_Attribute`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Attribute "langchain_core.runnables.utils.NonLocals.visit_Attribute")(node) | Visit an attribute node.  
[`visit_Constant`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Constant "langchain_core.runnables.utils.NonLocals.visit_Constant")(node) |   
[`visit_Name`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Name "langchain_core.runnables.utils.NonLocals.visit_Name")(node) | Visit a name node. 

__init__() → None[[source]](https://python.langchain.com/api_reference/_modules/langchain_core/runnables/utils.html#NonLocals.__init__)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.__init__ "Link to this definition")
...
generic_visit(_node_)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.generic_visit "Link to this definition")
    
Called if no explicit visitor function exists for a node. 

visit(_node_)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit "Link to this definition")
    
Visit a node. 

visit_Attribute( 
    _node :Attribute_, ) → Any[[source]](https://python.langchain.com/api_reference/_modules/langchain_core/runnables/utils.html#NonLocals.visit_Attribute)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Attribute "Link to this definition")     
...
visit_Constant(_node_)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Constant "Link to this definition")


visit_Name(_node :Name_) → Any[[source]](https://python.langchain.com/api_reference/_modules/langchain_core/runnables/utils.html#NonLocals.visit_Name)[#](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Name "Link to this definition")
...
Any
On this page 
  * [`NonLocals`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals)
    * [`__init__()`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.__init__)
    * [`generic_visit()`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.generic_visit)
    * [`visit()`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit)
    * [`visit_Attribute()`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Attribute)
    * [`visit_Constant()`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Constant)
    * [`visit_Name()`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.utils.NonLocals.html#langchain_core.runnables.utils.NonLocals.visit_Name)
