...
scraped_at: 2025-05-25T18:03:08.182948
title: AsyncHtml | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/async_html/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/async_html/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/async_html/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/async_html/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/async_html/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/async_html/)
...
```
urls =["https://www.espn.com","https://lilianweng.github.io/posts/2023-06-23-agent/"]loader = AsyncHtmlLoader(urls)# If you need to use the proxy to make web requests, for example using http_proxy/https_proxy environmental variables,# please set trust_env=True explicitly here as follows:# loader = AsyncHtmlLoader(urls, trust_env=True)# Otherwise, loader.load() may stuck becuase aiohttp session does not recognize the proxy by defaultdocs = loader.load()
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/async_html/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/async_html.ipynb)
#### Was this page helpful?
[PreviousAsync Chromium](https://python.langchain.com/docs/integrations/document_loaders/async_chromium/)[NextAthena](https://python.langchain.com/docs/integrations/document_loaders/athena/)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/async_html/#related)
