...
scraped_at: 2025-05-25T17:55:24.317062
title: MistralAI | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/mistralai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/mistralai/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/mistralai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/mistralai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/mistralai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/mistralai/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/mistralai.mdx)
# MistralAI
> [Mistral AI](https://docs.mistral.ai/api/) is a platform that offers hosting for their powerful open source models.
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/mistralai/#installation-and-setup "Direct link to Installation and Setup")
...
## Chat models[​](https://python.langchain.com/docs/integrations/providers/mistralai/#chat-models "Direct link to Chat models")
### ChatMistralAI[​](https://python.langchain.com/docs/integrations/providers/mistralai/#chatmistralai "Direct link to ChatMistralAI")
See a [usage example](https://python.langchain.com/docs/integrations/chat/mistralai/).
```
...
## Embedding models[​](https://python.langchain.com/docs/integrations/providers/mistralai/#embedding-models "Direct link to Embedding models")
### MistralAIEmbeddings[​](https://python.langchain.com/docs/integrations/providers/mistralai/#mistralaiembeddings "Direct link to MistralAIEmbeddings")
See a [usage example](https://python.langchain.com/docs/integrations/text_embedding/mistralai/).
```
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/mistralai.mdx)
#### Was this page helpful?
[PreviousMinimax](https://python.langchain.com/docs/integrations/providers/minimax/)[NextMLflow AI Gateway for LLMs](https://python.langchain.com/docs/integrations/providers/mlflow/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/mistralai/#installation-and-setup)
  * [Chat models](https://python.langchain.com/docs/integrations/providers/mistralai/#chat-models)
    * [ChatMistralAI](https://python.langchain.com/docs/integrations/providers/mistralai/#chatmistralai)
  * [Embedding models](https://python.langchain.com/docs/integrations/providers/mistralai/#embedding-models)
    * [MistralAIEmbeddings](https://python.langchain.com/docs/integrations/providers/mistralai/#mistralaiembeddings)
