...
scraped_at: 2025-05-25T18:14:24.339382
title: ChatOCIGenAI | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/)
...
## Overview[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#integration-details "Direct link to Integration details")
...
### Model features[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#model-features "Direct link to Model features")
[Tool calling](https://python.langchain.com/docs/how_to/tool_calling/)| [Structured output](https://python.langchain.com/docs/how_to/structured_output/)| [JSON mode](https://python.langchain.com/docs/how_to/structured_output/#advanced-specifying-the-method-for-structuring-outputs)| [Image input](https://python.langchain.com/docs/how_to/multimodal_inputs/)| Audio input| Video input| [Token-level streaming](https://python.langchain.com/docs/how_to/chat_streaming/)| Native async| [Token usage](https://python.langchain.com/docs/how_to/chat_token_usage_tracking/)| [Logprobs](https://python.langchain.com/docs/how_to/logprobs/)  
---|---|---|---|---|---|---|---|---|---  
✅| ✅| ✅| ✅| ❌| ❌| ✅| ❌| ❌| ❌  
## Setup[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#setup "Direct link to Setup")
To access OCIGenAI models you'll need to install the `oci` and `langchain-community` packages.
### Credentials[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#credentials "Direct link to Credentials")
...
### Installation[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#installation "Direct link to Installation")
...
## Instantiation[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#instantiation "Direct link to Instantiation")
...
## Invocation[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#invocation "Direct link to Invocation")
```
...
## Chaining[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#chaining "Direct link to Chaining")
...
## API reference[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#related "Direct link to Related")
...
[PreviousChatOCIModelDeployment](https://python.langchain.com/docs/integrations/chat/oci_data_science/)[NextChatOctoAI](https://python.langchain.com/docs/integrations/chat/octoai/)
  * [Overview](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#integration-details)
    * [Model features](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#model-features)
  * [Setup](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#instantiation)
  * [Invocation](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#invocation)
  * [Chaining](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#chaining)
  * [API reference](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/chat/oci_generative_ai/#related)
