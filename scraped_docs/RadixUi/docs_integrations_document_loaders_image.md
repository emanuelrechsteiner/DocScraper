---
url: https://python.langchain.com/docs/integrations/document_loaders/image/
scraped_at: 2025-05-25T18:08:03.234212
title: Images | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/image/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/image/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/image/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/image/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/image/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/image/)
...
### Retain Elements[​](https://python.langchain.com/docs/integrations/document_loaders/image/#retain-elements "Direct link to Retain Elements")
...
```
loader = UnstructuredImageLoader("./example_data/layout-parser-paper-screenshot.png", mode="elements")data = loader.load()data[0]
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/image/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/image.ipynb)
#### Was this page helpful?
[PreviousiFixit](https://python.langchain.com/docs/integrations/document_loaders/ifixit/)[NextImage captions](https://python.langchain.com/docs/integrations/document_loaders/image_captions/)
  * [Using Unstructured](https://python.langchain.com/docs/integrations/document_loaders/image/#using-unstructured)
    * [Retain Elements](https://python.langchain.com/docs/integrations/document_loaders/image/#retain-elements)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/image/#related)
