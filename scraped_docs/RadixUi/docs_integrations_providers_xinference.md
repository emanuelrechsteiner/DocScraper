...
scraped_at: 2025-05-25T17:59:29.292868
title: Xorbits Inference (Xinference) | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/xinference/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/xinference/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/xinference/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/xinference/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/xinference/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/xinference/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/xinference.mdx)
# Xorbits Inference (Xinference)
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/xinference/#installation-and-setup "Direct link to Installation and Setup")
Xinference can be installed via pip from PyPI:
```
pip install "xinference[all]"
```

## LLM[​](https://python.langchain.com/docs/integrations/providers/xinference/#llm "Direct link to LLM")
...
### Wrapper for Xinference[​](https://python.langchain.com/docs/integrations/providers/xinference/#wrapper-for-xinference "Direct link to Wrapper for Xinference")
...
**API Reference:**[Xinference](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.xinference.Xinference.html)
### Usage[​](https://python.langchain.com/docs/integrations/providers/xinference/#usage "Direct link to Usage")
...
### Embeddings[​](https://python.langchain.com/docs/integrations/providers/xinference/#embeddings "Direct link to Embeddings")
Xinference also supports embedding queries and documents. See [example for xinference embeddings](https://python.langchain.com/docs/integrations/text_embedding/xinference/) for a more detailed demo.
### Xinference LangChain partner package install[​](https://python.langchain.com/docs/integrations/providers/xinference/#xinference-langchain-partner-package-install "Direct link to Xinference LangChain partner package install")
Install the integration package with:
```
pip install langchain-xinference
```

## Chat Models[​](https://python.langchain.com/docs/integrations/providers/xinference/#chat-models "Direct link to Chat Models")
```
from langchain_xinference.chat_models import ChatXinference
```

## LLM[​](https://python.langchain.com/docs/integrations/providers/xinference/#llm-1 "Direct link to LLM")
```
from langchain_xinference.llms import Xinference
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/xinference.mdx)
#### Was this page helpful?
[PreviousXata](https://python.langchain.com/docs/integrations/providers/xata/)[NextYahoo](https://python.langchain.com/docs/integrations/providers/yahoo/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/xinference/#installation-and-setup)
  * [LLM](https://python.langchain.com/docs/integrations/providers/xinference/#llm)
    * [Wrapper for Xinference](https://python.langchain.com/docs/integrations/providers/xinference/#wrapper-for-xinference)
    * [Usage](https://python.langchain.com/docs/integrations/providers/xinference/#usage)
    * [Embeddings](https://python.langchain.com/docs/integrations/providers/xinference/#embeddings)
    * [Xinference LangChain partner package install](https://python.langchain.com/docs/integrations/providers/xinference/#xinference-langchain-partner-package-install)
  * [Chat Models](https://python.langchain.com/docs/integrations/providers/xinference/#chat-models)
  * [LLM](https://python.langchain.com/docs/integrations/providers/xinference/#llm-1)
