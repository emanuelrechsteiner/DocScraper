---
url: https://python.langchain.com/docs/integrations/document_loaders/langsmith/
scraped_at: 2025-05-25T18:05:06.925173
title: LangSmithLoader | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/langsmith/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/langsmith/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/langsmith/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/langsmith/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/langsmith/)
...
## Overview[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#integration-details "Direct link to Integration details")
...
### Loader features[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#loader-features "Direct link to Loader features")
Source| Lazy loading| Native async  
---|---|---  
LangSmithLoader| ✅| ❌  
## Setup[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#setup "Direct link to Setup")
...
### Credentials[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#credentials "Direct link to Credentials")
...
```
import getpassimport osifnot os.environ.get("LANGSMITH_API_KEY"):  os.environ["LANGSMITH_API_KEY"]= getpass.getpass("Enter your LangSmith API key: ")
```
...
### Installation[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#installation "Direct link to Installation")
Install `langchain-core`:
```
%pip install -qU langchain-core
```

### Clone example dataset[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#clone-example-dataset "Direct link to Clone example dataset")
...
## Initialization[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#initialization "Direct link to Initialization")
Now we can instantiate our document loader and load documents:
```
from langchain_core.document_loaders import LangSmithLoaderloader = LangSmithLoader(  dataset_name=dataset_name,  content_key="question",  limit=50,# format_content=...,# ...)
```

**API Reference:**[LangSmithLoader](https://python.langchain.com/api_reference/core/document_loaders/langchain_core.document_loaders.langsmith.LangSmithLoader.html)
## Load[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#load "Direct link to Load")
```
docs = loader.load()print(docs[0].page_content)
```
...
```
['dataset_id', 'inputs', 'outputs', 'metadata', 'id', 'created_at', 'modified_at', 'runs', 'source_run_id']
```

## Lazy Load[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#lazy-load "Direct link to Lazy Load")
```
page =[]for doc in loader.lazy_load():  page.append(doc)iflen(page)>=10:# do some paged operation, e.g.# index.upsert(page)# page = []breaklen(page)
```
...
## API reference[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/langsmith.ipynb)
#### Was this page helpful?
[PreviouslakeFS](https://python.langchain.com/docs/integrations/document_loaders/lakefs/)[NextLarkSuite (FeiShu)](https://python.langchain.com/docs/integrations/document_loaders/larksuite/)
  * [Overview](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#integration-details)
    * [Loader features](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#loader-features)
  * [Setup](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#credentials)
    * [Installation](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#installation)
    * [Clone example dataset](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#clone-example-dataset)
  * [Initialization](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#initialization)
  * [Load](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#load)
  * [Lazy Load](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#lazy-load)
  * [API reference](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/langsmith/#related)
