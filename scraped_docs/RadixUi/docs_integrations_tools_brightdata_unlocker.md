---
url: https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/
scraped_at: 2025-05-25T18:11:11.648780
title: BrightDataUnlocker | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/)
...
## Overview[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#integration-details "Direct link to Integration details")
...
### Tool features[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#tool-features "Direct link to Tool features")
Native async| Returns artifact| Return data| Pricing  
---|---|---|---  
❌| ❌| HTML, Markdown, or screenshot of web pages| Requires Bright Data account  
## Setup[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#setup "Direct link to Setup")
...
```
from langchain_brightdata import BrightDataUnlockerunlocker_tool = BrightDataUnlocker(bright_data_api_key="your-api-key")
```

## Instantiation[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#instantiation "Direct link to Instantiation")
...
## Invocation[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#invocation "Direct link to Invocation")
### Basic Usage[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#basic-usage "Direct link to Basic Usage")
```
...
### Advanced Usage with Parameters[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#advanced-usage-with-parameters "Direct link to Advanced Usage with Parameters")
```
from langchain_brightdata import BrightDataUnlockerunlocker_tool = BrightDataUnlocker(  bright_data_api_key="your-api-key",)# Access a webpage with specific parametersresult = unlocker_tool.invoke({"url":"https://example.com/region-restricted-content","country":"gb",# Access as if from Great Britain"data_format":"html",# Get content in markdown format"zone":"unlocker",# Use the unlocker zone})print(result)
```

## Customization Options[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#customization-options "Direct link to Customization Options")
...
## Data Format Options[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#data-format-options "Direct link to Data Format Options")
...
## Use within an agent[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#use-within-an-agent "Direct link to Use within an agent")
```
from langchain_brightdata import BrightDataUnlockerfrom langchain_google_genai import ChatGoogleGenerativeAIfrom langgraph.prebuilt import create_react_agent# Initialize the LLMllm = ChatGoogleGenerativeAI(model="gemini-2.0-flash", google_api_key="your-api-key")# Initialize the toolbright_data_tool = BrightDataUnlocker(bright_data_api_key="your-api-key")# Create the agentagent = create_react_agent(llm,[bright_data_tool])# Input URLs or promptuser_input ="Get the content from https://example.com/region-restricted-page - access it from GB"# Stream the agent's output step by stepfor step in agent.stream({"messages": user_input},  stream_mode="values",):  step["messages"][-1].pretty_print()
```

**API Reference:**[ChatGoogleGenerativeAI](https://python.langchain.com/api_reference/google_genai/chat_models/langchain_google_genai.chat_models.ChatGoogleGenerativeAI.html) | [create_react_agent](https://langchain-ai.github.io/langgraph/reference/prebuilt/#langgraph.prebuilt.chat_agent_executor.create_react_agent)
## API reference[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#api-reference "Direct link to API reference")
  * [Bright Data API Documentation](https://docs.brightdata.com/scraping-automation/web-unlocker/introduction)


## Related[​](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/brightdata_unlocker.ipynb)
#### Was this page helpful?
[PreviousBrightDataSERP](https://python.langchain.com/docs/integrations/tools/brightdata_serp/)[NextCassandra Database Toolkit](https://python.langchain.com/docs/integrations/tools/cassandra_database/)
  * [Overview](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#integration-details)
    * [Tool features](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#tool-features)
  * [Setup](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#setup)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#instantiation)
  * [Invocation](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#invocation)
    * [Basic Usage](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#basic-usage)
    * [Advanced Usage with Parameters](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#advanced-usage-with-parameters)
  * [Customization Options](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#customization-options)
  * [Data Format Options](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#data-format-options)
  * [Use within an agent](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#use-within-an-agent)
  * [API reference](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/brightdata_unlocker/#related)
