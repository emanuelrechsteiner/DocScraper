...
scraped_at: 2025-05-25T18:09:26.312483
title: How to use few shot examples | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/how_to/few_shot_examples/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/how_to/few_shot_examples/)
...
[v0.3](https://python.langchain.com/docs/how_to/few_shot_examples/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/how_to/few_shot_examples/)
...
This guide assumes familiarity with the following concepts:
  ...
  * [Vectorstores](https://python.langchain.com/docs/concepts/vectorstores/)
...
## Create a formatter for the few-shot examples[​](https://python.langchain.com/docs/how_to/few_shot_examples/#create-a-formatter-for-the-few-shot-examples "Direct link to Create a formatter for the few-shot examples")
...
## Creating the example set[​](https://python.langchain.com/docs/how_to/few_shot_examples/#creating-the-example-set "Direct link to Creating the example set")
...
### Pass the examples and formatter to `FewShotPromptTemplate`[​](https://python.langchain.com/docs/how_to/few_shot_examples/#pass-the-examples-and-formatter-to-fewshotprompttemplate "Direct link to pass-the-examples-and-formatter-to-fewshotprompttemplate")
...
## Using an example selector[​](https://python.langchain.com/docs/how_to/few_shot_examples/#using-an-example-selector "Direct link to Using an example selector")
...
## Next steps[​](https://python.langchain.com/docs/how_to/few_shot_examples/#next-steps "Direct link to Next steps")
...
#### Was this page helpful?
  * [Create a formatter for the few-shot examples](https://python.langchain.com/docs/how_to/few_shot_examples/#create-a-formatter-for-the-few-shot-examples)
  * [Creating the example set](https://python.langchain.com/docs/how_to/few_shot_examples/#creating-the-example-set)
    * [Pass the examples and formatter to `FewShotPromptTemplate`](https://python.langchain.com/docs/how_to/few_shot_examples/#pass-the-examples-and-formatter-to-fewshotprompttemplate)
  * [Using an example selector](https://python.langchain.com/docs/how_to/few_shot_examples/#using-an-example-selector)
  * [Next steps](https://python.langchain.com/docs/how_to/few_shot_examples/#next-steps)
