...
scraped_at: 2025-05-25T18:12:04.776049
title: Bedrock (Knowledge Bases) Retriever | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/retrievers/bedrock/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/retrievers/bedrock/)
...
[v0.3](https://python.langchain.com/docs/integrations/retrievers/bedrock/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/retrievers/bedrock/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/retrievers/bedrock/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/retrievers/bedrock/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/bedrock.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/bedrock.ipynb)
# Bedrock (Knowledge Bases) Retriever
This guide will help you getting started with the AWS Knowledge Bases [retriever](https://python.langchain.com/docs/concepts/retrievers/).
...
### Integration details[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#integration-details "Direct link to Integration details")
Retriever| Self-host| Cloud offering| Package  
---|---|---|---  
[AmazonKnowledgeBasesRetriever](https://python.langchain.com/docs/integrations/retrievers/bedrock/bedrock)| ❌| ✅| [langchain_aws](https://python.langchain.com/api_reference/aws/retrievers/langchain_aws.retrievers.bedrock.AmazonKnowledgeBasesRetriever.html)  
## Setup[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#setup "Direct link to Setup")
...
### Installation[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#installation "Direct link to Installation")
This retriever lives in the `langchain-aws` package:
```
%pip install -qU langchain-aws
```

## Instantiation[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#instantiation "Direct link to Instantiation")
...
## Usage[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#usage "Direct link to Usage")
```
query ="What did the president say about Ketanji Brown?"retriever.invoke(query)
```

## Use within a chain[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#use-within-a-chain "Direct link to Use within a chain")
```
...
## API reference[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/retrievers/bedrock/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/retrievers/bedrock.ipynb)
#### Was this page helpful?
[PreviousAzure AI Search](https://python.langchain.com/docs/integrations/retrievers/azure_ai_search/)[NextBM25](https://python.langchain.com/docs/integrations/retrievers/bm25/)
  * [Integration details](https://python.langchain.com/docs/integrations/retrievers/bedrock/#integration-details)
  * [Setup](https://python.langchain.com/docs/integrations/retrievers/bedrock/#setup)
    * [Installation](https://python.langchain.com/docs/integrations/retrievers/bedrock/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/retrievers/bedrock/#instantiation)
  * [Usage](https://python.langchain.com/docs/integrations/retrievers/bedrock/#usage)
  * [Use within a chain](https://python.langchain.com/docs/integrations/retrievers/bedrock/#use-within-a-chain)
  * [API reference](https://python.langchain.com/docs/integrations/retrievers/bedrock/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/retrievers/bedrock/#related)
