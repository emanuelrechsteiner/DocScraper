...
scraped_at: 2025-05-25T17:56:28.918270
title: Weaviate | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/weaviate/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/weaviate/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/weaviate/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/weaviate/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/weaviate/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/weaviate/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/weaviate.mdx)
# Weaviate
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/weaviate/#installation-and-setup "Direct link to Installation and Setup")
Install the Python SDK:
```
pip install langchain-weaviate
```

## Vector Store[​](https://python.langchain.com/docs/integrations/providers/weaviate/#vector-store "Direct link to Vector Store")
...
For a more detailed walkthrough of the Weaviate wrapper, see [this notebook](https://python.langchain.com/docs/integrations/vectorstores/weaviate/)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/weaviate.mdx)
#### Was this page helpful?
[PreviousWeather](https://python.langchain.com/docs/integrations/providers/weather/)[NextWhatsApp](https://python.langchain.com/docs/integrations/providers/whatsapp/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/weaviate/#installation-and-setup)
  * [Vector Store](https://python.langchain.com/docs/integrations/providers/weaviate/#vector-store)
