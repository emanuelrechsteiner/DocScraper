...
scraped_at: 2025-05-25T18:09:00.575336
title: Tavily Search | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/tavily_search/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/tavily_search/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/tavily_search/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/tavily_search/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/tavily_search/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/tavily_search/)
...
### Integration details[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#integration-details "Direct link to Integration details")
...
### Tool features[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#tool-features "Direct link to Tool features")
[Returns artifact](https://python.langchain.com/docs/how_to/tool_artifacts/)| Native async| Return data| Pricing  
---|---|---|---  
❌| ✅| title, URL, content snippet, raw_content, answer, images| 1,000 free searches / month  
## Setup[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#setup "Direct link to Setup")
The integration lives in the `langchain-tavily` package.
```
%pip install -qU langchain-tavily
```

### Credentials[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#credentials "Direct link to Credentials")
We also need to set our Tavily API key. You can get an API key by visiting [this site](https://app.tavily.com/sign-in) and creating an account.
```
import getpassimport osifnot os.environ.get("TAVILY_API_KEY"):  os.environ["TAVILY_API_KEY"]= getpass.getpass("Tavily API key:\n")
```

## Instantiation[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#instantiation "Direct link to Instantiation")
...
```
from langchain_tavily import TavilySearchtool = TavilySearch(  max_results=5,  topic="general",# include_answer=False,# include_raw_content=False,# include_images=False,# include_image_descriptions=False,# search_depth="basic",# time_range="day",# include_domains=None,# exclude_domains=None)
```

## Invocation[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#invocation "Direct link to Invocation")
### [Invoke directly with args](https://python.langchain.com/docs/concepts/tools/)[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#invoke-directly-with-args "Direct link to invoke-directly-with-args")
...
### [Invoke with ToolCall](https://python.langchain.com/docs/concepts/tools/)[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#invoke-with-toolcall "Direct link to invoke-with-toolcall")
We can also invoke the tool with a model-generated ToolCall, in which case a ToolMessage will be returned:
```
# This is usually generated by a model, but we'll create a tool call directly for demo purposes.model_generated_tool_call ={"args":{"query":"euro 2024 host nation"},"id":"1","name":"tavily","type":"tool_call",}tool_msg = tool.invoke(model_generated_tool_call)# The content is a JSON string of resultsprint(tool_msg.content[:400])
```
...
## Use within an agent[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#use-within-an-agent "Direct link to Use within an agent")
...
OpenAI▾
* [OpenAI](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Anthropic](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Azure](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Google Gemini](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Google Vertex](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [AWS](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Groq](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Cohere](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [NVIDIA](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Fireworks AI](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Mistral AI](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Together AI](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [IBM watsonx](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Databricks](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [xAI](https://python.langchain.com/docs/integrations/tools/tavily_search/)
* [Perplexity](https://python.langchain.com/docs/integrations/tools/tavily_search/)
```
...
```
ifnot os.environ.get("OPENAI_API_KEY"):  os.environ["OPENAI_API_KEY"]= getpass.getpass("OPENAI_API_KEY:\n")
```
...
```
from langchain_tavily import TavilySearchfrom langgraph.prebuilt import create_react_agent# Initialize Tavily Search Tooltavily_search_tool = TavilySearch(  max_results=5,  topic="general",)agent = create_react_agent(llm,[tavily_search_tool])user_input ="What nation hosted the Euro 2024? Include only wikipedia sources."for step in agent.stream({"messages": user_input},  stream_mode="values",):  step["messages"][-1].pretty_print()
```
...
## API reference[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/tools/tavily_search/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/tavily_search.ipynb)
#### Was this page helpful?
[PreviousTavily Extract](https://python.langchain.com/docs/integrations/tools/tavily_extract/)[NextTilores](https://python.langchain.com/docs/integrations/tools/tilores/)
  * [Overview](https://python.langchain.com/docs/integrations/tools/tavily_search/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/tools/tavily_search/#integration-details)
    * [Tool features](https://python.langchain.com/docs/integrations/tools/tavily_search/#tool-features)
  * [Setup](https://python.langchain.com/docs/integrations/tools/tavily_search/#setup)
    * [Credentials](https://python.langchain.com/docs/integrations/tools/tavily_search/#credentials)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/tavily_search/#instantiation)
  * [Invocation](https://python.langchain.com/docs/integrations/tools/tavily_search/#invocation)
    * [Invoke directly with args](https://python.langchain.com/docs/integrations/tools/tavily_search/#invoke-directly-with-args)
    * [Invoke with ToolCall](https://python.langchain.com/docs/integrations/tools/tavily_search/#invoke-with-toolcall)
  * [Use within an agent](https://python.langchain.com/docs/integrations/tools/tavily_search/#use-within-an-agent)
  * [API reference](https://python.langchain.com/docs/integrations/tools/tavily_search/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/tavily_search/#related)
