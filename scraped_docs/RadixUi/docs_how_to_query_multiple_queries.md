...
scraped_at: 2025-05-25T17:54:08.274660
title: How to handle multiple queries when doing query analysis | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/how_to/query_multiple_queries/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/how_to/query_multiple_queries/)
...
[v0.3](https://python.langchain.com/docs/how_to/query_multiple_queries/)
...
Search`⌘``K`
  ...
  * Versions
    ...
    * [v0.2](https://python.langchain.com/docs/how_to/query_multiple_queries/)
...
## Setup[​](https://python.langchain.com/docs/how_to/query_multiple_queries/#setup "Direct link to Setup")
#### Install dependencies[​](https://python.langchain.com/docs/how_to/query_multiple_queries/#install-dependencies "Direct link to Install dependencies")
```
...
#### Set environment variables[​](https://python.langchain.com/docs/how_to/query_multiple_queries/#set-environment-variables "Direct link to Set environment variables")
...
### Create Index[​](https://python.langchain.com/docs/how_to/query_multiple_queries/#create-index "Direct link to Create Index")
...
## Query analysis[​](https://python.langchain.com/docs/how_to/query_multiple_queries/#query-analysis "Direct link to Query analysis")
...
## Retrieval with query analysis[​](https://python.langchain.com/docs/how_to/query_multiple_queries/#retrieval-with-query-analysis "Direct link to Retrieval with query analysis")
...
#### Was this page helpful?
  * [Setup](https://python.langchain.com/docs/how_to/query_multiple_queries/#setup)
    * [Create Index](https://python.langchain.com/docs/how_to/query_multiple_queries/#create-index)
  * [Query analysis](https://python.langchain.com/docs/how_to/query_multiple_queries/#query-analysis)
  * [Retrieval with query analysis](https://python.langchain.com/docs/how_to/query_multiple_queries/#retrieval-with-query-analysis)
