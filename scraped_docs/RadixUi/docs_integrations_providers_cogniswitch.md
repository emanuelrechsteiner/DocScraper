---
url: https://python.langchain.com/docs/integrations/providers/cogniswitch/
scraped_at: 2025-05-25T18:09:07.989851
title: CogniSwitch | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/cogniswitch/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/cogniswitch/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/cogniswitch/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/cogniswitch/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/cogniswitch/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/cogniswitch/)
...
## Toolkit[​](https://python.langchain.com/docs/integrations/providers/cogniswitch/#toolkit "Direct link to Toolkit")
See [installation instructions and usage example](https://python.langchain.com/docs/integrations/tools/cogniswitch/).
```
...
## Tools[​](https://python.langchain.com/docs/integrations/providers/cogniswitch/#tools "Direct link to Tools")
### CogniswitchKnowledgeRequest[​](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgerequest "Direct link to CogniswitchKnowledgeRequest")
...
### CogniswitchKnowledgeSourceFile[​](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgesourcefile "Direct link to CogniswitchKnowledgeSourceFile")
...
### CogniswitchKnowledgeSourceURL[​](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgesourceurl "Direct link to CogniswitchKnowledgeSourceURL")
...
### CogniswitchKnowledgeStatus[​](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgestatus "Direct link to CogniswitchKnowledgeStatus")
...
[PreviousCognee](https://python.langchain.com/docs/integrations/providers/cognee/)[NextCohere](https://python.langchain.com/docs/integrations/providers/cohere/)
  * [Toolkit](https://python.langchain.com/docs/integrations/providers/cogniswitch/#toolkit)
  * [Tools](https://python.langchain.com/docs/integrations/providers/cogniswitch/#tools)
    * [CogniswitchKnowledgeRequest](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgerequest)
    * [CogniswitchKnowledgeSourceFile](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgesourcefile)
    * [CogniswitchKnowledgeSourceURL](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgesourceurl)
    * [CogniswitchKnowledgeStatus](https://python.langchain.com/docs/integrations/providers/cogniswitch/#cogniswitchknowledgestatus)
