...
scraped_at: 2025-05-25T17:57:48.474003
title: RePhraseQuery | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/retrievers/re_phrase/)
...
[v0.3](https://python.langchain.com/docs/integrations/retrievers/re_phrase/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/retrievers/re_phrase/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/retrievers/re_phrase/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/retrievers/re_phrase/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/re_phrase.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/retrievers/re_phrase.ipynb)
# RePhraseQuery
...
## Example[​](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#example "Direct link to Example")
### Setting up[​](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#setting-up "Direct link to Setting up")
...
### Using the default prompt[​](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#using-the-default-prompt "Direct link to Using the default prompt")
...
### Custom prompt[​](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#custom-prompt "Direct link to Custom prompt")
```
...
## Related[​](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/retrievers/re_phrase.ipynb)
#### Was this page helpful?
[PreviousRAGatouille](https://python.langchain.com/docs/integrations/retrievers/ragatouille/)[NextRememberizer](https://python.langchain.com/docs/integrations/retrievers/rememberizer/)
  * [Example](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#example)
    * [Setting up](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#setting-up)
    * [Using the default prompt](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#using-the-default-prompt)
    * [Custom prompt](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#custom-prompt)
  * [Related](https://python.langchain.com/docs/integrations/retrievers/re_phrase/#related)
