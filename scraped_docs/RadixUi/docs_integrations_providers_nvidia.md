...
scraped_at: 2025-05-25T18:15:40.219124
title: NVIDIA | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/nvidia/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/nvidia/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/nvidia/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/nvidia/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/nvidia/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/nvidia/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/nvidia.mdx)
# NVIDIA
...
## Installation[​](https://python.langchain.com/docs/integrations/providers/nvidia/#installation "Direct link to Installation")
```
pip install -U --quiet langchain-nvidia-ai-endpoints
```

## Setup[​](https://python.langchain.com/docs/integrations/providers/nvidia/#setup "Direct link to Setup")
**To get started:**
...
```
import getpassimport osifnot os.environ.get("NVIDIA_API_KEY","").startswith("nvapi-"):  nvidia_api_key = getpass.getpass("Enter your NVIDIA API key: ")assert nvidia_api_key.startswith("nvapi-"),f"{nvidia_api_key[:5]}... is not a valid key"  os.environ["NVIDIA_API_KEY"]= nvidia_api_key
```

## Working with NVIDIA API Catalog[​](https://python.langchain.com/docs/integrations/providers/nvidia/#working-with-nvidia-api-catalog "Direct link to Working with NVIDIA API Catalog")
```
...
**API Reference:**[ChatNVIDIA](https://python.langchain.com/api_reference/nvidia_ai_endpoints/chat_models/langchain_nvidia_ai_endpoints.chat_models.ChatNVIDIA.html)
Using the API, you can query live endpoints available on the NVIDIA API Catalog to get quick results from a DGX-hosted cloud compute environment. All models are source-accessible and can be deployed on your own compute cluster using NVIDIA NIM which is part of NVIDIA AI Enterprise, shown in the next section [Working with NVIDIA NIMs](https://python.langchain.com/docs/integrations/providers/nvidia/#working-with-nvidia-nims).
## Working with NVIDIA NIMs[​](https://python.langchain.com/docs/integrations/providers/nvidia/#working-with-nvidia-nims "Direct link to Working with NVIDIA NIMs")
When ready to deploy, you can self-host models with NVIDIA NIM—which is included with the NVIDIA AI Enterprise software license—and run them anywhere, giving you ownership of your customizations and full control of your intellectual property (IP) and AI applications.
[Learn more about NIMs](https://developer.nvidia.com/blog/nvidia-nim-offers-optimized-inference-microservices-for-deploying-ai-models-at-scale/)
```
from langchain_nvidia_ai_endpoints import ChatNVIDIA, NVIDIAEmbeddings, NVIDIARerank# connect to a chat NIM running at localhost:8000, specifying a modelllm = ChatNVIDIA(base_url="http://localhost:8000/v1", model="meta/llama3-8b-instruct")# connect to an embedding NIM running at localhost:8080embedder = NVIDIAEmbeddings(base_url="http://localhost:8080/v1")# connect to a reranking NIM running at localhost:2016ranker = NVIDIARerank(base_url="http://localhost:2016/v1")
```

**API Reference:**[ChatNVIDIA](https://python.langchain.com/api_reference/nvidia_ai_endpoints/chat_models/langchain_nvidia_ai_endpoints.chat_models.ChatNVIDIA.html) | [NVIDIAEmbeddings](https://python.langchain.com/api_reference/nvidia_ai_endpoints/embeddings/langchain_nvidia_ai_endpoints.embeddings.NVIDIAEmbeddings.html) | [NVIDIARerank](https://python.langchain.com/api_reference/nvidia_ai_endpoints/reranking/langchain_nvidia_ai_endpoints.reranking.NVIDIARerank.html)
## Using NVIDIA AI Foundation Endpoints[​](https://python.langchain.com/docs/integrations/providers/nvidia/#using-nvidia-ai-foundation-endpoints "Direct link to Using NVIDIA AI Foundation Endpoints")
...
**The following may be useful examples to help you get started:**
  * **[`ChatNVIDIA`Model](https://python.langchain.com/docs/integrations/chat/nvidia_ai_endpoints/).**
  * **[`NVIDIAEmbeddings`Model for RAG Workflows](https://python.langchain.com/docs/integrations/text_embedding/nvidia_ai_endpoints/).**


[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/nvidia.mdx)
#### Was this page helpful?
[PreviousNuclia](https://python.langchain.com/docs/integrations/providers/nuclia/)[NextObsidian](https://python.langchain.com/docs/integrations/providers/obsidian/)
  * [Installation](https://python.langchain.com/docs/integrations/providers/nvidia/#installation)
  * [Setup](https://python.langchain.com/docs/integrations/providers/nvidia/#setup)
  * [Working with NVIDIA API Catalog](https://python.langchain.com/docs/integrations/providers/nvidia/#working-with-nvidia-api-catalog)
  * [Working with NVIDIA NIMs](https://python.langchain.com/docs/integrations/providers/nvidia/#working-with-nvidia-nims)
  * [Using NVIDIA AI Foundation Endpoints](https://python.langchain.com/docs/integrations/providers/nvidia/#using-nvidia-ai-foundation-endpoints)
