...
scraped_at: 2025-05-25T18:04:59.651635
title: Geopandas | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/geopandas/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/geopandas/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/geopandas/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/geopandas/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/geopandas/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/geopandas/)
...
```
%pip install --upgrade --quiet sodapy%pip install --upgrade --quiet pandas%pip install --upgrade --quiet geopandas
```

```
import astimport geopandas as gpdimport pandas as pdfrom langchain_community.document_loaders import OpenCityDataLoader
```
...
```
from langchain_community.document_loaders import GeoDataFrameLoaderloader = GeoDataFrameLoader(data_frame=gdf, page_content_column="geometry")docs = loader.load()
```

**API Reference:**[GeoDataFrameLoader](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.geodataframe.GeoDataFrameLoader.html)
```
docs[0]
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/geopandas/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/geopandas.ipynb)
#### Was this page helpful?
[PreviousFireCrawl](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/)[NextGit](https://python.langchain.com/docs/integrations/document_loaders/git/)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/geopandas/#related)
