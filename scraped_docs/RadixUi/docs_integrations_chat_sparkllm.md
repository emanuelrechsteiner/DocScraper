---
url: https://python.langchain.com/docs/integrations/chat/sparkllm/
scraped_at: 2025-05-25T18:09:51.270638
title: SparkLLM Chat | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/chat/sparkllm/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/chat/sparkllm/)
...
[v0.3](https://python.langchain.com/docs/integrations/chat/sparkllm/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/chat/sparkllm/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/chat/sparkllm/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/chat/sparkllm/)
...
## Basic use[​](https://python.langchain.com/docs/integrations/chat/sparkllm/#basic-use "Direct link to Basic use")
```
...
## For ChatSparkLLM with Streaming[​](https://python.langchain.com/docs/integrations/chat/sparkllm/#for-chatsparkllm-with-streaming "Direct link to For ChatSparkLLM with Streaming")
```
...
## For v2[​](https://python.langchain.com/docs/integrations/chat/sparkllm/#for-v2 "Direct link to For v2")
```
...
**API Reference:**[ChatSparkLLM](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.sparkllm.ChatSparkLLM.html) | [HumanMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessage.html)
## Related[​](https://python.langchain.com/docs/integrations/chat/sparkllm/#related "Direct link to Related")
...
[Previoussolar](https://python.langchain.com/docs/integrations/chat/solar/)[NextNebula (Symbl.ai)](https://python.langchain.com/docs/integrations/chat/symblai_nebula/)
  * [Basic use](https://python.langchain.com/docs/integrations/chat/sparkllm/#basic-use)
  * [For ChatSparkLLM with Streaming](https://python.langchain.com/docs/integrations/chat/sparkllm/#for-chatsparkllm-with-streaming)
  * [For v2](https://python.langchain.com/docs/integrations/chat/sparkllm/#for-v2)
  * [Related](https://python.langchain.com/docs/integrations/chat/sparkllm/#related)
