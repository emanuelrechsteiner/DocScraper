...
scraped_at: 2025-05-25T18:05:14.001021
title: ScalaSegmenter — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#main-content)
Back to top `⌘`+`K`
...
# ScalaSegmenter[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#scalasegmenter "Link to this heading") 

_class_ langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter(_code :str_)[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/scala.html#ScalaSegmenter)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter "Link to this definition")
    
Code segmenter for Scala.
Methods
[`__init__`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.__init__ "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.__init__")(code) |   
---|---  
[`extract_functions_classes`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.extract_functions_classes "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.extract_functions_classes")() |   
[`get_chunk_query`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_chunk_query "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_chunk_query")() |   
[`get_language`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_language "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_language")() |   
[`get_parser`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_parser "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_parser")() |   
[`is_valid`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.is_valid "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.is_valid")() |   
[`make_line_comment`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.make_line_comment "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.make_line_comment")(text) |   
[`simplify_code`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.simplify_code "langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.simplify_code")() |  

Parameters:
      
**code** (_str_) 

__init__(_code :str_)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.__init__ "Link to this definition")
...
get_chunk_query() → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/scala.html#ScalaSegmenter.get_chunk_query)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_chunk_query "Link to this definition")
...
get_language() → [Language](https://python.langchain.com/api_reference/text_splitters/base/langchain_text_splitters.base.Language.html#langchain_text_splitters.base.Language "langchain_text_splitters.base.Language")[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/scala.html#ScalaSegmenter.get_language)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_language "Link to this definition")
...
get_parser() → Parser[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_parser "Link to this definition")
...
is_valid() → bool[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.is_valid "Link to this definition")
...
make_line_comment(_text :str_) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/parsers/language/scala.html#ScalaSegmenter.make_line_comment)[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.make_line_comment "Link to this definition")
...
simplify_code() → str[#](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.simplify_code "Link to this definition")
...
str
On this page 
  * [`ScalaSegmenter`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter)
    * [`__init__()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.__init__)
    * [`extract_functions_classes()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.extract_functions_classes)
    * [`get_chunk_query()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_chunk_query)
    * [`get_language()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_language)
    * [`get_parser()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.get_parser)
    * [`is_valid()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.is_valid)
    * [`make_line_comment()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.make_line_comment)
    * [`simplify_code()`](https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.html#langchain_community.document_loaders.parsers.language.scala.ScalaSegmenter.simplify_code)
