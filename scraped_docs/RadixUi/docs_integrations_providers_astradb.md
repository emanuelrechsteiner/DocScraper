...
scraped_at: 2025-05-25T18:02:23.848994
title: Astra DB | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/astradb/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/astradb/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/astradb/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/astradb/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/astradb/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/astradb/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/astradb.mdx)
# Astra DB
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/astradb/#installation-and-setup "Direct link to Installation and Setup")
...
## Vector Store[​](https://python.langchain.com/docs/integrations/providers/astradb/#vector-store "Direct link to Vector Store")
...
## Chat message history[​](https://python.langchain.com/docs/integrations/providers/astradb/#chat-message-history "Direct link to Chat message history")
```
...
## LLM Cache[​](https://python.langchain.com/docs/integrations/providers/astradb/#llm-cache "Direct link to LLM Cache")
```
from langchain.globalsimport set_llm_cachefrom langchain_astradb import AstraDBCacheset_llm_cache(AstraDBCache(  api_endpoint=ASTRA_DB_API_ENDPOINT,  token=ASTRA_DB_APPLICATION_TOKEN,))
```

**API Reference:**[set_llm_cache](https://python.langchain.com/api_reference/langchain/globals/langchain.globals.set_llm_cache.html) | [AstraDBCache](https://python.langchain.com/api_reference/astradb/cache/langchain_astradb.cache.AstraDBCache.html)
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/llm_caching/#astra-db-caches) (scroll to the Astra DB section).
## Semantic LLM Cache[​](https://python.langchain.com/docs/integrations/providers/astradb/#semantic-llm-cache "Direct link to Semantic LLM Cache")
```
from langchain.globalsimport set_llm_cachefrom langchain_astradb import AstraDBSemanticCacheset_llm_cache(AstraDBSemanticCache(  embedding=my_embedding,  api_endpoint=ASTRA_DB_API_ENDPOINT,  token=ASTRA_DB_APPLICATION_TOKEN,))
```

**API Reference:**[set_llm_cache](https://python.langchain.com/api_reference/langchain/globals/langchain.globals.set_llm_cache.html) | [AstraDBSemanticCache](https://python.langchain.com/api_reference/astradb/cache/langchain_astradb.cache.AstraDBSemanticCache.html)
Learn more in the [example notebook](https://python.langchain.com/docs/integrations/llm_caching/#astra-db-caches) (scroll to the appropriate section).
## Document loader[​](https://python.langchain.com/docs/integrations/providers/astradb/#document-loader "Direct link to Document loader")
```
...
## Self-querying retriever[​](https://python.langchain.com/docs/integrations/providers/astradb/#self-querying-retriever "Direct link to Self-querying retriever")
```
...
## Store[​](https://python.langchain.com/docs/integrations/providers/astradb/#store "Direct link to Store")
```
...
## Byte Store[​](https://python.langchain.com/docs/integrations/providers/astradb/#byte-store "Direct link to Byte Store")
```
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/astradb.mdx)
#### Was this page helpful?
[PreviousAssemblyAI](https://python.langchain.com/docs/integrations/providers/assemblyai/)[NextAtlas](https://python.langchain.com/docs/integrations/providers/atlas/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/astradb/#installation-and-setup)
  * [Vector Store](https://python.langchain.com/docs/integrations/providers/astradb/#vector-store)
  * [Chat message history](https://python.langchain.com/docs/integrations/providers/astradb/#chat-message-history)
  * [LLM Cache](https://python.langchain.com/docs/integrations/providers/astradb/#llm-cache)
  * [Semantic LLM Cache](https://python.langchain.com/docs/integrations/providers/astradb/#semantic-llm-cache)
  * [Document loader](https://python.langchain.com/docs/integrations/providers/astradb/#document-loader)
  * [Self-querying retriever](https://python.langchain.com/docs/integrations/providers/astradb/#self-querying-retriever)
  * [Store](https://python.langchain.com/docs/integrations/providers/astradb/#store)
  * [Byte Store](https://python.langchain.com/docs/integrations/providers/astradb/#byte-store)
