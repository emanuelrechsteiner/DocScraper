...
scraped_at: 2025-05-25T18:00:13.028112
title: Lindorm | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/lindorm/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/lindorm/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/lindorm/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/lindorm/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/lindorm/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/lindorm/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/lindorm.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/lindorm.ipynb)
# Lindorm
...
## Embeddings[​](https://python.langchain.com/docs/integrations/providers/lindorm/#embeddings "Direct link to Embeddings")
...
## Rerank[​](https://python.langchain.com/docs/integrations/providers/lindorm/#rerank "Direct link to Rerank")
The Lindorm AI Service also supports reranking.
```
from langchain_lindorm_integration.reranker import LindormAIRerank
```

## Vector Store[​](https://python.langchain.com/docs/integrations/providers/lindorm/#vector-store "Direct link to Vector Store")
Lindorm also supports vector store.
```
from langchain_lindorm_integration import LindormVectorStore
```

## ByteStore[​](https://python.langchain.com/docs/integrations/providers/lindorm/#bytestore "Direct link to ByteStore")
Use ByteStore from Lindorm
```
from langchain_lindorm_integration import LindormByteStore
```

[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/lindorm.ipynb)
#### Was this page helpful?
[PreviousLantern](https://python.langchain.com/docs/integrations/providers/lantern/)[NextLinkup](https://python.langchain.com/docs/integrations/providers/linkup/)
  * [Embeddings](https://python.langchain.com/docs/integrations/providers/lindorm/#embeddings)
  * [Rerank](https://python.langchain.com/docs/integrations/providers/lindorm/#rerank)
  * [Vector Store](https://python.langchain.com/docs/integrations/providers/lindorm/#vector-store)
  * [ByteStore](https://python.langchain.com/docs/integrations/providers/lindorm/#bytestore)
