...
scraped_at: 2025-05-25T18:14:06.916694
title: FireCrawl | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/)
...
## Overview[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#overview "Direct link to Overview")
### Integration details[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#integration-details "Direct link to Integration details")
...
### Loader features[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#loader-features "Direct link to Loader features")
Source| Document Lazy Loading| Native Async Support  
---|---|---  
FireCrawlLoader| ✅| ❌  
## Setup[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#setup "Direct link to Setup")
```
pip install firecrawl-py
```

## Usage[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#usage "Direct link to Usage")
...
```
loader = FireCrawlLoader(  api_key="YOUR_API_KEY", url="https://firecrawl.dev", mode="scrape")
```
...
```
pages =[]for doc in loader.lazy_load():  pages.append(doc)iflen(pages)>=10:# do some paged operation, e.g.# index.upsert(page)    pages =[]
```
...
## Modes[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#modes "Direct link to Modes")
...
### Crawl[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#crawl "Direct link to Crawl")
```
...
```
print(pages[0].page_content[:100])print(pages[0].metadata)
```

#### Crawl Options[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#crawl-options "Direct link to Crawl Options")
...
### Map[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#map "Direct link to Map")
```
...
#### Map Options[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#map-options "Direct link to Map Options")
...
## API reference[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#related "Direct link to Related")
...
[PreviousFigma](https://python.langchain.com/docs/integrations/document_loaders/figma/)[NextGeopandas](https://python.langchain.com/docs/integrations/document_loaders/geopandas/)
  * [Overview](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#overview)
    * [Integration details](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#integration-details)
    * [Loader features](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#loader-features)
  * [Setup](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#setup)
  * [Usage](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#usage)
  * [Modes](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#modes)
    * [Crawl](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#crawl)
    * [Map](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#map)
  * [API reference](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/#related)
