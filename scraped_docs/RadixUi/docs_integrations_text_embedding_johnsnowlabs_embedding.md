...
scraped_at: 2025-05-25T18:04:02.747633
title: John Snow Labs | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/)
...
[v0.3](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/)
...
On this page
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/johnsnowlabs_embedding.ipynb)[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/text_embedding/johnsnowlabs_embedding.ipynb)
# John Snow Labs
...
> Models are loaded with [nlp.load](https://nlp.johnsnowlabs.com/docs/en/jsl/load_api) and spark session is started >with [nlp.start()](https://nlp.johnsnowlabs.com/docs/en/jsl/start-a-sparksession) under the hood. For all 24.000+ models, see the [John Snow Labs Model Models Hub](https://nlp.johnsnowlabs.com/models)
## Setting up[​](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#setting-up "Direct link to Setting up")
```
...
## Example[​](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#example "Direct link to Example")
```
...
```
embeddings = embedder.embed_documents(texts)for i, embedding inenumerate(embeddings):print(f"Embedding for document {i+1}: {embedding}")
```
...
## Related[​](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/text_embedding/johnsnowlabs_embedding.ipynb)
#### Was this page helpful?
[PreviousJina](https://python.langchain.com/docs/integrations/text_embedding/jina/)[NextLASER Language-Agnostic SEntence Representations Embeddings by Meta AI](https://python.langchain.com/docs/integrations/text_embedding/laser/)
  * [Setting up](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#setting-up)
  * [Example](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#example)
  * [Related](https://python.langchain.com/docs/integrations/text_embedding/johnsnowlabs_embedding/#related)
