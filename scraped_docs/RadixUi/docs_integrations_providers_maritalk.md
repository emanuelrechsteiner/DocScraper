---
url: https://python.langchain.com/docs/integrations/providers/maritalk/
scraped_at: 2025-05-25T18:01:32.480304
title: MariTalk | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/maritalk/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/maritalk/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/maritalk/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/maritalk/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/maritalk/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/maritalk/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/maritalk.mdx)
# MariTalk
> [MariTalk](https://www.maritaca.ai/en) is an LLM-based chatbot trained to meet the needs of Brazil.
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/maritalk/#installation-and-setup "Direct link to Installation and Setup")
...
## Chat models[​](https://python.langchain.com/docs/integrations/providers/maritalk/#chat-models "Direct link to Chat models")
See a [usage example](https://python.langchain.com/docs/integrations/chat/maritalk/).
```
from langchain_community.chat_models import ChatMaritalk
```

**API Reference:**[ChatMaritalk](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.maritalk.ChatMaritalk.html)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/maritalk.mdx)
#### Was this page helpful?
[PreviousMariaDB](https://python.langchain.com/docs/integrations/providers/mariadb/)[NextMarqo](https://python.langchain.com/docs/integrations/providers/marqo/)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/maritalk/#installation-and-setup)
  * [Chat models](https://python.langchain.com/docs/integrations/providers/maritalk/#chat-models)
