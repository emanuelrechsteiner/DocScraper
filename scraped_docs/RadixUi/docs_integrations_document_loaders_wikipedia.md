---
url: https://python.langchain.com/docs/integrations/document_loaders/wikipedia
scraped_at: 2025-05-25T18:14:35.126629
title: Wikipedia | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/)
...
## Installation[​](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#installation "Direct link to Installation")
First, you need to install the `langchain_community` and `wikipedia` packages.
```
%pip install -qU langchain_community wikipedia
```

## Parameters[​](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#parameters "Direct link to Parameters")
...
## Example[​](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#example "Direct link to Example")
```
...
## Related[​](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/wikipedia.ipynb)
#### Was this page helpful?
[PreviousWhatsApp Chat](https://python.langchain.com/docs/integrations/document_loaders/whatsapp_chat/)[NextUnstructuredXMLLoader](https://python.langchain.com/docs/integrations/document_loaders/xml/)
  * [Installation](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#installation)
  * [Parameters](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#parameters)
  * [Example](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#example)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/wikipedia/#related)
