---
url: https://python.langchain.com/docs/integrations/tools/gmail/
scraped_at: 2025-05-25T18:13:05.280451
title: Gmail Toolkit | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/gmail/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/gmail/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/gmail/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/gmail/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/gmail/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/gmail/)
...
### Installation[​](https://python.langchain.com/docs/integrations/tools/gmail/#installation "Direct link to Installation")
...
## Instantiation[​](https://python.langchain.com/docs/integrations/tools/gmail/#instantiation "Direct link to Instantiation")
...
### Customizing Authentication[​](https://python.langchain.com/docs/integrations/tools/gmail/#customizing-authentication "Direct link to Customizing Authentication")
...
**API Reference:**[build_resource_service](https://python.langchain.com/api_reference/google_community/gmail/langchain_google_community.gmail.utils.build_resource_service.html) | [get_gmail_credentials](https://python.langchain.com/api_reference/google_community/gmail/langchain_google_community.gmail.utils.get_gmail_credentials.html)
## Tools[​](https://python.langchain.com/docs/integrations/tools/gmail/#tools "Direct link to Tools")
...
## Use within an agent[​](https://python.langchain.com/docs/integrations/tools/gmail/#use-within-an-agent "Direct link to Use within an agent")
Below we show how to incorporate the toolkit into an [agent](https://python.langchain.com/docs/tutorials/agents/).
We will need a LLM or chat model:
Select [chat model](https://python.langchain.com/docs/integrations/chat/):
OpenAI▾
* [OpenAI](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Anthropic](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Azure](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Google Gemini](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Google Vertex](https://python.langchain.com/docs/integrations/tools/gmail/)
* [AWS](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Groq](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Cohere](https://python.langchain.com/docs/integrations/tools/gmail/)
* [NVIDIA](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Fireworks AI](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Mistral AI](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Together AI](https://python.langchain.com/docs/integrations/tools/gmail/)
* [IBM watsonx](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Databricks](https://python.langchain.com/docs/integrations/tools/gmail/)
* [xAI](https://python.langchain.com/docs/integrations/tools/gmail/)
* [Perplexity](https://python.langchain.com/docs/integrations/tools/gmail/)
```
...
## API reference[​](https://python.langchain.com/docs/integrations/tools/gmail/#api-reference "Direct link to API reference")
...
## Related[​](https://python.langchain.com/docs/integrations/tools/gmail/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/gmail.ipynb)
#### Was this page helpful?
[PreviousGitlab Toolkit](https://python.langchain.com/docs/integrations/tools/gitlab/)[NextGOAT](https://python.langchain.com/docs/integrations/tools/goat/)
  * [Setup](https://python.langchain.com/docs/integrations/tools/gmail/#setup)
    * [Installation](https://python.langchain.com/docs/integrations/tools/gmail/#installation)
  * [Instantiation](https://python.langchain.com/docs/integrations/tools/gmail/#instantiation)
    * [Customizing Authentication](https://python.langchain.com/docs/integrations/tools/gmail/#customizing-authentication)
  * [Tools](https://python.langchain.com/docs/integrations/tools/gmail/#tools)
  * [Use within an agent](https://python.langchain.com/docs/integrations/tools/gmail/#use-within-an-agent)
  * [API reference](https://python.langchain.com/docs/integrations/tools/gmail/#api-reference)
  * [Related](https://python.langchain.com/docs/integrations/tools/gmail/#related)
