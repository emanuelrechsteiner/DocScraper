---
url: https://python.langchain.com/docs/integrations/tools/office365/
scraped_at: 2025-05-25T18:01:10.265961
title: Office365 Toolkit | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/tools/office365/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/tools/office365/)
...
[v0.3](https://python.langchain.com/docs/integrations/tools/office365/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/tools/office365/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/tools/office365/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/tools/office365/)
...
```
%pip install --upgrade --quiet O365%pip install --upgrade --quiet beautifulsoup4 # This is optional but is useful for parsing HTML messages%pip install -qU langchain-community
```

## Assign Environmental Variables[​](https://python.langchain.com/docs/integrations/tools/office365/#assign-environmental-variables "Direct link to Assign Environmental Variables")
...
## Related[​](https://python.langchain.com/docs/integrations/tools/office365/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/office365.ipynb)
#### Was this page helpful?
[PreviousNVIDIA Riva: ASR and TTS](https://python.langchain.com/docs/integrations/tools/nvidia_riva/)[NextOpenAPI Toolkit](https://python.langchain.com/docs/integrations/tools/openapi/)
  * [Assign Environmental Variables](https://python.langchain.com/docs/integrations/tools/office365/#assign-environmental-variables)
  * [Create the Toolkit and Get Tools](https://python.langchain.com/docs/integrations/tools/office365/#create-the-toolkit-and-get-tools)
  * [Use within an Agent](https://python.langchain.com/docs/integrations/tools/office365/#use-within-an-agent)
  * [Related](https://python.langchain.com/docs/integrations/tools/office365/#related)
