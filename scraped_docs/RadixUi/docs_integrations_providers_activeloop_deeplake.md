...
scraped_at: 2025-05-25T17:59:21.616879
title: Activeloop Deep Lake | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/activeloop_deeplake.mdx)
# Activeloop Deep Lake
> [Activeloop Deep Lake](https://docs.activeloop.ai/) is a data lake for Deep Learning applications, allowing you to use it as a vector store.
## Why Deep Lake?[​](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#why-deep-lake "Direct link to Why Deep Lake?")
  * More than just a (multi-modal) vector store. You can later use the dataset to fine-tune your own LLM models.
  * Not only stores embeddings, but also the original data with automatic version control.
  * Truly serverless. Doesn't require another service and can be used with major cloud providers (`AWS S3`, `GCS`, etc.)


`Activeloop Deep Lake` supports `SelfQuery Retrieval`: [Activeloop Deep Lake Self Query Retrieval](https://python.langchain.com/docs/integrations/retrievers/self_query/activeloop_deeplake_self_query/)
## More Resources[​](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#more-resources "Direct link to More Resources")
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#installation-and-setup "Direct link to Installation and Setup")
Install the Python package:
```
pip install deeplake
```

## VectorStore[​](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#vectorstore "Direct link to VectorStore")
```
from langchain_community.vectorstores import DeepLake
```

**API Reference:**[DeepLake](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.deeplake.DeepLake.html)
See a [usage example](https://python.langchain.com/docs/integrations/vectorstores/activeloop_deeplake/).
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/activeloop_deeplake.mdx)
#### Was this page helpful?
[PreviousAcreom](https://python.langchain.com/docs/integrations/providers/acreom/)[NextADS4GPTs](https://python.langchain.com/docs/integrations/providers/ads4gpts/)
  * [Why Deep Lake?](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#why-deep-lake)
  * [More Resources](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#more-resources)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#installation-and-setup)
  * [VectorStore](https://python.langchain.com/docs/integrations/providers/activeloop_deeplake/#vectorstore)
