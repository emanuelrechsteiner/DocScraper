...
scraped_at: 2025-05-25T17:59:36.486319
title: MyScale | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/providers/myscale/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/providers/myscale/)
...
[v0.3](https://python.langchain.com/docs/integrations/providers/myscale/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/providers/myscale/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/providers/myscale/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/providers/myscale/)
...
On this page
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github&logoColor=white)](https://github.com/langchain-ai/langchain/blob/master/docs/docs/integrations/providers/myscale.mdx)
# MyScale
...
## Introduction[​](https://python.langchain.com/docs/integrations/providers/myscale/#introduction "Direct link to Introduction")
...
## Installation and Setup[​](https://python.langchain.com/docs/integrations/providers/myscale/#installation-and-setup "Direct link to Installation and Setup")
  * Install the Python SDK with `pip install clickhouse-connect`


### Setting up environments[​](https://python.langchain.com/docs/integrations/providers/myscale/#setting-up-environments "Direct link to Setting up environments")
...
```
from langchain_community.vectorstores import MyScale, MyScaleSettingsconfig = MyScaleSettings(host="<your-backend-url>", port=8443,...)index = MyScale(embedding_function, config)index.add_documents(...)
```



## Wrappers[​](https://python.langchain.com/docs/integrations/providers/myscale/#wrappers "Direct link to Wrappers")
supported functions:
  * `add_texts`
  * `add_documents`
  * `from_texts`
...
### VectorStore[​](https://python.langchain.com/docs/integrations/providers/myscale/#vectorstore "Direct link to VectorStore")
...
**API Reference:**[MyScale](https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.myscale.MyScale.html)
For a more detailed walkthrough of the MyScale wrapper, see [this notebook](https://python.langchain.com/docs/integrations/vectorstores/myscale/)
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/providers/myscale.mdx)
#### Was this page helpful?
[PreviousMotörhead](https://python.langchain.com/docs/integrations/providers/motorhead/)[NextNAVER](https://python.langchain.com/docs/integrations/providers/naver/)
  * [Introduction](https://python.langchain.com/docs/integrations/providers/myscale/#introduction)
  * [Installation and Setup](https://python.langchain.com/docs/integrations/providers/myscale/#installation-and-setup)
    * [Setting up environments](https://python.langchain.com/docs/integrations/providers/myscale/#setting-up-environments)
  * [Wrappers](https://python.langchain.com/docs/integrations/providers/myscale/#wrappers)
    * [VectorStore](https://python.langchain.com/docs/integrations/providers/myscale/#vectorstore)
