---
url: https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis
scraped_at: 2025-05-25T18:11:29.455031
title: Google Memorystore for Redis | 🦜️🔗 LangChain
---

[Skip to main content](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#__docusaurus_skipToContent_fallback)
...
[More](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/)
...
[v0.3](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/)
...
Search`⌘``K`
  ...
  * [Components](https://python.langchain.com/docs/integrations/components/)
    ...
    * [Document loaders](https://python.langchain.com/docs/integrations/document_loaders/)
      ...
      * [example_data](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/)
      ...
      * [parsers](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/)
    ...
    * [Other](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/)
...
This notebook goes over how to use [Memorystore for Redis](https://cloud.google.com/memorystore/docs/redis/memorystore-for-redis-overview) to [save, load and delete langchain documents](https://python.langchain.com/docs/how_to/#document-loaders) with `MemorystoreDocumentLoader` and `MemorystoreDocumentSaver`.
...
## Before You Begin[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#before-you-begin "Direct link to Before You Begin")
...
```
# @markdown Please specify an endpoint associated with the instance and a key prefix for demo purpose.ENDPOINT ="redis://127.0.0.1:6379"# @param {type:"string"}KEY_PREFIX ="doc:"# @param {type:"string"}
```

### 🦜🔗 Library Installation[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#-library-installation "Direct link to 🦜🔗 Library Installation")
...
### ☁ Set Your Google Cloud Project[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#-set-your-google-cloud-project "Direct link to ☁ Set Your Google Cloud Project")
...
### 🔐 Authentication[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#-authentication "Direct link to 🔐 Authentication")
...
## Basic Usage[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#basic-usage "Direct link to Basic Usage")
### Save documents[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#save-documents "Direct link to Save documents")
...
```
import redisfrom langchain_core.documents import Documentfrom langchain_google_memorystore_redis import MemorystoreDocumentSavertest_docs =[  Document(    page_content="Apple Granny Smith 150 0.99 1",    metadata={"fruit_id":1},),  Document(    page_content="Banana Cavendish 200 0.59 0",    metadata={"fruit_id":2},),  Document(    page_content="Orange Navel 80 1.29 1",    metadata={"fruit_id":3},),]doc_ids =[f"{i}"for i inrange(len(test_docs))]redis_client = redis.from_url(ENDPOINT)saver = MemorystoreDocumentSaver(  client=redis_client,  key_prefix=KEY_PREFIX,  content_field="page_content",)saver.add_documents(test_docs, ids=doc_ids)
```
...
### Load documents[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#load-documents "Direct link to Load documents")
...
```
import redisfrom langchain_google_memorystore_redis import MemorystoreDocumentLoaderredis_client = redis.from_url(ENDPOINT)loader = MemorystoreDocumentLoader(  client=redis_client,  key_prefix=KEY_PREFIX,  content_fields=set(["page_content"]),)for doc in loader.lazy_load():print("Loaded documents:", doc)
```

### Delete documents[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#delete-documents "Direct link to Delete documents")
...
```
docs = loader.load()print("Documents before delete:", docs)saver.delete(ids=[0])print("Documents after delete:", loader.load())saver.delete()print("Documents after delete all:", loader.load())
```

## Advanced Usage[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#advanced-usage "Direct link to Advanced Usage")
### Customize Document Page Content & Metadata[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#customize-document-page-content--metadata "Direct link to Customize Document Page Content & Metadata")
...
```
loader = MemorystoreDocumentLoader(  client=redis_client,  key_prefix=KEY_PREFIX,  content_fields=set(["content_field_1","content_field_2"]),  metadata_fields=set(["title","author"]),)
```

## Related[​](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#related "Direct link to Related")
...
[Edit this page](https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/document_loaders/google_memorystore_redis.ipynb)
#### Was this page helpful?
[PreviousGoogle Firestore (Native Mode)](https://python.langchain.com/docs/integrations/document_loaders/google_firestore/)[NextGoogle Spanner](https://python.langchain.com/docs/integrations/document_loaders/google_spanner/)
  * [Before You Begin](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#before-you-begin)
    * [🦜🔗 Library Installation](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#-library-installation)
    * [☁ Set Your Google Cloud Project](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#-set-your-google-cloud-project)
    * [🔐 Authentication](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#-authentication)
  * [Basic Usage](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#basic-usage)
    * [Save documents](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#save-documents)
    * [Load documents](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#load-documents)
    * [Delete documents](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#delete-documents)
  * [Advanced Usage](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#advanced-usage)
    * [Customize Document Page Content & Metadata](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#customize-document-page-content--metadata)
  * [Related](https://python.langchain.com/docs/integrations/document_loaders/google_memorystore_redis/#related)
