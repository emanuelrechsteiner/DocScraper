...
scraped_at: 2025-05-25T18:00:33.768995
title: SparkSQL — 🦜🔗 LangChain  documentation
---

[Skip to main content](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#main-content)
Back to top `⌘`+`K`
...
# SparkSQL[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#sparksql "Link to this heading") 

_class_ langchain_community.utilities.spark_sql.SparkSQL( 
    _spark_session :SparkSession|None=None_,     _catalog :str|None=None_,     _schema :str|None=None_,     _ignore_tables :List[str]|None=None_,     _include_tables :List[str]|None=None_,     _sample_rows_in_table_info :int=3_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL "Link to this definition")     
SparkSQL is a utility class for interacting with Spark SQL.
Initialize a SparkSQL object. 

Parameters:
    
  * **spark_session** (_Optional_ _[__SparkSession_ _]_) – A SparkSession object. If not provided, one will be created.
  ...
  * **ignore_tables** (_Optional_ _[__List_ _[__str_ _]__]_) – A list of tables to ignore. If not provided, all tables will be used.
  * **include_tables** (_Optional_ _[__List_ _[__str_ _]__]_) – A list of tables to include. If not provided, all tables will be used.
  * **sample_rows_in_table_info** (_int_) – The number of rows to include in the table info. Defaults to 3.


Methods
[`__init__`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.__init__ "langchain_community.utilities.spark_sql.SparkSQL.__init__")([spark_session, catalog, schema, ...]) | Initialize a SparkSQL object.  
---|---  
[`from_uri`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.from_uri "langchain_community.utilities.spark_sql.SparkSQL.from_uri")(database_uri[, engine_args]) | Creating a remote Spark Session via Spark connect.  
[`get_table_info`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_table_info "langchain_community.utilities.spark_sql.SparkSQL.get_table_info")([table_names]) |   
[`get_table_info_no_throw`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_table_info_no_throw "langchain_community.utilities.spark_sql.SparkSQL.get_table_info_no_throw")([table_names]) | Get information about specified tables.  
[`get_usable_table_names`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_usable_table_names "langchain_community.utilities.spark_sql.SparkSQL.get_usable_table_names")() | Get names of tables available.  
[`run`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.run "langchain_community.utilities.spark_sql.SparkSQL.run")(command[, fetch]) |   
[`run_no_throw`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.run_no_throw "langchain_community.utilities.spark_sql.SparkSQL.run_no_throw")(command[, fetch]) | Execute a SQL command and return a string representing the results. 

__init__( 
    _spark_session :SparkSession|None=None_,     _catalog :str|None=None_,     _schema :str|None=None_,     _ignore_tables :List[str]|None=None_,     _include_tables :List[str]|None=None_,     _sample_rows_in_table_info :int=3_, )[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.__init__)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.__init__ "Link to this definition")       
Initialize a SparkSQL object. 
...
_classmethod_ from_uri( 
    _database_uri :str_,     _engine_args :dict|None=None_,     _** kwargs:Any_, ) → [SparkSQL](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL "langchain_community.utilities.spark_sql.SparkSQL")[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.from_uri)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.from_uri "Link to this definition")     
...
[_SparkSQL_](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL "langchain_community.utilities.spark_sql.SparkSQL") 

get_table_info( 
    _table_names :List[str]|None=None_, ) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.get_table_info)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_table_info "Link to this definition")      
...
get_table_info_no_throw( 
    _table_names :List[str]|None=None_, ) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.get_table_info_no_throw)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_table_info_no_throw "Link to this definition")     
...
get_usable_table_names() → Iterable[str][[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.get_usable_table_names)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_usable_table_names "Link to this definition")
...
run(_command :str_, _fetch :str='all'_) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.run)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.run "Link to this definition")
...
run_no_throw( 
    _command :str_,     _fetch :str='all'_, ) → str[[source]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/spark_sql.html#SparkSQL.run_no_throw)[#](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.run_no_throw "Link to this definition")     
...
On this page 
  * [`SparkSQL`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL)
    * [`__init__()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.__init__)
    * [`from_uri()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.from_uri)
    * [`get_table_info()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_table_info)
    * [`get_table_info_no_throw()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_table_info_no_throw)
    * [`get_usable_table_names()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.get_usable_table_names)
    * [`run()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.run)
    * [`run_no_throw()`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.spark_sql.SparkSQL.html#langchain_community.utilities.spark_sql.SparkSQL.run_no_throw)
