...
scraped_at: 2025-05-25T08:50:03.390485
...
# Legacy React APIs[](https://react.dev/reference/react/legacy#undefined "Link for this heading")
These APIs are exported from the `react` package, but they are not recommended for use in newly written code. See the linked individual API pages for the suggested alternatives.
## Legacy APIs [](https://react.dev/reference/react/legacy#legacy-apis "Link for Legacy APIs ")
...
## Removed APIs [](https://react.dev/reference/react/legacy#removed-apis "Link for Removed APIs ")
...
## On this page
  * [Overview](https://react.dev/reference/react/legacy)
  * [Legacy APIs ](https://react.dev/reference/react/legacy#legacy-apis)
  * [Removed APIs ](https://react.dev/reference/react/legacy#removed-apis)
