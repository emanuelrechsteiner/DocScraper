...
scraped_at: 2025-05-25T08:41:07.523878
...
## Legacy Server APIs for non-streaming environments [](https://react.dev/reference/react-dom/server#legacy-server-apis-for-non-streaming-environments "Link for Legacy Server APIs for non-streaming environments ")
...
## On this page
  * [Overview](https://react.dev/reference/react-dom/server)
  * [Server APIs for Node.js Streams ](https://react.dev/reference/react-dom/server#server-apis-for-nodejs-streams)
  * [Server APIs for Web Streams ](https://react.dev/reference/react-dom/server#server-apis-for-web-streams)
  * [Legacy Server APIs for non-streaming environments ](https://react.dev/reference/react-dom/server#legacy-server-apis-for-non-streaming-environments)
