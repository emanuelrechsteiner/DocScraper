...
scraped_at: 2025-05-24T22:27:10.265839
...
Style: New York
Open in Copy
## [](https://ui.shadcn.com/docs/components/input#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/input#usage)Usage
```
...
```
Copy
## [](https://ui.shadcn.com/docs/components/input#examples)Examples
### [](https://ui.shadcn.com/docs/components/input#default)Default
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/input#file)File
PreviewCode
Style: New York
Open in Copy
Picture
### [](https://ui.shadcn.com/docs/components/input#disabled)Disabled
PreviewCode
Style: New York
Open in Copy
### [](https://ui.shadcn.com/docs/components/input#with-label)With Label
PreviewCode
Style: New York
Open in Copy
Email
### [](https://ui.shadcn.com/docs/components/input#with-button)With Button
PreviewCode
Style: New York
Open in Copy
Subscribe
### [](https://ui.shadcn.com/docs/components/input#form)Form
PreviewCode
Style: New York
Copy
Username
