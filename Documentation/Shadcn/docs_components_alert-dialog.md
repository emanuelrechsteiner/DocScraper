...
scraped_at: 2025-05-24T22:24:46.493647
...
Open in Copy
Show Dialog
## [](https://ui.shadcn.com/docs/components/alert-dialog#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/alert-dialog#usage)Usage
```
import {
 AlertDialog,
 AlertDialogAction,
