...
scraped_at: 2025-05-24T22:26:11.852850
...
## [](https://ui.shadcn.com/docs/components/alert#installation)Installation
CLIManual
pnpmnpmyarnbun
```
...
Copy
## [](https://ui.shadcn.com/docs/components/alert#usage)Usage
```
...
```
Copy
## [](https://ui.shadcn.com/docs/components/alert#examples)Examples
### [](https://ui.shadcn.com/docs/components/alert#default)Default
PreviewCode
Style: New York
Open in Copy
##### Heads up!
You can add components to your app using the cli.
### [](https://ui.shadcn.com/docs/components/alert#destructive)Destructive
PreviewCode
Style: New York
Open in Copy
##### Error
